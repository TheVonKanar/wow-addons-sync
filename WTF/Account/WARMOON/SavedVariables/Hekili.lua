...
["action"] = "pistol_shot",
["description"] = "With 2 ranks in Fan the Hammer, consume Opportunity as a higher priority if at max stacks or if it will expire.",
},
{
["enabled"] = true,
...
{
["enabled"] = true,
["criteria"] = "talent.deft_maneuvers.enabled & ! variable.finish_condition & spell_targets >= 5 & ( ! buff.disorienting_strikes.up || stealthed.all || buff.escalating_blade.stack >= 4 )",
["action"] = "blade_flurry",
["description"] = "With Deft Maneuvers, build CPs with Blade Flurry at 5+ targets. Trickster builds should avoid this during Disorienting Strikes with 0-3 stacks of Escalating Blade, unless stealth is active.",
},
{
["enabled"] = true,
