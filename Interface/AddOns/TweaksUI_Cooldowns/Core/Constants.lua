...
-- Midnight API Detection
TUICD.HAS_SPELL_COOLDOWN_DURATION = C_Spell and C_Spell.GetSpellCooldownDuration ~= nil
TUICD.HAS_SPELL_CHARGES_DURATION = C_Spell and C_Spell.GetSpellChargesCooldownDuration ~= nil
