...
L["Disable Hotkey For Teleport"] = "Desactivar teclas de acceso rápido para teletransportarse";
L["Disable Hotkey For Teleport Desc"] = "Desactiva las teclas de acceso rápido cuando eliges un destino de teletransporte.";
