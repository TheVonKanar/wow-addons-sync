...
L["Disable Hotkey For Teleport"] = "Desabilitar atalhos para teleportes";
L["Disable Hotkey For Teleport Desc"] = "Desabilita os atalhos quando você estiver escolhendo o destino de um teleporte.";
