...
L["Format RP Name Example"] = "당신은 다음과 같이 불립니다:\n%s";
...
L["Press Escape To Decline Quest"] = "ESC 키를 눌러 퀘스트 거절";
L["Press Escape To Decline Quest Desc"] = "NPC의 다른 대화가 있는 퀘스트를 볼 때 ESC 키를 누르면 UI가 닫히지 않고 이전 페이지로 돌아갑니다.";
...
L["Disable Hotkey For Teleport"] = "순간이동 단축키 사용 안 함";
L["Disable Hotkey For Teleport Desc"] = "순간이동 목적지를 선택할 때 단축키를 비활성화합니.";
...
L["VO Provider Format"] = "|cffffffff%s|r 가 음성을 처리합니다";
L["VO No File Format"] = "|cffffffff%s|r 에서 음성 파일을 찾을 수 없습니다.";
