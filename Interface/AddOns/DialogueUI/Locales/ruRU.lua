...
L["Disable Hotkey For Teleport"] = "Отключить клавиши для телепортации";
L["Disable Hotkey For Teleport Desc"] = "Отключить возможность использования горячих клавиш при выборе места назначения телепортации.";
