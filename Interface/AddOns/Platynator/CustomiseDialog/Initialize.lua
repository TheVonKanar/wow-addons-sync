...
function addonTable.CustomiseDialog.Initialize()
  ...
  local version = C_AddOns.GetAddOnMetadata("Platynator", "Version")
  ...
  header:SetText(LINK_FONT_COLOR:WrapTextInColorCode(addonTable.Locales.PLATYNATOR))
  ...
  local category = Settings.RegisterCanvasLayoutCategory(optionsFrame, addonTable.Locales.PLATYNATOR)
  category.ID = addonTable.Locales.PLATYNATOR
