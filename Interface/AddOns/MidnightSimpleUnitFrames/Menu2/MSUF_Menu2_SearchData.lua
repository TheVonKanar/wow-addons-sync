...
Data.QUERY_ALIASES = {
    ...
    menu = { "dashboard", "menu scale", "ui scale", "search", "support", "undo", "redo", "change history" },
    window = { "menu", "dashboard", "reset positions", "ui scale", "menu scale" },
    ui = { "ui scale", "menu scale", "dashboard" },
    fontpreview = { "font preview", "fonts", "font dropdown", "global fonts" },
    schriftvorschau = { "font preview", "fonts", "font dropdown", "global fonts" },
    undo = { "undo", "change history", "saved changes", "menu" },
    redo = { "redo", "change history", "saved changes", "menu" },
    history = { "change history", "undo", "redo", "saved changes", "menu" },
    rueckgaengig = { "undo", "change history", "saved changes", "menu" },
    wiederholen = { "redo", "change history", "saved changes", "menu" },
    gespeichert = { "saved changes", "change history", "undo", "redo" },
    ...
    menuscale = { "menu scale", "dashboard", "ui scale", "menu window", "window frame" },
    menugroesse = { "menu scale", "dashboard", "ui scale", "menu window" },
    optionsgroesse = { "menu scale", "dashboard", "ui scale", "menu window" },
...
function Data.BuildFAQ(env)
    ...
    },
    {
        ...
        answer = "Use the Menu scale slider in the window frame from any page. Dashboard scaling remains available for UI scale, and the window corner changes the menu's dimensions.",
        pageKey = "home",
        target = "Menu window frame / Dashboard scaling",
        anchorText = "Menu window frame UI Scale Menu Scale resize window bigger smaller dashboard",
        keywords = { "menu too big", "menu too small", "make menu bigger", "make menu smaller", "ui scale", "menu scale", "resize window", "options too big", "options too small", "scale menu from any page", "menu window scale", "window frame scale", "menugroesse", "optionsgroesse" },
        priority = 45,
    },
    {
    ...
    {
        label = "Can I preview a font before selecting it?",
        answer = "Yes. Open any MSUF font dropdown: every font name is rendered in that font, and the selected field keeps the same live preview.",
        pageKey = "opt_fonts",
        target = "Opens: Global Style > Fonts",
        anchorText = "Fonts font dropdown font preview selected font name typography text",
        keywords = { "font preview", "preview fonts", "see font before choosing", "font dropdown preview", "selected font preview", "font sample", "schriftvorschau", "schriftart vorschau", "fonts ansehen" },
        priority = 95,
    },
    {
        label = "Was my menu change saved, and how do I undo it?",
        answer = "A short confirmation appears below Undo and Redo after each recorded menu change. Use those buttons in the navigation rail to step backward or forward in the current menu session.",
        pageKey = "home",
        target = "MSUF menu navigation > Undo / Redo",
        anchorText = "Undo Redo saved change confirmation change history navigation rail",
        keywords = { "was change saved", "setting saved", "saved changes", "change confirmation", "undo menu change", "redo menu change", "change history", "revert last setting", "rueckgaengig", "wiederholen", "aenderung gespeichert", "gespeichert" },
        priority = 120,
    },
    }
end
