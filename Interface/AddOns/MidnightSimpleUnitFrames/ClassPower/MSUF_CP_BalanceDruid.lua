...
-- MSUF_CP_Balance.lua â€” Balance Druid Astral Power prediction + eclipse colors
-- Self-contained feature module. Wrapped in doâ€¦end so the Druid-class-gate
...
do
    ...
    -- registrations and remain registered for all classes â€” consumer-side
    ...
    -- One-time load guard (scoped â€” only relevant once we know we're Druid).
