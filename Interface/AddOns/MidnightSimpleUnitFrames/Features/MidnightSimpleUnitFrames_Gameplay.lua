...
-- Shared helpers for split Gameplay feature modules. Keep this table small and
-- compatibility-focused; hot feature code still binds what it needs locally.
ns.MSUF_GameplayShared = ns.MSUF_GameplayShared or {}
do
    local S = ns.MSUF_GameplayShared
    S.EnsureGameplayDefaults = EnsureGameplayDefaults
    S.GetPlayerSpecID = MSUF_GetPlayerSpecID
    S.Clamp = _MSUF_Clamp
    S.RoundInt = _MSUF_RoundInt
    S.SetupArrowNudge = MSUF_Gameplay_SetupArrowNudge
    S.BeginHistory = MSUF_Gameplay_BeginHistory
    S.CommitHistory = MSUF_Gameplay_CommitHistory
    S.CheckpointHistory = MSUF_Gameplay_CheckpointHistory
    S.SelectNudgeFrame = MSUF_Gameplay_SelectNudgeFrame
end
...
function GameplayFeatures.PlayerTotems.Apply(g)
    local fn = ns.MSUF_Gameplay_PlayerTotems_Apply
