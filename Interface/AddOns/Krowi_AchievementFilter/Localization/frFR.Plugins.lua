...
L["Add To Right Click Menu Desc"] = "Ajouter une option au menu clic droit qui vous dirigera vers les tactiques si {iat} possède des données pour cela."
L["Alert System Overwrite Desc"] = "Les paramètres de localisation ne sont pas actifs lorsque {addon} est activé. Déplacer l'ancre des cadres de Butin / Alertes donnera le même résultat."
...
L["ElvUI Fix World Map Button Desc"] = "Lorsque \"ElvUI Maps\" -> \"Carte du monde\" -> \"Carte du monde plus petite\" est activé, le bouton de la carte du monde nécessite une réparation."
L["ElvUI Remove Parchment"] = "Supprimer le parchemin"
...
L["ElvUI Skin Calendar Desc"] = "Applique l'apparence d'ElvUI au calendrier."
L["ElvUI Skin Data Manager"] = "Apparence du gestionnaire de données"
L["ElvUI Skin Data Manager Desc"] = "Applique l'apparence d'ElvUI à la fenêtre du gestionnaire de données."
L["ElvUI Skin Misc Frames"] = "Apparence des autres cadres"
L["ElvUI Skin Misc Frames Desc"] = "Applique l'apparence d'ElvUI au menu de filtre, au menu clic droit et à la boîte de dialogue contextuelle."
L["ElvUI Skin Tooltip"] = "Apparence de l'infobulle"
L["ElvUI Skin Tooltip Desc"] = "Applique l'apparence d'ElvUI aux infobulles."
L["ElvUI Skin Tutorials"] = "Apparence du tutoriel"
...
L["GW2_UI Skin DropDown Desc"] = "Applique l'apparence de GW 2 UI au menu de filtre et au menu clic droit."
L["GW2_UI Skin Popup Notifications"] = "Apparence des notifications surgissantes"
L["GW2_UI Skin Popup Notifications Desc"] = "Applique l'apparence de GW 2 UI à la boîte de dialogue surgissante."
L["GW2_UI Skin Tooltip"] = "Apparence de l'infobulle"
L["GW2_UI Skin Tooltip Desc"] = "Applique l'apparence de GW 2 UI aux infobulles."
L["GW2_UI Skins Desc"] = "Chacune des options ci-dessous est contrôlée par GW 2 UI et est purement informative. Pour modifier ces options, allez dans \"Menu du jeu\" -> \"GW 2 UI\" -> \"Général\" -> \"Skins\" et cochez les options souhaitées. Voir chaque option ci-dessous pour savoir quoi cocher."
L["IAT Tactics"] = true
...
L["Zygor Guides Viewer"] = "Afficher les guides de Zygor"
L["Zygor Guides Viewer Desc"] = "Ce plugin ajoute à nouveau les loupes à l'onglet des Réalisations de Blizzard. Il n'y a pas d'options."