...
KrowiAF.CategoryData.Events = { -- TAB - Events
    ...
    { -- Pandaria: Remix
        1578,
        addon.GetCategoryInfoTitle(15536),
        { -- Zones
            1579,
            addon.L["Zones"],
            { -- The Jade Forest
    ...
    { -- Battle for Azeroth
        ...
        { -- Faction Assaults
            ...
            { -- Assault on Tiragarde Sound
                935,
                addon.L["Assault on Tiragarde Sound"],
                {
            ...
            { -- Assault on Stormsong Valley
                937,
                addon.L["Assault on Stormsong Valley"],
                {
                    13317, -- Supplied and Ready
                    13283, -- Frontline Warrior
                    13284, -- Frontline Warrior
    ...
    { -- Dragonflight
        ...
        { -- Researchers Under Fire
            ...
            { -- Zaqali Ruin Investigation
                1429,
                addon.L["Zaqali Ruin Investigation"],
                {
