...
KrowiAF.AchievementData["08_00_01"] = {
	...
	Ach(12479):HousingDecor(1183):FactionSplit(faction.Horde, 12891), -- Zandalar Forever!
	...
	Ach(12509):HousingDecor(944):FactionSplit(faction.Horde, 12510), -- Ready for War
	...
	Ach(12582):HousingDecor(1704):FactionSplit(faction.Alliance, 12555), -- Come Sail Away
	...
	Ach(12614):HousingDecor(1188):FactionSplit(faction.Horde, nil), -- Loa Expectations
	Ach(12719):FactionSplit(faction.Horde, nil), -- Spirits Be With You
	Ach(12721), -- Wrap God
	Ach(12722), -- It Belongs in a Mausoleum!
	Ach(12723):Pet(2202), -- How to Keep a Mummy
	...
	Ach(12733):HousingDecor(1191):FactionSplit(faction.Horde, 12731), -- Professional Zandalari Master
	...
	Ach(12746):HousingDecor(1417):FactionSplit(faction.Horde, 12744), -- The Zandalari Menu
	...
	Ach(12806):Mount(963), -- Glory of the Uldir Raider
	Ach(12807), -- Battle for Azeroth Dungeon Hero
	Ach(12812):Mount(933), -- Glory of the Wartorn Hero
	...
	Ach(12866):Mount(1190):Title(), -- 100 Exalted Reputations
	Ach(12867):HousingDecor(838):FactionSplit(faction.Horde, 12896), -- Azeroth at War: The Barrens
	Ach(12869):HousingDecor(837):FactionSplit(faction.Horde, 12898), -- Azeroth at War: After Lordaeron
	Ach(12870):HousingDecor(933):FactionSplit(faction.Horde, 12899), -- Azeroth at War: Kalimdor on Fire
	...
	Ach(12893):Pet(1978, 1979):IsPvP(), -- Honor Level 5
	Ach(12894):Toy():IsPvP(), -- Honor Level 10
	Ach(12895):Mount(826):IsPvP(), -- Honor Level 15
	...
	Ach(12900):Pet(1918, 1919):IsPvP(), -- Honor Level 20
	Ach(12901):Title():IsPvP(), -- Honor Level 25
	Ach(12902):Toy():IsPvP(), -- Honor Level 30
	Ach(12903):Mount(833):IsPvP(), -- Honor Level 40
	Ach(12904):Title():IsPvP(), -- Honor Level 50
	Ach(12905):Toy():IsPvP(), -- Honor Level 60
	Ach(12906):Mount(834):IsPvP(), -- Honor Level 70
	Ach(12907):Title():IsPvP(), -- Honor Level 80
	Ach(12908):Toy():IsPvP(), -- Honor Level 90
	Ach(12909):Title():IsPvP(), -- Honor Level 100
	Ach(12910):Mount(832):IsPvP(), -- Honor Level 125
	Ach(12911):Mount(831):IsPvP(), -- Honor Level 150
	Ach(12912):Toy():IsPvP(), -- Honor Level 175
	Ach(12913):Title():IsPvP(), -- Honor Level 200
	Ach(12914):Mount(836):IsPvP(), -- Honor Level 250
	Ach(12915):Title():IsPvP(), -- Honor Level 300
	Ach(12916):Pet(2478, 2479):IsPvP(), -- Honor Level 400
	Ach(12917):Mount(1192):IsPvP(), -- Honor Level 500
	Ach(12918), -- Have a Heart
	Ach(12927), -- Polished Pet Charmer
	Ach(12930):Pet(2431), -- Battle Safari
	Ach(12931):Mount(1167):AutoFactionSplit(faction.Horde, 12932), -- No Stable Big Enough
	Ach(12933):Mount(1191):AutoFactionSplit(faction.Alliance, 12934), -- A Horde of Hoofbeats
	...
	Ach(12992):Pet(2401), -- Pet Emporium
	Ach(12993), -- Don't Warfront Me
	Ach(12995), -- Treasures of Drustvar
	Ach(12996):Pet(1479), -- Toybox Tycoon
	Ach(12997):HousingDecor(9141):FactionSplit(faction.Alliance, nil), -- The Pride of Kul Tiras
	...
	Ach(13018):HousingDecor(1418), -- Dune Rider
	...
	Ach(13038):HousingDecor(1175):FactionSplit(faction.Horde, nil), -- Raptari Rider
	Ach(13039):HousingDecor(1185):FactionSplit(faction.Horde, nil), -- Paku'ai
	...
	Ach(13049):HousingDecor(9140):FactionSplit(faction.Alliance, nil), -- The Long Con
	...
	Ach(13062):Pet(2442):FactionSplit(faction.Alliance, nil), -- Let's Bee Friends
...
KrowiAF.AchievementData["08_01_00"] = {
	...
	Ach(13212):Mount(1031):Title():PvP(27), -- Gladiator: Battle for Azeroth Season 2
	...
	Ach(13269):Pet(2534), -- Pet Battle Challenge: Gnomeregan
	...
	Ach(13279):Pet(2535), -- Family Battler
	Ach(13280), -- Hobbyist Aquarist
	Ach(13281), -- Human Resources
	Ach(13283):FactionSplit(faction.Alliance, 13284), -- Frontline Warrior
	Ach(13284):HousingDecor(937):FactionSplit(faction.Horde, 13283), -- Frontline Warrior
	...
	Ach(13315):Mount(1218), -- Glory of the Dazar'alor Raider
...
KrowiAF.AchievementData["08_01_05"] = {
	...
	Ach(13469):Pet(2591), -- Raiding with Leashes VI: Pets of Pandaria
	...
	Ach(13517):Mount(1245, 1246), -- Two Sides to Every Tale
}

KrowiAF.AchievementData["08_02_00"] = {
	Ach(13250):Mount(1224), -- Battle for Azeroth Pathfinder, Part Two
	Ach(13470), -- Rest In Pistons
	Ach(13472), -- Deep Pockets
	Ach(13473):HousingDecor(2326), -- Diversified Investments
	Ach(13474), -- Junkyard Machinist
	Ach(13475):HousingDecor(2435), -- Junkyard Scavenger
	Ach(13476), -- Junkyard Tinkerer
	Ach(13477):HousingDecor(2430), -- Junkyard Apprentice
	...
	Ach(13541):Mount(1247), -- Mecha-Done
	...
	Ach(13627):Pet(2638), -- Pet Battle Challenge: Stratholme
	...
	Ach(13638):Mount(1238):Title(), -- Undersea Usurper
	...
	Ach(13647):Mount(1032):Title():PvP(28), -- Gladiator: Battle for Azeroth Season 3
	Ach(13676):Title():PvP(28), -- Elite: Battle for Azeroth Season 3
	Ach(13684), -- You and What Army?
	Ach(13686), -- Junkyard Melomaniac
	Ach(13687):Mount(1232), -- Glory of the Eternal Raider
	...
	Ach(13695):Pet(2683), -- Team Aquashock
	...
	Ach(13723):HousingDecor(2322), -- M.C., Hammered
...
KrowiAF.AchievementData["08_02_05"] = {
	...
	Ach(13931):Mount(1240):Obtainable("From", "Date", {2019, 11, 5}, "Until", "Date", {2020, 1, 7}), -- Memories of Fel, Frost and Fire
}
...
KrowiAF.AchievementData["08_03_00"] = {
	...
	Ach(13967):Mount(1035):Title():PvP(29), -- Gladiator: Battle for Azeroth Season 4
	Ach(13989):Title():PvP(29), -- Elite: Battle for Azeroth Season 4
	Ach(13990), -- You Can Pet the Dog, But...
	Ach(13994):Mount(1282), -- Through the Depths of Visions
	...
	Ach(14143):Pet(2844), -- Reeking of Visions
	Ach(14144):Title():PvE(4), -- Battle for Azeroth Keystone Conqueror: Season Four
	Ach(14145):Mount(1326):PvE(4), -- Battle for Azeroth Keystone Master: Season Four
	Ach(14146):Mount(1322), -- Glory of the Ny'alotha Raider
