...
KrowiAF.AchievementData["04_00_03"] = {
	...
	Ach(4883), -- Therazane
	Ach(4884), -- Ramkahen
	Ach(4885):AutoFactionSplit(faction.Alliance, 4886), -- Wildhammer / Dragonmaw Clan
	...
	Ach(4895):AutoFactionSplit(faction.Horde, 4902), -- Hillsbrad Foothills / Redridge Mountains Quests
	...
	Ach(4918):Obtainable("Before", "Version", {8, 0, 1}), -- Illustrious Grand Master Medic
	...
	Ach(4926):AutoFactionSplit(faction.Alliance, 4933), -- Bloodmyst Isle / Northern Barrens Quests
	Ach(4927):AutoFactionSplit(faction.Horde, 4928), -- Azshara / Darkshore Quests
	...
	Ach(5219):AutoFactionSplit(faction.Alliance, 5220):IsPvP(), -- I'm in the White / Black Lodge
	...
	Ach(5268):AutoFactionSplit(faction.Alliance, 5269):IsPvP(), -- In Service of the Alliance / Horde
	...
	Ach(5333):AutoFactionSplit(faction.Alliance, 5348):Title():IsPvP(), -- Master / Senior Sergeant
	...
	Ach(5481):AutoFactionSplit(faction.Alliance, 5482), -- Wildhammer / Dragonmaw Tour of Duty
	Ach(5483), -- Bounce
...
KrowiAF.AchievementData["04_03_00"] = {
	...
	Ach(6124):PvP(10), -- Ruthless Gladiator
	Ach(6127), -- Lazy Eye
