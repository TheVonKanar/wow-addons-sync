...
zoneData:Zone({1533, 1690, 1713, 1714}, { -- Bastion (zone)
...
zoneData:Zone({1536, 1649, 1650, 1651, 1652}, { -- Maldraxxus (zone)
...
zoneData:Zone({1543, 1820, 1821, 1822, 1823}, { -- The Maw (zone)
    14334, -- Into the Maw
...
zoneData:Zone({1970, 2027, 2028, 2029, 2030, 2031, 2066}, { -- Zereth Mortis (zone)
