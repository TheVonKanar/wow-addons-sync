...
KrowiAF.AchievementData["03_00_02_S"] = {
	...
	Ach(11):Obtainable("Before", "Version", {9, 0, 1}), -- Level 60 (Legacy)
	Ach(12):Obtainable("Before", "Version", {9, 0, 1}), -- Level 70 (Legacy)
	Ach(13):Obtainable("Before", "Version", {9, 0, 1}), -- Level 80 (Legacy)
	...
	Ach(45):Tabard(), -- Northrend Explorer
	Ach(46):Title(), -- Universal Explorer
	...
	Ach(131):Obtainable("Before", "Version", {8, 0, 1}), -- Journeyman Medic
	Ach(132):Obtainable("Before", "Version", {8, 0, 1}), -- Expert Medic
	Ach(133):Obtainable("Before", "Version", {8, 0, 1}), -- Artisan Medic
	Ach(134):Obtainable("Before", "Version", {8, 0, 1}), -- Master Medic
	Ach(135):Obtainable("Before", "Version", {8, 0, 1}), -- Grand Master Medic
	Ach(137), -- Stocking Up
	...
	Ach(963):AutoFactionSplit(faction.Alliance, 965):Obtainable("Event", 324), -- Tricks and Treats of Kalimdor
	Ach(964), -- Going Down?
	Ach(966):AutoFactionSplit(faction.Alliance, 967):Obtainable("Event", 324), -- Tricks and Treats of Eastern Kingdoms
	Ach(968):AutoFactionSplit(faction.Horde, 969):Obtainable("Event", 324), -- Tricks and Treats of Outland
	...
	Ach(1184):AutoFactionSplit(faction.Alliance, 1203):Obtainable("Event", 372), -- Strange Brew
	...
	Ach(1279):AutoFactionSplit(faction.Alliance, 1280):Obtainable("Before", "Version", {10, 2, 5}), -- Flirt With Disaster
	...
	Ach(1307):Obtainable("Before", "Version", {6, 0, 2}), -- Upper Blackrock Spire (Classic)
	...
	Ach(1685):AutoFactionSplit(faction.Horde, 1686):Obtainable("Event", 141), -- Holiday Bromance
	...
	Ach(1697):AutoFactionSplit(faction.Alliance, 1698):Obtainable("Before", "Version", {10, 2, 5}), -- Nation of Adoration
	...
	Ach(1757):IsPvP():AutoFactionSplit(faction.Alliance, 2200):Obtainable("Before", "Version", {8, 0, 1}), -- Defense of the Ancients
	Ach(1761):IsPvP():Obtainable("Before", "Version", {8, 0, 1}), -- The Dapper Sapper
	Ach(1762):IsPvP():AutoFactionSplit(faction.Alliance, 2192):Obtainable("Before", "Version", {8, 0, 1}), -- Not Even a Scratch
...
KrowiAF.AchievementData["03_01_00_S"] = {
	...
	Ach(2420):AutoFactionSplit(faction.Horde, 2421):Obtainable("Event", 181), -- Noble Garden
...
KrowiAF.AchievementData["03_02_00_S"] = {
	...
	Ach(3576):AutoFactionSplit(faction.Alliance, 3577):Obtainable("Event", 404), -- Now We're Cookin'
	Ach(3578):Obtainable("Event", 404), -- The Turkinator
	Ach(3579):Obtainable("Event", 404), -- "FOOD FIGHT!"
	Ach(3580):AutoFactionSplit(faction.Alliance, 3581):Obtainable("Event", 404), -- Pilgrim's Peril
