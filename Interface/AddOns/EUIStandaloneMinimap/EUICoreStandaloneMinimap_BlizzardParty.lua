...
-------------------------------------------------------------------------------
--  EUICoreStandaloneMinimap_BlizzardParty.lua
...
--  implementation and the same saved setting (EUICoreStandaloneMinimapDB.hideBlizzardPartyFrame),
...
local function ApplyHideBlizzardPartyFrame()
    local shouldHide = EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.hideBlizzardPartyFrame
    ...
    if shouldHide then
        ...
        if not hookedMgr then
            ...
            regenFrame:SetScript("OnEvent", function()
                if EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.hideBlizzardPartyFrame then
...
EUICoreStandaloneMinimap._applyHideBlizzardPartyFrame = ApplyHideBlizzardPartyFrame
