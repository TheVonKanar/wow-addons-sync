...
-------------------------------------------------------------------------------
--  EUICoreStandaloneMinimap_PartyMode.lua
...
-------------------------------------------------------------------------------
if _G._EUICoreStandaloneMinimapPartyModeLoaded then return end
_G._EUICoreStandaloneMinimapPartyModeLoaded = true

local ADDON_NAME = ...
local GRADIENT_TEX = "Interface\\AddOns\\EUIStandaloneMinimap\\media\\party.png"
...
--  The bound key is saved in EUICoreStandaloneMinimapDB.partyModeKey (nil = unbound).
-------------------------------------------------------------------------------
if not _G["EUICoreStandaloneMinimapPartyModeBindBtn"] then
    local btn = CreateFrame("Button", "EUICoreStandaloneMinimapPartyModeBindBtn", UIParent)
    btn:Hide()
...
-------------------------------------------------------------------------------
function EUICoreStandaloneMinimap_IsDimLightsActive()
    return dimLightsActive
end

function EUICoreStandaloneMinimap_ApplyDimLights()
...
function EUICoreStandaloneMinimap_RestoreDimLights()
...
local function CreateOverlay()
    ...
    container = CreateFrame("Frame", "EUICoreStandaloneMinimapPartyModeFrame", UIParent)
...
local function GetSoundTables()
    if not _soundPaths then
        local EUI = _G.EUICoreStandaloneMinimap
...
function EUICoreStandaloneMinimap_GetPartyModeSounds()
...
--  Global API
-------------------------------------------------------------------------------
function EUICoreStandaloneMinimap_StartPartyMode()
    CreateOverlay()
    ...
    if not container:IsShown() then
        local key = EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.partyModeSoundKey
    ...
    if EUICoreStandaloneMinimapDB and (EUICoreStandaloneMinimapDB.partyModeDimLights ~= false) then
        EUICoreStandaloneMinimap_ApplyDimLights()
    end
end

function EUICoreStandaloneMinimap_StopPartyMode()
...
-------------------------------------------------------------------------------
function EUICoreStandaloneMinimap_TogglePartyMode()
    ...
    if EUICoreStandaloneMinimapDB.partyMode then
        ...
        EUICoreStandaloneMinimapDB.partyMode = true
        EUICoreStandaloneMinimap_StartPartyMode()
    end
end
...
local function GetRandomCooldown()
    return ((EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.partyModeRandomCooldown) or 10) * 60
end
...
local function ScheduleRandomActivation()
    ...
    randomScheduledTimer = C_Timer.NewTimer(delay, function()
        ...
        if not (EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.partyModeTriggerRandom) then return end
        if EUICoreStandaloneMinimapDB.partyMode then
        ...
        local duration = (EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.partyModeMPlusDuration) or 30
        celebrationTimer = C_Timer.NewTimer(duration, function()
            celebrationTimer = nil
            if EUICoreStandaloneMinimapDB then EUICoreStandaloneMinimapDB.partyMode = false end
            EUICoreStandaloneMinimap_StopPartyMode()
...
function EUICoreStandaloneMinimap_StartRandomTrigger()
    if randomTimer or randomScheduledTimer or randomCooldownTimer then return end
    ScheduleRandomActivation()
end

function EUICoreStandaloneMinimap_StopRandomTrigger()
...
local function OnSettingsClose()
    ...
    if EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.partyModeTriggerRandom then
        EUICoreStandaloneMinimap_StartRandomTrigger()
    end
end

EUICoreStandaloneMinimap:RegisterOnShow(OnSettingsOpen)
EUICoreStandaloneMinimap:RegisterOnHide(OnSettingsClose)
...
-- toggle it live, mirroring EUICoreStandaloneMinimap_StartRandomTrigger.
function EUICoreStandaloneMinimap_UpdatePartyModeLustListener()
    if EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.partyModeTriggerBloodlust then
...
pmInit:SetScript("OnEvent", function(self, event, ...)
    if event == "PLAYER_LOGIN" then
        ...
        if EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.partyModeKey then
            SetOverrideBindingClick(EUICoreStandaloneMinimapPartyModeBindBtn, true, EUICoreStandaloneMinimapDB.partyModeKey, "EUICoreStandaloneMinimapPartyModeBindBtn")
        end
        ...
        EUICoreStandaloneMinimap_UpdatePartyModeLustListener()

    elseif event == "UNIT_AURA" then
        if not (EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.partyModeTriggerBloodlust) then return end
    ...
    elseif event == "CHALLENGE_MODE_COMPLETED" then
        if not EUICoreStandaloneMinimapDB or not EUICoreStandaloneMinimapDB.partyModeTriggerKeystone then return end
    ...
    elseif event == "ENCOUNTER_END" then
        ...
        if not (EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB[key]) then return end
        EUICoreStandaloneMinimapDB.partyMode = true
        EUICoreStandaloneMinimap_StartPartyMode()
        if celebrationTimer then celebrationTimer:Cancel() end
        local duration = (EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.partyModeMPlusDuration) or 30
    ...
    elseif event == "PVP_MATCH_COMPLETE" then
        ...
        if C_PvP and C_PvP.IsRatedBattleground and C_PvP.IsRatedBattleground() and EUICoreStandaloneMinimapDB.partyModeTriggerRatedBG then
            triggered = true
        end
        if C_PvP and C_PvP.IsRatedArena and C_PvP.IsRatedArena() and EUICoreStandaloneMinimapDB.partyModeTriggerRatedArena then
            triggered = true
        end
