...
-- EUICoreStandaloneMinimap_ClientGate.lua
...
ev:SetScript("OnEvent", function(self)
    ...
    title:SetText("EUICoreStandaloneMinimap")
    ...
    body:SetText("This version of EUICoreStandaloneMinimap is built for the Midnight 12.1 patch and has been disabled on this game version.|n|nYour saved settings are safe and untouched. Please install the previous EUICoreStandaloneMinimap release until 12.1 launches.")
