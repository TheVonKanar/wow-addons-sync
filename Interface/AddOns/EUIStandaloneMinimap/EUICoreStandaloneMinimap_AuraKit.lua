...
-- EUICoreStandaloneMinimap_AuraKit.lua Shared engine for the 12.1 aura container system. Every
-- EUICoreStandaloneMinimap module consumes aura displays through this file; modules never call
...
local AK = {}
EUICoreStandaloneMinimap.AuraKit = AK
    ...
    if d.borderHost then
        ...
        if PP and b then
            if shapeActive and style.shapeBorderPath then
                ...
                if b.texture and EUICoreStandaloneMinimap.ApplyBorderStyle then
                    ...
                    EUICoreStandaloneMinimap.ApplySecretSafeBorderStyle(d.borderHost, d, b.size or 1,
    ...
    if dispelTexSet then
        ...
        if shapeActive and d.dispelShapeTex then
            ...
            if d.akDispelGeom ~= geomKey then
                local PPx = EUICoreStandaloneMinimap.PP
