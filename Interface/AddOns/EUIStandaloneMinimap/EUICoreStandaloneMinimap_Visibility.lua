...
-------------------------------------------------------------------------------
--  EUICoreStandaloneMinimap_Visibility.lua
...
-------------------------------------------------------------------------------
local EUI = _G.EUICoreStandaloneMinimap or {}
_G.EUICoreStandaloneMinimap = EUI
...
function EUI.RegisterMouseoverTarget(frame, isActive)
    ...
    EUICoreStandaloneMinimap.Mouse.SubscribeTick("visMouseover", 0.15, MouseoverScan)
end
