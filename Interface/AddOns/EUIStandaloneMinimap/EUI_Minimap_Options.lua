...
--  Registers the Minimap module with EUICoreStandaloneMinimap.
--  All get/set calls go through the global bridge to the addon's DB profile.
-------------------------------------------------------------------------------
local ADDON_NAME = "EUIStandaloneMinimap"
local ns = EUICoreStandaloneMinimap._ModuleNS[ADDON_NAME]  -- module namespace (published by the module at its load)
...
initFrame:SetScript("OnEvent", function(self)
    ...
    local function BuildVisibilityRow(W, parent, y, getCfg, refreshFn)
        local visRow, visH = EUICoreStandaloneMinimap.BuildVisibilityModeRow(W, parent, y,
    ...
    local function BuildMinimapPage(pageName, parent, yOffset)
        ...
        if not EUICoreStandaloneMinimap._prebuilding then
            ...
            cogTex:SetAllPoints()
            cogTex:SetTexture(EUICoreStandaloneMinimap.COGS_ICON)
        ...
        local texValues, texOrder = EUICoreStandaloneMinimap.GetBorderTextureDropdown()
        local borderRow
        borderRow, h = W:DualRow(parent, y,
            { type="dropdown", text="Border Style",
              ...
              setValue=function(v)
                  ...
                  local _bcol, _bbehind = EUICoreStandaloneMinimap.GetBorderStyleSelectDefaults(v)
                  m.borderColor = _bcol
                  m.borderA = 1
                  m.borderBehind = _bbehind
                  m.borderUseClassColor = false
                  m.useClassColor = false
                  local defSz = EUICoreStandaloneMinimap.GetBorderDefaultSize("minimap", v)
        ...
        if not EUICoreStandaloneMinimap._prebuilding then
                ...
                rows = {
                    { type = "slider", label = "Offset X", min = -10, max = 10, step = 1,
                      get = function()
                          ...
                          local dox = EUICoreStandaloneMinimap.GetBorderDefaults("minimap", BorderTex(), BorderSz())
                          return dox
                      end,
                      set = function(v)
                          local m = MinimapDB(); if not m then return end
                    ...
                    { type = "slider", label = "Offset Y", min = -10, max = 10, step = 1,
                      get = function()
                          ...
                          if v then return v end
                          local _, doy = EUICoreStandaloneMinimap.GetBorderDefaults("minimap", BorderTex(), BorderSz())
                          return doy
                      end,
                      set = function(v)
                          local m = MinimapDB(); if not m then return end
                    ...
                    { type = "slider", label = "Shift X", min = -10, max = 10, step = 1,
                      get = function()
                          ...
                          if v then return v end
                          local _, _, dsx = EUICoreStandaloneMinimap.GetBorderDefaults("minimap", BorderTex(), BorderSz())
                          return dsx
                      end,
                      set = function(v)
                          local m = MinimapDB(); if not m then return end
                    ...
                    { type = "slider", label = "Shift Y", min = -10, max = 10, step = 1,
                      get = function()
                          ...
                          if v then return v end
                          local _, _, _, dsy = EUICoreStandaloneMinimap.GetBorderDefaults("minimap", BorderTex(), BorderSz())
                          return dsy
                      end,
                      set = function(v)
                          local m = MinimapDB(); if not m then return end
            ...
            local cogTex = cogBtn:CreateTexture(nil, "OVERLAY")
            cogTex:SetAllPoints()
            cogTex:SetTexture(EUICoreStandaloneMinimap.DIRECTIONS_ICON)
            cogBtn:SetScript("OnEnter", function(s) s:SetAlpha(0.7) end)
            cogBtn:SetScript("OnLeave", function(s) s:SetAlpha(0.4) end)
            cogBtn:SetScript("OnClick", function(s) cogShow(s) end)
            ...
            EUICoreStandaloneMinimap.RegisterWidgetRefresh(UpdateCogVis)
            UpdateCogVis()
        end
        ...
        if not EUICoreStandaloneMinimap._prebuilding then
            ...
            local PPl = EUICoreStandaloneMinimap.PP

            -- Accent swatch (nearest the control): live theme accent.
            local accentSwatch, updateAccent = EUICoreStandaloneMinimap.BuildColorSwatch(
            ...
            local classSwatch, updateClass = EUICoreStandaloneMinimap.BuildColorSwatch(
                rgn, borderRow:GetFrameLevel() + 3,
                function()
                    local cc = EUICoreStandaloneMinimap.GetClassColor and EUICoreStandaloneMinimap.GetClassColor(select(2, UnitClass("player")))
            ...
            local customSwatch, updateCustom = EUICoreStandaloneMinimap.BuildColorSwatch(
                rgn, borderRow:GetFrameLevel() + 3,
                function()
                    local m = MinimapDB()
            ...
            accentSwatch:HookScript("OnEnter", function() EUICoreStandaloneMinimap.ShowWidgetTooltip(accentSwatch, "Accent Color") end)
            accentSwatch:HookScript("OnLeave", function() EUICoreStandaloneMinimap.HideWidgetTooltip() end)
            classSwatch:HookScript("OnEnter", function() EUICoreStandaloneMinimap.ShowWidgetTooltip(classSwatch, "Class Color") end)
            classSwatch:HookScript("OnLeave", function() EUICoreStandaloneMinimap.HideWidgetTooltip() end)
            customSwatch:HookScript("OnEnter", function() EUICoreStandaloneMinimap.ShowWidgetTooltip(customSwatch, "Custom Color") end)
            customSwatch:HookScript("OnLeave", function() EUICoreStandaloneMinimap.HideWidgetTooltip() end)
            ...
            EUICoreStandaloneMinimap.RegisterWidgetRefresh(UpdateState)
            UpdateState()
        end
        ...
        if not EUICoreStandaloneMinimap._prebuilding then
            ...
            for i = 1, rgn:GetNumRegions() do
                ...
                if reg and reg.GetText and EUICoreStandaloneMinimap.EnKey(reg:GetText()) == "Reset Zoom" then
                    rzLabel = reg
                    break
                end
            end
        ...
        if not EUICoreStandaloneMinimap._prebuilding then
            ...
            resetFS:SetFont(EUICoreStandaloneMinimap.EXPRESSWAY or "Fonts\\FRIZQT__.TTF", 12, "")
            resetFS:SetTextColor(1, 1, 1, 0.8)
            resetFS:SetText(EUICoreStandaloneMinimap.L("Reset"))
            ...
            UpdateResetVis()
            EUICoreStandaloneMinimap.RegisterWidgetRefresh(UpdateResetVis)
        end
        ...
        if not EUICoreStandaloneMinimap._prebuilding then
            ...
            local cbDD, cbDDRefresh = EUICoreStandaloneMinimap.BuildReorderCBDropdown(
        ...
        _, h = W:DualRow(parent, y,
            ...
            { type="toggle", text="Open Micro Menu on Middle Click",
              tooltip="Middle-click the minimap to open the EUICoreStandaloneMinimap micro menu. When off, middle-click does nothing.",
        ...
        if not EUICoreStandaloneMinimap._prebuilding then
            ...
            local cogTex = cogBtn:CreateTexture(nil, "OVERLAY")
            cogTex:SetAllPoints()
            cogTex:SetTexture(EUICoreStandaloneMinimap.RESIZE_ICON)
            cogBtn:SetScript("OnEnter", function(s) s:SetAlpha(0.7) end)
            cogBtn:SetScript("OnLeave", function(s) s:SetAlpha(0.4) end)
            cogBtn:SetScript("OnClick", function(s) cogShow(s) end)
        end
        ...
        if not EUICoreStandaloneMinimap._prebuilding then
            ...
            cogBlock:SetScript("OnEnter", function() EUICoreStandaloneMinimap.ShowWidgetTooltip(cogBtn, EUICoreStandaloneMinimap.DisabledTooltip("Show Omnium Folio")) end)
            cogBlock:SetScript("OnLeave", function() EUICoreStandaloneMinimap.HideWidgetTooltip() end)
        ...
        if not EUICoreStandaloneMinimap._prebuilding then
            ...
            local cogBlock = CreateFrame("Frame", nil, cogBtn)
            cogBlock:SetAllPoints(); cogBlock:SetFrameLevel(cogBtn:GetFrameLevel() + 10); cogBlock:EnableMouse(true)
            cogBlock:SetScript("OnEnter", function() EUICoreStandaloneMinimap.ShowWidgetTooltip(cogBtn, EUICoreStandaloneMinimap.DisabledTooltip("Show Addon Compartment")) end)
            cogBlock:SetScript("OnLeave", function() EUICoreStandaloneMinimap.HideWidgetTooltip() end)
            EUICoreStandaloneMinimap.RegisterWidgetRefresh(function()
        ...
        if not EUICoreStandaloneMinimap._prebuilding then
            ...
            cogBlock:SetScript("OnEnter", function()
                ...
                EUICoreStandaloneMinimap.ShowWidgetTooltip(cogBtn, EUICoreStandaloneMinimap.DisabledTooltip(req))
            end)
            cogBlock:SetScript("OnLeave", function() EUICoreStandaloneMinimap.HideWidgetTooltip() end)
            EUICoreStandaloneMinimap.RegisterWidgetRefresh(function()
                local off = mailOff()
        ...
        if not EUICoreStandaloneMinimap._prebuilding then
            ...
            local cogBlock = CreateFrame("Frame", nil, cogBtn)
            cogBlock:SetAllPoints(); cogBlock:SetFrameLevel(cogBtn:GetFrameLevel() + 10); cogBlock:EnableMouse(true)
            cogBlock:SetScript("OnEnter", function() EUICoreStandaloneMinimap.ShowWidgetTooltip(cogBtn, EUICoreStandaloneMinimap.DisabledTooltip("Square Shape")) end)
            cogBlock:SetScript("OnLeave", function() EUICoreStandaloneMinimap.HideWidgetTooltip() end)
            EUICoreStandaloneMinimap.RegisterWidgetRefresh(function()
                local off = elOff()
                cogBtn:SetAlpha(off and 0.15 or 0.4)
        ...
        if not EUICoreStandaloneMinimap._prebuilding then
            ...
            local cogBlock = CreateFrame("Frame", nil, cogBtn)
            cogBlock:SetAllPoints(); cogBlock:SetFrameLevel(cogBtn:GetFrameLevel() + 10); cogBlock:EnableMouse(true)
            cogBlock:SetScript("OnEnter", function() EUICoreStandaloneMinimap.ShowWidgetTooltip(cogBtn, EUICoreStandaloneMinimap.DisabledTooltip("Clock Style")) end)
            cogBlock:SetScript("OnLeave", function() EUICoreStandaloneMinimap.HideWidgetTooltip() end)
            EUICoreStandaloneMinimap.RegisterWidgetRefresh(function()
                local off = clockOff()
                cogBtn:SetAlpha(off and 0.15 or 0.4)
        ...
        if not EUICoreStandaloneMinimap._prebuilding then
            ...
            local cogBlock = CreateFrame("Frame", nil, cogBtn)
            cogBlock:SetAllPoints(); cogBlock:SetFrameLevel(cogBtn:GetFrameLevel() + 10); cogBlock:EnableMouse(true)
            cogBlock:SetScript("OnEnter", function() EUICoreStandaloneMinimap.ShowWidgetTooltip(cogBtn, EUICoreStandaloneMinimap.DisabledTooltip("Zone Text Style")) end)
            cogBlock:SetScript("OnLeave", function() EUICoreStandaloneMinimap.HideWidgetTooltip() end)
            EUICoreStandaloneMinimap.RegisterWidgetRefresh(function()
                local off = styleOff()
                cogBtn:SetAlpha(off and 0.15 or 0.4)
        ...
        if not EUICoreStandaloneMinimap._prebuilding then
            ...
            local cogBlock = CreateFrame("Frame", nil, cogBtn)
            cogBlock:SetAllPoints(); cogBlock:SetFrameLevel(cogBtn:GetFrameLevel() + 10); cogBlock:EnableMouse(true)
            cogBlock:SetScript("OnEnter", function() EUICoreStandaloneMinimap.ShowWidgetTooltip(cogBtn, EUICoreStandaloneMinimap.DisabledTooltip("Show Coordinates")) end)
            cogBlock:SetScript("OnLeave", function() EUICoreStandaloneMinimap.HideWidgetTooltip() end)
            EUICoreStandaloneMinimap.RegisterWidgetRefresh(function()
                local off = coordsOff()
                cogBtn:SetAlpha(off and 0.15 or 0.4)
        ...
        if not EUICoreStandaloneMinimap._prebuilding then
            ...
            local _, fpsCogShow = EUICoreStandaloneMinimap.BuildCogPopup({
            ...
            fpsCogTex:SetTexture(EUICoreStandaloneMinimap.COGS_ICON)
            ...
            fpsCogBlock:SetScript("OnEnter", function() EUICoreStandaloneMinimap.ShowWidgetTooltip(fpsCogBtn, EUICoreStandaloneMinimap.DisabledTooltip("Show FPS/MS")) end)
            fpsCogBlock:SetScript("OnLeave", function() EUICoreStandaloneMinimap.HideWidgetTooltip() end)
            EUICoreStandaloneMinimap.RegisterWidgetRefresh(function()
                local off = FpsOff()
        ...
        if not EUICoreStandaloneMinimap._prebuilding then
            ...
            local cogBlock = CreateFrame("Frame", nil, cogBtn)
            cogBlock:SetAllPoints(); cogBlock:SetFrameLevel(cogBtn:GetFrameLevel() + 10); cogBlock:EnableMouse(true)
            cogBlock:SetScript("OnEnter", function() EUICoreStandaloneMinimap.ShowWidgetTooltip(cogBtn, EUICoreStandaloneMinimap.DisabledTooltip("Show FPS/MS")) end)
            cogBlock:SetScript("OnLeave", function() EUICoreStandaloneMinimap.HideWidgetTooltip() end)
            EUICoreStandaloneMinimap.RegisterWidgetRefresh(function()
                local off = FpsOff()
                cogBtn:SetAlpha(off and 0.15 or 0.4)
        ...
        if not EUICoreStandaloneMinimap._prebuilding then
            ...
            local cogBlock = CreateFrame("Frame", nil, cogBtn)
            cogBlock:SetAllPoints(); cogBlock:SetFrameLevel(cogBtn:GetFrameLevel() + 10); cogBlock:EnableMouse(true)
            cogBlock:SetScript("OnEnter", function() EUICoreStandaloneMinimap.ShowWidgetTooltip(cogBtn, EUICoreStandaloneMinimap.DisabledTooltip("Show Instance Difficulty as Text")) end)
            cogBlock:SetScript("OnLeave", function() EUICoreStandaloneMinimap.HideWidgetTooltip() end)
            EUICoreStandaloneMinimap.RegisterWidgetRefresh(function()
                local off = diffOff()
                cogBtn:SetAlpha(off and 0.15 or 0.4)
        ...
        if not EUICoreStandaloneMinimap._prebuilding then
            ...
            -- Accent swatch (nearest the control): live theme accent.
            local accentSwatch, updateAccent = EUICoreStandaloneMinimap.BuildColorSwatch(rgn, rgn:GetFrameLevel() + 5,
                function()
                    local ar, ag, ab = EUICoreStandaloneMinimap.GetAccentColor()
                    return ar, ag, ab, 1
                end,
            ...
            local customSwatch, updateCustom = EUICoreStandaloneMinimap.BuildColorSwatch(rgn, rgn:GetFrameLevel() + 5,
                function()
                    local m = MinimapDB()
    ...
    --  Register the module
    ---------------------------------------------------------------------------
    EUICoreStandaloneMinimap:RegisterModule("EUIStandaloneMinimap", {
        title       = "Minimap",
    ...
    SlashCmdList.EMM = function()
        ...
        EUICoreStandaloneMinimap:ShowModule("EUIStandaloneMinimap")
    end
end)
