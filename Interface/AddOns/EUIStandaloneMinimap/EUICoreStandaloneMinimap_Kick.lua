...
--------------------------------------------------------------------------------
--  EUICoreStandaloneMinimap_Kick.lua
...
EUICoreStandaloneMinimap.GetActiveKickSpell = function()
    return activeKickSpell
end
EUICoreStandaloneMinimap.RefreshKickAbility = RefreshKickAbility
EUICoreStandaloneMinimap.ComputeCastBarTint = ComputeCastBarTint
...
function EUICoreStandaloneMinimap.GetSecureMenuProxy(frame)
...
function EUICoreStandaloneMinimap.GetSecureTargetProxy(frame)
    if not frame then return end
...
function EUICoreStandaloneMinimap.AttachSecureUnitMenu(frame)
    if not frame then return end
    local proxy = EUICoreStandaloneMinimap.GetSecureMenuProxy(frame)
