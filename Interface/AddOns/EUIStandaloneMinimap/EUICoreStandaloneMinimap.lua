if _G.__EUISTANDALONE_MINIMAP_INERT then return end
if EUI_CLIENT_BLOCKED then return end -- pre-12.1 client failsafe (EUICoreStandaloneMinimap_ClientGate.lua)
-------------------------------------------------------------------------------
--  EUICoreStandaloneMinimap.lua  -  Custom Options Panel, shared across the whole EUI suite.
--  Scaffold: background, sidebar, header, content area, controls.
-------------------------------------------------------------------------------
local EUI_HOST_ADDON = ...
-- Build renames "EUICoreStandaloneMinimap" -> "EUICoreStandalone<Module>" but never the word
...
local THEME_PRESETS = {
    ["EUICoreStandaloneMinimap"]    = { r = 12/255,  g = 210/255, b = 157/255 },  -- #0CD29D
...
local THEME_ORDER = { "EUICoreStandaloneMinimap", "Horde", "Alliance", "Faction (Auto)", "Midnight", "Dark", "Class Colored", "Custom Color" }
-- Background file paths per theme (relative to MEDIA_PATH, in backgrounds/ subfolder)
local THEME_BG_FILES = {
    ["EUICoreStandaloneMinimap"]   = "backgrounds\\eui-bg-all-compressed.png",
...
do
    local mp = "Interface\\AddOns\\EUIStandaloneMinimap\\media\\"
...
-- EUICoreStandaloneMinimapDB arrives from SavedVariables at ADDON_LOADED. Do NOT create it here --
-- that overwrites saved data. (Stale child SV copy guard lives in EUICoreStandaloneMinimap_Lite.lua.)
...
do
    ...
    local db = EUICoreStandaloneMinimapDB or {}
    local theme = ResolveFactionTheme(db.activeTheme or "EUICoreStandaloneMinimap")
    local r, g, b
...
-- Paths  (media lives in EUICoreStandaloneMinimap/media inside the parent addon folder)
local ADDON_PATH = "Interface\\AddOns\\" .. EUI_HOST_ADDON .. "\\"
local MEDIA_PATH = "Interface\\AddOns\\EUIStandaloneMinimap\\media\\"
...
EUICoreStandaloneMinimap.CLASS_ICON_SPRITE_COORDS = {
...
-- Font (Expressway lives in EUICoreStandaloneMinimap/media)
...
-- EUICoreStandaloneMinimap_Locale.lua from the EFFECTIVE locale (client or override); nil = Expressway.
local LOCALE_FONT_FALLBACK = _G.EUICoreStandaloneMinimap and _G.EUICoreStandaloneMinimap._localeFont or nil
-------------------------------------------------------------------------------
--  Addon Roster  --  per-addon display name + search alias from EUICoreStandaloneMinimap/media
-------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------
EUICoreStandaloneMinimap.SEASON_PORTALS = {
...
local ADDON_ROSTER = {
    { folder = "EUICoreStandaloneMinimapActionBars",        display = "Action Bars",          search_name = "EUICoreStandaloneMinimap Action Bars"             },
    { folder = "EUICoreStandaloneMinimapNameplates",        display = "Nameplates",           search_name = "EUICoreStandaloneMinimap Nameplates"              },
    { folder = "EUICoreStandaloneMinimapUnitFrames",        display = "Unit Frames",          search_name = "EUICoreStandaloneMinimap Unit Frames"             },
    { folder = "EUICoreStandaloneMinimapRaidFrames",        display = "Raid Frames",          search_name = "EUICoreStandaloneMinimap Raid Frames"             },
    { folder = "EUICoreStandaloneMinimapCooldownManager",   display = "Cooldown Manager",     search_name = "EUICoreStandaloneMinimap Cooldown Manager"        },
    { folder = "EUICoreStandaloneMinimapResourceBars",      display = "Resource & Cast Bars", search_name = "EUICoreStandaloneMinimap Resource Bars Cast Bars" },
    { folder = "EUICoreStandaloneMinimapAuraBuffReminders", display = "AuraBuff Reminders",   search_name = "EUICoreStandaloneMinimap AuraBuff Reminders"      },
    { folder = "EUICoreStandaloneMinimapQoL",               display = "Quality of Life",      search_name = "EUICoreStandaloneMinimap Quality of Life"         },
    { folder = "EUICoreStandaloneMinimapBlizzardSkin",      display = "Blizz UI Enhanced",    search_name = "EUICoreStandaloneMinimap Blizz UI Enhanced",      syncFolder = "EUICoreStandaloneMinimapDragonRiding", syncDisplay = "Dragon Riding" },
    { folder = "EUICoreStandaloneMinimapFriends",           display = "Friends List",         search_name = "EUICoreStandaloneMinimap Friends List"            },
    { folder = "EUICoreStandaloneMinimapMythicTimer",       display = "Mythic+ Tools",        search_name = "EUICoreStandaloneMinimap Mythic+ Tools Timer"     },
    { folder = "EUICoreStandaloneMinimapQuestTracker",      display = "Quest Tracker",        search_name = "EUICoreStandaloneMinimap Quest Tracker"           },
    { folder = "EUIStandaloneMinimap",           display = "Minimap",              search_name = "EUICoreStandaloneMinimap Minimap"                 },
    { folder = "EUICoreStandaloneMinimapChat",              display = "Chat",                 search_name = "EUICoreStandaloneMinimap Chat"                    },
    { folder = "EUICoreStandaloneMinimapDamageMeters",      display = "Damage Meters",        search_name = "EUICoreStandaloneMinimap Damage Meters"           },
    { folder = "EUICoreStandaloneMinimapBags",              display = "Bags",                 search_name = "EUICoreStandaloneMinimap Bags"                    },
    { folder = "EUICoreStandaloneMinimapDataBars",          display = "DataBars",             search_name = "EUICoreStandaloneMinimap DataBars"                },
    { folder = "EUICoreStandaloneMinimapQuickdraw",         display = "Quickdraw",            search_name = "EUICoreStandaloneMinimap Quickdraw"               },
    { folder = "EUICoreStandaloneMinimapPartyMode",         display = "Party Mode",           search_name = "EUICoreStandaloneMinimap Party Mode",             alwaysLoaded = true },
}

-------------------------------------------------------------------------------
--  Addon Groups -- ordered sidebar categories (group = text header, no toggle; members
--  = child rows, order authoritative, coming-soon last). On EUICoreStandaloneMinimap, not a file
--  local, to stay under the 200-local / CreateMainFrame 60-upvalue caps.
-------------------------------------------------------------------------------
EUICoreStandaloneMinimap.ADDON_GROUPS = {
    {
        key     = "core",
        label   = "Core Addons",
        members = {
            "EUICoreStandaloneMinimapActionBars",
            "EUICoreStandaloneMinimapNameplates",
            "EUICoreStandaloneMinimapUnitFrames",
            "EUICoreStandaloneMinimapCooldownManager",
            "EUICoreStandaloneMinimapResourceBars",
            "EUICoreStandaloneMinimapRaidFrames",
        },
    },
    {
        key     = "qol",
        label   = "QoL Addons",
        members = {
            "EUICoreStandaloneMinimapQoL",
            "EUICoreStandaloneMinimapAuraBuffReminders",
            "EUICoreStandaloneMinimapDataBars",
            "EUICoreStandaloneMinimapQuickdraw",
            "EUICoreStandaloneMinimapPartyMode",
        },
    },
    {
        key     = "reskin",
        ...
        members = {
            "EUICoreStandaloneMinimapBlizzardSkin",
            "EUICoreStandaloneMinimapDamageMeters",
            "EUICoreStandaloneMinimapMythicTimer",
            "EUICoreStandaloneMinimapQuestTracker",
            "EUICoreStandaloneMinimapFriends",
            "EUIStandaloneMinimap",
            "EUICoreStandaloneMinimapChat",
            "EUICoreStandaloneMinimapBags",
        },
    },
}
...
if IS_STANDALONE then
    ...
    if selfFolder then
        for _, group in ipairs(EUICoreStandaloneMinimap.ADDON_GROUPS) do
        ...
        table.insert(EUICoreStandaloneMinimap.ADDON_GROUPS, 1, {
            key     = "standalone",
            label   = "Standalone",
            members = { selfFolder },
        })
...
-- Flat folder -> roster-info lookup for the grouped sidebar builder. On EUICoreStandaloneMinimap
-- (not a local): CreateMainFrame is up against the Lua 5.1 60-upvalue limit.
EUICoreStandaloneMinimap._addonInfoByFolder = {}
for _, info in ipairs(ADDON_ROSTER) do
    EUICoreStandaloneMinimap._addonInfoByFolder[info.folder] = info
end
...
--  profile switch; outside profiles never push in. Storage: EUICoreStandaloneMinimapDB.syncedModules
--  = { [folder] = { [profileName] = true } }. Exclusions: EUICoreStandaloneMinimap._syncExclusions
...
do
    ...
    local SYNC_EXEMPT = { EUICoreStandaloneMinimapPartyMode = true }
    EUICoreStandaloneMinimap._syncExempt = SYNC_EXEMPT

    -- Modules with a sync icon but no per-profile data (always "synced"). BlizzardSkin hosts
    -- Dragon Riding's per-profile DB; its sync icon routes to EUICoreStandaloneMinimapDragonRiding via syncFolder.
    local SYNC_GLOBAL_ONLY = {}
    EUICoreStandaloneMinimap._syncGlobalOnly = SYNC_GLOBAL_ONLY

    -- Exclusion registry: keys NOT copied during sync (flat or dot-wildcard, see banner)
    local syncExclusions = {}
    EUICoreStandaloneMinimap._syncExclusions = syncExclusions

    function EUICoreStandaloneMinimap.RegisterSyncExclusions(folder, keys)
    ...
    -- EUICoreStandaloneMinimap_SpecOverrides.lua); matcher walks the tree dot-joined so gsub("\30",".") is exact.
    EUICoreStandaloneMinimap._SyncExclusionsWithOverrides = function(folder, staticEx, srcProf, dstProf)
        local merged
        ...
        local function addProf(prof)
            ...
            if folder == "EUICoreStandaloneMinimapRaidFrames" then
    ...
    EUICoreStandaloneMinimap._SelectiveCopy = SelectiveCopy
    ...
    function EUICoreStandaloneMinimap._SelectiveOverlay(src, dst, exclusions, deepCopy, parentPath)
        for k, v in pairs(src) do
            local keyStr = tostring(k)
            local fullKey = parentPath and (parentPath .. "." .. keyStr) or keyStr
            if not exclusions[fullKey] then
                if type(v) == "table" then
                    ...
                    elseif hasNested then
                        if type(dst[k]) ~= "table" then dst[k] = {} end
                        EUICoreStandaloneMinimap._SelectiveOverlay(v, dst[k], exclusions, deepCopy, fullKey)
                    else
                        dst[k] = deepCopy(v)
                    end
                else
    ...
    function EUICoreStandaloneMinimap.IsProfileSynced(folder, profileName)
        if not EUICoreStandaloneMinimapDB then return false end
        local sm = EUICoreStandaloneMinimapDB.syncedModules
    ...
    function EUICoreStandaloneMinimap.GetSyncedProfiles(folder)
        if not EUICoreStandaloneMinimapDB or not EUICoreStandaloneMinimapDB.syncedModules then return {} end
        local targets = EUICoreStandaloneMinimapDB.syncedModules[folder]
    ...
    function EUICoreStandaloneMinimap.IsModuleFullySynced(folder)
        if not EUICoreStandaloneMinimapDB or not EUICoreStandaloneMinimapDB.syncedModules or not EUICoreStandaloneMinimapDB.profiles then return false end
        local targets = EUICoreStandaloneMinimapDB.syncedModules[folder]
        if type(targets) ~= "table" then return false end
        local total = 0
        for name in pairs(EUICoreStandaloneMinimapDB.profiles) do
            total = total + 1
    ...
    function EUICoreStandaloneMinimap.IsModuleSynced(folder)
        if not EUICoreStandaloneMinimapDB or not EUICoreStandaloneMinimapDB.syncedModules then return false end
        local targets = EUICoreStandaloneMinimapDB.syncedModules[folder]
        if type(targets) ~= "table" then return false end
    ...
    function EUICoreStandaloneMinimap.SyncModuleToProfiles(folder, targetProfiles)
        if not EUICoreStandaloneMinimapDB or not EUICoreStandaloneMinimapDB.profiles then return end
        local active = EUICoreStandaloneMinimapDB.activeProfile or "Default"
        local src = EUICoreStandaloneMinimapDB.profiles[active]
        if not src or not src.addons or not src.addons[folder] then return end
        local DeepCopy = EUICoreStandaloneMinimap.Lite and EUICoreStandaloneMinimap.Lite.DeepCopy
        if not DeepCopy then return end

        local staticEx = syncExclusions[folder]
        local exFn = EUICoreStandaloneMinimap._SyncExclusionsWithOverrides
        for profName in pairs(targetProfiles) do
            if profName ~= active then
                local prof = EUICoreStandaloneMinimapDB.profiles[profName]
                if prof then
                    ...
                    if exclusions and next(exclusions) then
                        ...
                        if not dst then
                            ...
                            EUICoreStandaloneMinimap._SelectiveOverlay(src.addons[folder], dst, exclusions, DeepCopy)
                        end
                    else
    ...
    function EUICoreStandaloneMinimap.SetModuleSyncTargets(folder, targetProfiles)
        if not EUICoreStandaloneMinimapDB then return end
        if not EUICoreStandaloneMinimapDB.syncedModules then EUICoreStandaloneMinimapDB.syncedModules = {} end
        EUICoreStandaloneMinimapDB.syncedModules[folder] = targetProfiles
        EUICoreStandaloneMinimap.SyncModuleToProfiles(folder, targetProfiles)
    end
    ...
    function EUICoreStandaloneMinimap.SyncModuleFromProfile(folder, srcName, targets)
        if not EUICoreStandaloneMinimapDB or not EUICoreStandaloneMinimapDB.profiles then return end
        local active = EUICoreStandaloneMinimapDB.activeProfile or "Default"
        if srcName == active then
            EUICoreStandaloneMinimap.SyncModuleToProfiles(folder, targets)
            return
        end
        local DeepCopy = EUICoreStandaloneMinimap.Lite and EUICoreStandaloneMinimap.Lite.DeepCopy
        if not DeepCopy then return end
        local srcProf = EUICoreStandaloneMinimapDB.profiles[srcName]
            ...
            if profName ~= srcName then
                ...
                if prof then
                    ...
                    if profName == active then
                        ...
                        if exclusions and next(exclusions) then
                            EUICoreStandaloneMinimap._SelectiveOverlay(srcData, dst, exclusions, DeepCopy)
                        else
                            wipe(dst)
        ...
        if targets[active] then
            ...
            local reg = EUICoreStandaloneMinimap.Lite._dbRegistry
            if reg then
                for _, rdb in ipairs(reg) do
                    if rdb.folder == folder then
                        if rdb._profileDefaults and rdb.profile then
                            EUICoreStandaloneMinimap.Lite.DeepMergeDefaults(rdb.profile, rdb._profileDefaults)
                        end
                        break
                    end
                end
            end
            if EUICoreStandaloneMinimap.RefreshAllAddons then
                EUICoreStandaloneMinimap.RefreshAllAddons()
            end
            if EUICoreStandaloneMinimap.RefreshPage then
                EUICoreStandaloneMinimap:RefreshPage()
            end
        end
    end
    ...
    initFrame:SetScript("OnEvent", function(self)
        ...
        if EUICoreStandaloneMinimap.Lite and EUICoreStandaloneMinimap.Lite.RegisterPreLogout then
            EUICoreStandaloneMinimap.Lite.RegisterPreLogout(function()
                if not EUICoreStandaloneMinimapDB or not EUICoreStandaloneMinimapDB.syncedModules then return end
                local active = EUICoreStandaloneMinimapDB.activeProfile or "Default"
                for folder, targets in pairs(EUICoreStandaloneMinimapDB.syncedModules) do
...
-------------------------------------------------------------------------------
EUICoreStandaloneMinimap.RegisterSyncExclusions("EUICoreStandaloneMinimapActionBars", {
    "barPositions",
    "bars.*.growDirection",
    "bars.*.orientation",
    "bars.*.buttonWidth",
...
EUICoreStandaloneMinimap.RegisterSyncExclusions("EUICoreStandaloneMinimapUnitFrames", {
    "positions",
...
EUICoreStandaloneMinimap.RegisterSyncExclusions("EUICoreStandaloneMinimapCooldownManager", {
    "cdmBarPositions",
...
EUICoreStandaloneMinimap.RegisterSyncExclusions("EUICoreStandaloneMinimapResourceBars", {
...
EUICoreStandaloneMinimap.RegisterSyncExclusions("EUICoreStandaloneMinimapAuraBuffReminders", {
    "unlockPos",
    "display.xOffset", "display.yOffset",
})

EUICoreStandaloneMinimap.RegisterSyncExclusions("EUICoreStandaloneMinimapRaidFrames", {
    "unlockPos",
})

EUICoreStandaloneMinimap.RegisterSyncExclusions("EUICoreStandaloneMinimapMythicTimer", {
    "standalonePos",
    "scale",
    "frameWidth",
})
...
EUICoreStandaloneMinimap.RegisterSyncExclusions("EUICoreStandaloneMinimapDragonRiding", {
    "unlockPos",
})
...
EUICoreStandaloneMinimap.RegisterSyncExclusions("EUICoreStandaloneMinimapQoL", {
    "secondaryStatsPos",
    "fpsPos",
    "cursor.gcd.pos",
...
EUICoreStandaloneMinimap.RegisterSyncExclusions("EUIStandaloneMinimap", {
...
EUICoreStandaloneMinimap.RegisterSyncExclusions("EUICoreStandaloneMinimapChat", {
...
EUICoreStandaloneMinimap.RegisterSyncExclusions("EUICoreStandaloneMinimapDamageMeters", {
...
EUICoreStandaloneMinimap.RegisterSyncExclusions("EUICoreStandaloneMinimapDataBars", {
...
EUICoreStandaloneMinimap.RegisterSyncExclusions("EUICoreStandaloneMinimapBags", {
...
do
    ...
    function EUICoreStandaloneMinimap.CloseSyncPopup()
        if _syncPopup then _syncPopup:Hide() end
        if EUICoreStandaloneMinimap._syncConfirmFrame then EUICoreStandaloneMinimap._syncConfirmFrame:Hide() end
    end
    ...
    function EUICoreStandaloneMinimap._ShowSyncSeedConfirm(opts)
        local fontPath = (EUICoreStandaloneMinimap.GetFontPath and EUICoreStandaloneMinimap.GetFontPath()) or "Fonts\\FRIZQT__.TTF"
        local PP = EUICoreStandaloneMinimap.PanelPP or EUICoreStandaloneMinimap.PP
        local W, PAD = 360, 18

        if not EUICoreStandaloneMinimap._syncConfirmFrame then
            ...
            EUICoreStandaloneMinimap._syncConfirmFrame = nf
        end
        local f = EUICoreStandaloneMinimap._syncConfirmFrame
        ...
        local function MakeFont(parent, size, r, g, b, a)
            ...
            if EUICoreStandaloneMinimap and EUICoreStandaloneMinimap.PrimeFontShadow then EUICoreStandaloneMinimap.PrimeFontShadow(fs, true) end
            fs:SetFont(fontPath, size, "")
            fs:SetTextColor(r or 1, g or 1, b or 1, a or 1)
            return fs
        end

        if PP then EUICoreStandaloneMinimap.MakeBorder(f, 1, 1, 1, 0.15, PP) end
        f:ClearAllPoints()
        ...
        title:SetText(EUICoreStandaloneMinimap.L(opts.hadGroup and "Update Sync Group" or "Create Sync Group"))
        cy = cy - 22 - 8
        ...
        msg:SetText(EUICoreStandaloneMinimap.Lf("All selected profiles will keep their %1$s settings in sync: changes made on any of them carry over to the others. Choose which profile's settings the group starts from.", EUICoreStandaloneMinimap.L(opts.displayName)))
        cy = cy - (msg:GetStringHeight() or 42) - 14

        local ddLabel = MakeFont(f, 11, 1, 1, 1, 0.5)
        ddLabel:SetPoint("TOP", f, "TOP", 0, cy)
        ddLabel:SetText(EUICoreStandaloneMinimap.L("Sync settings from:"))
        cy = cy - 16 - 6
        ...
        local ddBtn = EUICoreStandaloneMinimap.BuildDropdownControl(ddHolder, DD_W, ddHolder:GetFrameLevel() + 1,
        ...
        if opts.hasWarning then
            ...
            warn:SetText(EUICoreStandaloneMinimap.L("Position and size settings are not synced and keep each profile's own values."))
        ...
        local function MakeBtn(label, r, g, b, a, hr, hg, hb)
            ...
            if EUICoreStandaloneMinimap and EUICoreStandaloneMinimap.PrimeFontShadow then EUICoreStandaloneMinimap.PrimeFontShadow(lbl, false) end
        ...
        local cancelBtn = MakeBtn(EUICoreStandaloneMinimap.L("Cancel"), 0.18, 0.19, 0.22, 0.9, 0.25, 0.26, 0.3)
        cancelBtn:SetPoint("TOPRIGHT", f, "TOP", -6, cy)
        local confirmBtn = MakeBtn(EUICoreStandaloneMinimap.L("Sync"), 0.05, 0.52, 0.39, 0.8, 0.07, 0.62, 0.49)
        ...
        confirmBtn:SetScript("OnClick", function()
            f:Hide()
            if not EUICoreStandaloneMinimapDB.syncedModules then EUICoreStandaloneMinimapDB.syncedModules = {} end
            EUICoreStandaloneMinimapDB.syncedModules[opts.folder] = opts.targets
            if seedChoice then
                EUICoreStandaloneMinimap.SyncModuleFromProfile(opts.folder, seedChoice, opts.targets)
            end
    ...
    function EUICoreStandaloneMinimap.OpenSyncPopup(folder, displayName, anchorBtn)
        if EUICoreStandaloneMinimap._syncConfirmFrame then EUICoreStandaloneMinimap._syncConfirmFrame:Hide() end
        ...
        if not EUICoreStandaloneMinimapDB or not EUICoreStandaloneMinimapDB.profiles then return end
        local active = EUICoreStandaloneMinimapDB.activeProfile or "Default"
        local profileOrder = EUICoreStandaloneMinimapDB.profileOrder or {}
        ...
        for _, name in ipairs(profileOrder) do
            if EUICoreStandaloneMinimapDB.profiles[name] then
        ...
        if #allProfiles <= 1 then
            if EUICoreStandaloneMinimap.ShowWidgetTooltip then
                EUICoreStandaloneMinimap.ShowWidgetTooltip(anchorBtn, "No other profiles to sync to")
                C_Timer.After(1.5, function() EUICoreStandaloneMinimap.HideWidgetTooltip() end)
            end
            return
        end
        ...
        local MEDIA_PATH = "Interface\\AddOns\\EUIStandaloneMinimap\\media\\"
        local fontPath = (EUICoreStandaloneMinimap.GetFontPath and EUICoreStandaloneMinimap.GetFontPath()) or "Fonts\\FRIZQT__.TTF"
        local accentColor = EUICoreStandaloneMinimap.ACCENT_COLOR or EUICoreStandaloneMinimap.ELLESMERE_GREEN or { r = 0.05, g = 0.82, b = 0.62 }
        local PP = EUICoreStandaloneMinimap.PanelPP or EUICoreStandaloneMinimap.PP
        ...
        local HEADER_H = 26
        local WARN_MODULES = {
            EUICoreStandaloneMinimapActionBars = true,
            EUICoreStandaloneMinimapUnitFrames = true,
            EUICoreStandaloneMinimapCooldownManager = true,
            EUICoreStandaloneMinimapResourceBars = true,
            EUICoreStandaloneMinimapMythicTimer = true,
            EUICoreStandaloneMinimapRaidFrames = true,
        }
        ...
        if PP then
            EUICoreStandaloneMinimap.MakeBorder(popup, 1, 1, 1, 0.15, PP)
        end

        -- Position: flush right of sidebar, centered on the sync icon, clamped
        local sidebar = EUICoreStandaloneMinimap._sidebar
        local root = EUICoreStandaloneMinimap._mainFrame
        ...
        if EUICoreStandaloneMinimap.IsModuleSynced(folder) then
        ...
        title:SetText(EUICoreStandaloneMinimap.Lf("%1$s Sync", EUICoreStandaloneMinimap.L(displayName)))
        cy = cy - HEADER_H - 7
        ...
        subtitle:SetText(EUICoreStandaloneMinimap.L("Syncing allows you to auto update all profiles whenever you change settings. This can be enabled per module."))
        cy = cy - SUBTITLE_H - 14

        -- Toggle rows for every profile (the active one included)
        local currentSynced = EUICoreStandaloneMinimap.GetSyncedProfiles(folder)
        local toggleState = {}
        ...
        local BuildToggleControl = EUICoreStandaloneMinimap.BuildToggleControl
        ...
        local sBrd
        if PP then
            sBrd = EUICoreStandaloneMinimap.MakeBorder(syncBtn, accentColor.r, accentColor.g, accentColor.b, 0.7, PP)
        end
        local sLbl = syncBtn:CreateFontString(nil, "OVERLAY")
        if EUICoreStandaloneMinimap and EUICoreStandaloneMinimap.PrimeFontShadow then EUICoreStandaloneMinimap.PrimeFontShadow(sLbl, false) end
        ...
        refreshSyncBtnLabel = function()
            ...
            if hadGroup and count == 0 then
                sLbl:SetText(EUICoreStandaloneMinimap.L("Disband Sync Group"))
            elseif hadGroup then
                sLbl:SetText(EUICoreStandaloneMinimap.L("Update Sync Group"))
            else
                sLbl:SetText(EUICoreStandaloneMinimap.L("Create Sync Group"))
            end
            ApplyBtnState(dirty)
        end
        refreshSyncBtnLabel()
        ...
        local function RefreshSidebarSyncIcon()
            local sidebarBtns = EUICoreStandaloneMinimap._sidebarButtons
        ...
        syncBtn:SetScript("OnClick", function()
            ...
            if count == 0 then
                ...
                if not EUICoreStandaloneMinimapDB.syncedModules then EUICoreStandaloneMinimapDB.syncedModules = {} end
                EUICoreStandaloneMinimapDB.syncedModules[folder] = {}
                popup:Hide()
            ...
            if count == 1 then
                if EUICoreStandaloneMinimap.ShowWidgetTooltip then
                    EUICoreStandaloneMinimap.ShowWidgetTooltip(syncBtn, "A sync group needs at least two profiles")
                    C_Timer.After(1.5, function() EUICoreStandaloneMinimap.HideWidgetTooltip() end)
                end
                return
            end
            ...
            if not anyNew then
                ...
                if not EUICoreStandaloneMinimapDB.syncedModules then EUICoreStandaloneMinimapDB.syncedModules = {} end
                EUICoreStandaloneMinimapDB.syncedModules[folder] = targets
                popup:Hide()
                RefreshSidebarSyncIcon()
                return
            end
            ...
            EUICoreStandaloneMinimap._ShowSyncSeedConfirm({
                folder = folder,
...
-------------------------------------------------------------------------------
local EUICoreStandaloneMinimap = _G.EUICoreStandaloneMinimap or {}
_G.EUICoreStandaloneMinimap = EUICoreStandaloneMinimap
EUICoreStandaloneMinimap.GLOBAL_KEY = "_EUIGlobal"
EUICoreStandaloneMinimap.ADDON_ROSTER = ADDON_ROSTER
EUICoreStandaloneMinimap.LOCALE_FONT_FALLBACK = LOCALE_FONT_FALLBACK
...
EUICoreStandaloneMinimap.LOCALE_SCRIPT = EUICoreStandaloneMinimap._localeScript
EUICoreStandaloneMinimap.EXPRESSWAY = LOCALE_FONT_FALLBACK or EXPRESSWAY
...
function EUICoreStandaloneMinimap.Print(...)
...
function EUICoreStandaloneMinimap.RunBudgeted(steps, msBudget, onDone)
    local idx, n = 1, #steps
...
-- On EUICoreStandaloneMinimap (not a local) to save a CreateMainFrame upvalue; used by CreateMainFrame, RefreshSidebarStates, _applySidebarSearch.
EUICoreStandaloneMinimap._sidebarGroupButtons = {}
local activeModule, activePage
local _lastPagePerModule = {}
local modules = {}
EUICoreStandaloneMinimap._modules = modules -- read-only alias so other files (e.g. global search) can iterate registered modules
...
EUICoreStandaloneMinimap.RegisterWidgetRefresh = RegisterWidgetRefresh
...
function EUICoreStandaloneMinimap._SnapshotAndClearWidgetRefreshList()
    local snap = {}
    for i = 1, #_widgetRefreshList do snap[i] = _widgetRefreshList[i] end
    ClearWidgetRefreshList()
    return snap
end
function EUICoreStandaloneMinimap._RestoreWidgetRefreshList(snap)
    ClearWidgetRefreshList()
...
do
    ...
    HideAllChildren = function(parent, keepSet)
        ...
        if EUICoreStandaloneMinimap._hideScrollFrameRoots then
            EUICoreStandaloneMinimap._hideScrollFrameRoots()
        end
    end
end
...
local function MakeBorder(parent, r, g, b, a, ppOverride)
    ...
    if not EUICoreStandaloneMinimap._onScaleChanged then EUICoreStandaloneMinimap._onScaleChanged = {} end
    EUICoreStandaloneMinimap._onScaleChanged[#EUICoreStandaloneMinimap._onScaleChanged + 1] = function()
...
local function RowBg(frame, parent)
    ...
    local ppp = EUICoreStandaloneMinimap.PanelPP or PP
...
-------------------------------------------------------------------------------
--  Exports  (shared locals EUICoreStandaloneMinimap table for split files)
-------------------------------------------------------------------------------
-- Visual constants (tables)
EUICoreStandaloneMinimap.ELLESMERE_GREEN = ELLESMERE_GREEN
EUICoreStandaloneMinimap.DARK_BG         = DARK_BG
EUICoreStandaloneMinimap.BORDER_COLOR    = BORDER_COLOR
EUICoreStandaloneMinimap.TEXT_WHITE       = TEXT_WHITE
EUICoreStandaloneMinimap.TEXT_DIM         = TEXT_DIM
EUICoreStandaloneMinimap.TEXT_SECTION     = TEXT_SECTION
EUICoreStandaloneMinimap.CS              = CS

-- Shared icon paths
EUICoreStandaloneMinimap.COGS_ICON       = MEDIA_PATH .. "icons\\cogs-3.png"
EUICoreStandaloneMinimap.UNDO_ICON       = MEDIA_PATH .. "icons\\undo.png"
EUICoreStandaloneMinimap.RESIZE_ICON     = MEDIA_PATH .. "icons\\eui-resize-5.png"
EUICoreStandaloneMinimap.DIRECTIONS_ICON = MEDIA_PATH .. "icons\\eui-directions.png"
EUICoreStandaloneMinimap.SYNC_ICON       = MEDIA_PATH .. "icons\\sync.png"
EUICoreStandaloneMinimap.EYE_VISIBLE_ICON   = MEDIA_PATH .. "icons\\eui-visible.png"
EUICoreStandaloneMinimap.EYE_INVISIBLE_ICON = MEDIA_PATH .. "icons\\eui-invisible.png"
...
EUICoreStandaloneMinimap.POSITION_GRID_VALUES = {
    ["topleft"]    = "Top Left",
    ["top"]        = "Top",
    ["topright"]   = "Top Right",
    ["left"]       = "Left",
...
EUICoreStandaloneMinimap.POSITION_GRID_VALUES_NONE = {
    ["topleft"]    = "Top Left",
    ["top"]        = "Top",
    ["topright"]   = "Top Right",
    ["left"]       = "Left",
...
EUICoreStandaloneMinimap.POSITION_GRID_ORDER = { "topleft", "top", "topright", "left", "center", "right", "bottomleft", "bottom", "bottomright" }
EUICoreStandaloneMinimap.FRAME_STRATA_LABELS = {
...
EUICoreStandaloneMinimap.FRAME_STRATA_ORDER_BASE = { "BACKGROUND", "LOW", "MEDIUM", "HIGH", "DIALOG" }
EUICoreStandaloneMinimap.FRAME_STRATA_ORDER_FULL = { "BACKGROUND", "LOW", "MEDIUM", "HIGH", "DIALOG", "FULLSCREEN", "FULLSCREEN_DIALOG", "TOOLTIP" }
EUICoreStandaloneMinimap.GROW_DIR_VALUES_FULL = { RIGHT = "Right", LEFT = "Left", UP = "Up", DOWN = "Down", CENTER = "Center" }
EUICoreStandaloneMinimap.GROW_DIR_ORDER_FULL  = { "RIGHT", "LEFT", "UP", "DOWN", "CENTER" }
EUICoreStandaloneMinimap.GROW_DIR_VALUES_BASE = { RIGHT = "Right", LEFT = "Left", UP = "Up", DOWN = "Down" }
EUICoreStandaloneMinimap.GROW_DIR_ORDER_BASE  = { "RIGHT", "LEFT", "UP", "DOWN" }
...
EUICoreStandaloneMinimap.ALERT_SOUND_FILES = {
...
EUICoreStandaloneMinimap.ALERT_SOUND_NAMES = {
...
EUICoreStandaloneMinimap.ALERT_SOUND_ORDER = {
...
function EUICoreStandaloneMinimap.BuildAlertSoundTables()
    local dir = MEDIA_PATH .. "sounds\\"
    local paths, names, order = {}, {}, {}
    for i, k in ipairs(EUICoreStandaloneMinimap.ALERT_SOUND_ORDER) do
        order[i] = k
        names[k] = EUICoreStandaloneMinimap.ALERT_SOUND_NAMES[k]
        local f = EUICoreStandaloneMinimap.ALERT_SOUND_FILES[k]
...
EUICoreStandaloneMinimap.BAR_TEXTURE_FILES = {
...
EUICoreStandaloneMinimap.BAR_TEXTURE_NAMES = {
...
EUICoreStandaloneMinimap.BAR_TEXTURE_ORDER = {
    "none", "melli", "atrocity",
    "fade", "fade-right",
...
function EUICoreStandaloneMinimap.BuildBarTextureTables(includeExtras)
    local dir = MEDIA_PATH .. "textures\\"
    local tex, names, order = {}, {}, {}
    for _, k in ipairs(EUICoreStandaloneMinimap.BAR_TEXTURE_ORDER) do
        if includeExtras or (k ~= "blinkii-diamonds" and k ~= "kringel-window") then
            order[#order + 1] = k
            names[k] = EUICoreStandaloneMinimap.BAR_TEXTURE_NAMES[k]
            local f = EUICoreStandaloneMinimap.BAR_TEXTURE_FILES[k]
...
-- Numeric constants
EUICoreStandaloneMinimap.TEXT_WHITE_R = TEXT_WHITE_R
EUICoreStandaloneMinimap.TEXT_WHITE_G = TEXT_WHITE_G
EUICoreStandaloneMinimap.TEXT_WHITE_B = TEXT_WHITE_B
EUICoreStandaloneMinimap.TEXT_DIM_R = TEXT_DIM_R
EUICoreStandaloneMinimap.TEXT_DIM_G = TEXT_DIM_G
EUICoreStandaloneMinimap.TEXT_DIM_B = TEXT_DIM_B
EUICoreStandaloneMinimap.TEXT_DIM_A = TEXT_DIM_A
EUICoreStandaloneMinimap.TEXT_SECTION_R = TEXT_SECTION_R
EUICoreStandaloneMinimap.TEXT_SECTION_G = TEXT_SECTION_G
EUICoreStandaloneMinimap.TEXT_SECTION_B = TEXT_SECTION_B
EUICoreStandaloneMinimap.TEXT_SECTION_A = TEXT_SECTION_A
EUICoreStandaloneMinimap.ROW_BG_ODD  = ROW_BG_ODD
EUICoreStandaloneMinimap.ROW_BG_EVEN = ROW_BG_EVEN
EUICoreStandaloneMinimap.BORDER_R = BORDER_R
EUICoreStandaloneMinimap.BORDER_G = BORDER_G
EUICoreStandaloneMinimap.BORDER_B = BORDER_B
EUICoreStandaloneMinimap.CONTENT_PAD = CONTENT_PAD
-- Slider
EUICoreStandaloneMinimap.SL_TRACK_R = SL_TRACK_R
EUICoreStandaloneMinimap.SL_TRACK_G = SL_TRACK_G
EUICoreStandaloneMinimap.SL_TRACK_B = SL_TRACK_B
EUICoreStandaloneMinimap.SL_TRACK_A = SL_TRACK_A
EUICoreStandaloneMinimap.SL_FILL_A  = SL_FILL_A
EUICoreStandaloneMinimap.SL_INPUT_R = SL_INPUT_R
EUICoreStandaloneMinimap.SL_INPUT_G = SL_INPUT_G
EUICoreStandaloneMinimap.SL_INPUT_B = SL_INPUT_B
EUICoreStandaloneMinimap.SL_INPUT_A = SL_INPUT_A
EUICoreStandaloneMinimap.SL_INPUT_BRD_A = SL_INPUT_BRD_A
EUICoreStandaloneMinimap.MW_INPUT_ALPHA_BOOST = MW_INPUT_ALPHA_BOOST
EUICoreStandaloneMinimap.MW_TRACK_ALPHA_BOOST = MW_TRACK_ALPHA_BOOST
-- Toggle
EUICoreStandaloneMinimap.TG_OFF_R = TG_OFF_R
EUICoreStandaloneMinimap.TG_OFF_G = TG_OFF_G
EUICoreStandaloneMinimap.TG_OFF_B = TG_OFF_B
EUICoreStandaloneMinimap.TG_OFF_A = TG_OFF_A
EUICoreStandaloneMinimap.TG_ON_A  = TG_ON_A
EUICoreStandaloneMinimap.TG_KNOB_OFF_R = TG_KNOB_OFF_R
EUICoreStandaloneMinimap.TG_KNOB_OFF_G = TG_KNOB_OFF_G
EUICoreStandaloneMinimap.TG_KNOB_OFF_B = TG_KNOB_OFF_B
EUICoreStandaloneMinimap.TG_KNOB_OFF_A = TG_KNOB_OFF_A
EUICoreStandaloneMinimap.TG_KNOB_ON_R  = TG_KNOB_ON_R
EUICoreStandaloneMinimap.TG_KNOB_ON_G  = TG_KNOB_ON_G
EUICoreStandaloneMinimap.TG_KNOB_ON_B  = TG_KNOB_ON_B
EUICoreStandaloneMinimap.TG_KNOB_ON_A  = TG_KNOB_ON_A
-- Checkbox
EUICoreStandaloneMinimap.CB_BOX_R = CB_BOX_R
EUICoreStandaloneMinimap.CB_BOX_G = CB_BOX_G
EUICoreStandaloneMinimap.CB_BOX_B = CB_BOX_B
EUICoreStandaloneMinimap.CB_BRD_A     = CB_BRD_A
EUICoreStandaloneMinimap.CB_ACT_BRD_A = CB_ACT_BRD_A
-- Button
EUICoreStandaloneMinimap.BTN_BG_R  = BTN_BG_R
EUICoreStandaloneMinimap.BTN_BG_G  = BTN_BG_G
EUICoreStandaloneMinimap.BTN_BG_B  = BTN_BG_B
EUICoreStandaloneMinimap.BTN_BG_A  = BTN_BG_A
EUICoreStandaloneMinimap.BTN_BG_HA = BTN_BG_HA
EUICoreStandaloneMinimap.BTN_BRD_A  = BTN_BRD_A
EUICoreStandaloneMinimap.BTN_BRD_HA = BTN_BRD_HA
EUICoreStandaloneMinimap.BTN_TXT_A  = BTN_TXT_A
EUICoreStandaloneMinimap.BTN_TXT_HA = BTN_TXT_HA
-- Dropdown
EUICoreStandaloneMinimap.DD_BG_R  = DD_BG_R
EUICoreStandaloneMinimap.DD_BG_G  = DD_BG_G
EUICoreStandaloneMinimap.DD_BG_B  = DD_BG_B
EUICoreStandaloneMinimap.DD_BG_A  = DD_BG_A
EUICoreStandaloneMinimap.DD_BG_HA = DD_BG_HA
EUICoreStandaloneMinimap.DD_BRD_A  = DD_BRD_A
EUICoreStandaloneMinimap.DD_BRD_HA = DD_BRD_HA
EUICoreStandaloneMinimap.DD_TXT_A  = DD_TXT_A
EUICoreStandaloneMinimap.DD_TXT_HA = DD_TXT_HA
EUICoreStandaloneMinimap.DD_ITEM_HL_A  = DD_ITEM_HL_A
EUICoreStandaloneMinimap.DD_ITEM_SEL_A = DD_ITEM_SEL_A
-- Blizzard reskin colors (tooltips, context menus, popups)
EUICoreStandaloneMinimap.RESKIN = {
...
-- EUICoreStandaloneMinimapDB); unset = RESKIN palette. Returns r,g,b,a (0 is valid: Lua 0 is truthy, so `or` fallback fires on nil only).
function EUICoreStandaloneMinimap.GetTooltipBg()
    local db = EUICoreStandaloneMinimapDB
    local c = db and db.tooltipBgColor
    local R = EUICoreStandaloneMinimap.RESKIN
...
function EUICoreStandaloneMinimap.GetTooltipBorder()
    local db = EUICoreStandaloneMinimapDB
    local c = db and db.tooltipBorderColor
    local r = (c and c.r) or 1
    local g = (c and c.g) or 1
    local b = (c and c.b) or 1
    local a = (db and db.tooltipBorderOpacity) or EUICoreStandaloneMinimap.RESKIN.BRD_ALPHA
    local size = (db and db.tooltipBorderSize) or 1
    return r, g, b, a, size
end
-- Layout
EUICoreStandaloneMinimap.DUAL_ITEM_W  = DUAL_ITEM_W
EUICoreStandaloneMinimap.DUAL_GAP     = DUAL_GAP
EUICoreStandaloneMinimap.TRIPLE_ITEM_W = TRIPLE_ITEM_W
EUICoreStandaloneMinimap.TRIPLE_GAP    = TRIPLE_GAP

-- Table constants
EUICoreStandaloneMinimap.CLASS_COLOR_MAP = CLASS_COLOR_MAP
EUICoreStandaloneMinimap.CLASS_ART_MAP   = CLASS_ART_MAP
...
do
    ...
    EUICoreStandaloneMinimap.UPGRADE_TRACK_KEYS = KEYS
    ...
    function EUICoreStandaloneMinimap.GetUpgradeTrackKey(itemLink)
...
do
    ...
    local need = en and (
        (en("EUICoreStandaloneMinimapBags") or 0) > 0
        or ((en("EUICoreStandaloneMinimapBlizzardSkin") or 0) > 0
            and (not EUICoreStandaloneMinimapDB
                 or EUICoreStandaloneMinimapDB.themedCharacterSheet ~= false
                 or EUICoreStandaloneMinimapDB.themedInspectSheet ~= false))
    )
    if need then
        ...
        EUICoreStandaloneMinimap._TRACK_WHITE = W
        EUICoreStandaloneMinimap._TRACK_RANK = { [GR] = 1, [W] = 2, [VE] = 3, [CH] = 4, [HE] = 5, [MY] = 6 }
        ...
        function EUICoreStandaloneMinimap.GetUpgradeTrack(itemLink)
            local key, cur, maxL = EUICoreStandaloneMinimap.GetUpgradeTrackKey(itemLink)
        ...
        function EUICoreStandaloneMinimap.GetItemLevelColor(itemLink, itemQuality)
            if EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.charSheetItemLevelUseColor
                and EUICoreStandaloneMinimapDB.charSheetItemLevelColor then
                return EUICoreStandaloneMinimapDB.charSheetItemLevelColor
            end
            local upgradeText, upgradeColor = EUICoreStandaloneMinimap.GetUpgradeTrack(itemLink)
            if upgradeText and upgradeText ~= "" and upgradeColor then
                return upgradeColor
            end
            if (not EUICoreStandaloneMinimapDB or EUICoreStandaloneMinimapDB.charSheetColorItemLevel ~= false) and itemQuality then
...
--  Usage: local PP = EUICoreStandaloneMinimap.PP
...
do
    ...
    local PP = {}
    EUICoreStandaloneMinimap.PP = PP
    ...
    function PP.UpdateMult()
        PP.RefreshPhysical()
        local uiScale = EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.ppUIScale or PP.PixelBestSize()
    ...
    function PP.SetUIScale(newScale)
        ...
        if not EUICoreStandaloneMinimapDB then EUICoreStandaloneMinimapDB = {} end
        local currentScale = UIParent and UIParent:GetScale() or 1
        local scaleChanged = math.abs(currentScale - newScale) > 0.0001
        EUICoreStandaloneMinimapDB.ppUIScale = newScale
        UIParent:SetScale(newScale)
        PP.UpdateMult()
        if scaleChanged then
            -- Re-snap all stored values to the new pixel grid
            if EUICoreStandaloneMinimap.SnapProfilePositions then
                local activeName = EUICoreStandaloneMinimapDB.activeProfile or "Default"
                local profData = EUICoreStandaloneMinimapDB.profiles and EUICoreStandaloneMinimapDB.profiles[activeName]
                if profData then EUICoreStandaloneMinimap.SnapProfilePositions(profData) end
            end
            ...
            if EUICoreStandaloneMinimap.ApplyAllWidthHeightMatches then
                ...
                PP._scaleMatchDebounce = C_Timer.NewTimer(0.3, function()
                    ...
                    EUICoreStandaloneMinimap.ApplyAllWidthHeightMatches()
                end)
            end
        end
    end
    ...
    ---------------------------------------------------------------------------
    --  UNIFIED BORDER SYSTEM -- the single border API for every EUICoreStandaloneMinimap addon. 4 manual
        ...
        for i = 1, allBordersN do
            ...
            if c and f then
                ...
                if not ok then
                    ...
                    local AKR = EUICoreStandaloneMinimap and EUICoreStandaloneMinimap.AuraKit
    ...
    scaleWatcher:SetScript("OnEvent", function(_, event)
        if event == "DISPLAY_SIZE_CHANGED" then
            ...
            if EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.ppUIScaleAuto == true then
        ...
        local mf = EUICoreStandaloneMinimap._mainFrame
        if mf and mf:IsShown() then
            ...
            if physW and physW > 0 and sw and sw > 0 then
                ...
                local userScale = (EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.panelScale) or 1.0
                mf:SetScale(baseScale * userScale)
                if EUICoreStandaloneMinimap.PanelPP then EUICoreStandaloneMinimap.PanelPP.UpdateMult() end
            end
        end
    end)
end
...
PP = EUICoreStandaloneMinimap.PP
-------------------------------------------------------------------------------
...
do
    local PanelPP = {}
    EUICoreStandaloneMinimap.PanelPP = PanelPP
...
local PanelPP = EUICoreStandaloneMinimap.PanelPP
...
--  API:
--    EUICoreStandaloneMinimap.GetBorderTextureList()       -- sorted {key,name} array
--    EUICoreStandaloneMinimap.GetBorderTextureDropdown()    -- values + order for W:DualRow
--    EUICoreStandaloneMinimap.ResolveBorderTexture(key)     -- key -> edgeFile path (nil for solid)
--    EUICoreStandaloneMinimap.ApplyBorderStyle(frame, sz, r,g,b,a, textureKey)
--    EUICoreStandaloneMinimap.SetBorderStyleColor(frame, r,g,b,a)
-------------------------------------------------------------------------------
do
    local _bdBorderData = setmetatable({}, { __mode = "k" })
    EUICoreStandaloneMinimap._bdBorderData = _bdBorderData
    ...
    -- Register: EUICoreStandaloneMinimap.RegisterBorderDefaults(addonKey, table);
    -- read: EUICoreStandaloneMinimap.GetBorderDefaults(addonKey, textureKey, sizeKey).
    local _borderDefaults = {}

    function EUICoreStandaloneMinimap.RegisterBorderDefaults(addonKey, defaults)
    ...
    function EUICoreStandaloneMinimap.GetBorderDefaults(addonKey, textureKey, sizeKey)
    ...
    function EUICoreStandaloneMinimap.GetBorderDefaultSize(addonKey, textureKey)
        if textureKey == "shadow" then textureKey = "glow" end  -- Shadow shares Glow's defaults
        local addon = _borderDefaults[addonKey]
    ...
    EUICoreStandaloneMinimap._builtinBorderTextures = {
        { key = "solid",   name = "Solid" },
        { key = "glow",    name = "Glow",            path = "Interface\\AddOns\\EUIStandaloneMinimap\\media\\borders\\glow-border",  defaultOffset = 0, defaultOffsetY = 0, scaleOffset = true, defaultThickness = "normal" },
        ...
        { key = "shadow",  name = "Shadow",          path = "Interface\\AddOns\\EUIStandaloneMinimap\\media\\borders\\glow-border",  defaultOffset = 0, defaultOffsetY = 0, scaleOffset = true, defaultThickness = "normal" },
        { key = "blizz",   name = "Blizzard",        path = "Interface\\AddOns\\EUIStandaloneMinimap\\media\\borders\\blizz-border", defaultOffset = 3, defaultOffsetY = 2, scaleOffset = true, defaultThickness = "heavy" },
        { key = "lightspark", name = "Lightspark Border", path = "Interface\\AddOns\\EUIStandaloneMinimap\\media\\borders\\lightspark-border", defaultOffset = 0, defaultOffsetY = 0, scaleOffset = true, defaultThickness = "normal" },
    ...
    function EUICoreStandaloneMinimap.GetBorderTextureList()
        local list = {}
        local seen = {}
        for _, entry in ipairs(EUICoreStandaloneMinimap._builtinBorderTextures) do
    ...
    function EUICoreStandaloneMinimap.GetBorderTextureDropdown()
        local texList = EUICoreStandaloneMinimap.GetBorderTextureList()
        local values, order = {}, {}
    ...
    function EUICoreStandaloneMinimap.GetBorderTextureDefaultThickness(key)
    ...
    function EUICoreStandaloneMinimap.GetBorderTextureDefaultOffset(key)
    ...
    function EUICoreStandaloneMinimap.GetBorderTextureDefaultOffsetY(key)
        if not key or key == "" or key == "solid" then return 0 end
        for _, entry in ipairs(EUICoreStandaloneMinimap._builtinBorderTextures) do
    ...
    function EUICoreStandaloneMinimap.BorderTextureUsesScaleOffset(key)
    ...
    function EUICoreStandaloneMinimap.GetBorderStyleSelectDefaults(textureKey)
    ...
    function EUICoreStandaloneMinimap.ResolveBorderTexture(key)
        if not key or key == "" or key == "solid" then return nil end
        for _, entry in ipairs(EUICoreStandaloneMinimap._builtinBorderTextures) do
    ...
    function EUICoreStandaloneMinimap.ApplyBorderStyle(borderFrame, size, r, g, b, a, textureKey, offsetOverride, offsetYOverride, shiftX, shiftY, addonKey, sizeKey, normalizeScale)
        local PP = EUICoreStandaloneMinimap.PP
        ...
        if isSolid then
            ...
            local texPath = EUICoreStandaloneMinimap.ResolveBorderTexture(textureKey)
            ...
            if addonKey and sizeKey then
                local dox, doy, dsx, dsy = EUICoreStandaloneMinimap.GetBorderDefaults(addonKey, textureKey, sizeKey)
                adjX = offsetOverride or dox
                adjY = offsetYOverride or doy
                sx   = shiftX or dsx
                sy   = shiftY or dsy
            else
                adjX = offsetOverride or EUICoreStandaloneMinimap.GetBorderTextureDefaultOffset(textureKey)
                adjY = offsetYOverride or EUICoreStandaloneMinimap.GetBorderTextureDefaultOffsetY(textureKey)
                sx   = shiftX or 0
                sy   = shiftY or 0
            end
            ...
            if EUICoreStandaloneMinimap.BorderTextureUsesScaleOffset(textureKey) then
    ...
    function EUICoreStandaloneMinimap.ApplySecretSafeBorderStyle(borderFrame, state, size, r, g, b, a,
        ...
        if textureKey == "" or textureKey == "solid" or size <= 0 then
            ...
            EUICoreStandaloneMinimap.ApplyBorderStyle(borderFrame, size, r, g, b, a, "solid")
            return
        end
        local path = EUICoreStandaloneMinimap.ResolveBorderTexture(textureKey)
        if not path then
            if edges then for _, tex in pairs(edges) do tex:Hide() end end
            EUICoreStandaloneMinimap.ApplyBorderStyle(borderFrame, 0, 0, 0, 0, 0, "solid")
            return
        end
        ...
        local ox, oy, sx, sy = EUICoreStandaloneMinimap.GetBorderDefaults(addonKey, textureKey, sizeKey)
    ...
    function EUICoreStandaloneMinimap.SetBorderStyleColor(borderFrame, r, g, b, a)
        local PP = EUICoreStandaloneMinimap.PP
        if not PP or not borderFrame then return end
        a = a or 1
    ...
    function EUICoreStandaloneMinimap.HideBorderStyle(borderFrame)
...
--  stored in EUICoreStandaloneMinimapDB.customColors, falls back to WoW defaults.
-------------------------------------------------------------------------------

-- Default power colors (from WoW's PowerBarColor)
EUICoreStandaloneMinimap.DEFAULT_POWER_COLORS = {
...
EUICoreStandaloneMinimap.DEFAULT_RESOURCE_COLORS = {
...
EUICoreStandaloneMinimap.DEFAULT_CLASS_RESOURCE_COLORS = {
...
function EUICoreStandaloneMinimap.GetClassResourceColor(key)
    if not key then return nil end
    if EUICoreStandaloneMinimap._colorCacheDirty then EUICoreStandaloneMinimap._RebuildColorCache() end
    return EUICoreStandaloneMinimap._colorCache.classResource[key]
end

-- Class -> primary power type name mapping
EUICoreStandaloneMinimap.CLASS_POWER_MAP = {
    WARRIOR      = "RAGE",
    PALADIN      = "MANA",
    HUNTER       = "FOCUS",
    ROGUE        = "ENERGY",
...
EUICoreStandaloneMinimap.CLASS_TOKEN_ORDER = {
    "WARRIOR", "PALADIN", "HUNTER", "ROGUE", "PRIEST", "DEATHKNIGHT",
    "SHAMAN", "MAGE", "WARLOCK", "MONK", "DRUID", "DEMONHUNTER", "EVOKER",
}

-- Class -> resource type mapping (nil = no class resource)
EUICoreStandaloneMinimap.CLASS_RESOURCE_MAP = {
    ROGUE       = "ComboPoints",
    DRUID       = "ComboPoints",
    PALADIN     = "HolyPower",
    MONK        = "Chi",
...
function EUICoreStandaloneMinimap.DarkenColor(r, g, b, frac)
    frac = frac or 0.10
...
-- EUICoreStandaloneMinimapDB.colorsApplyToAllProfiles (default ON, nil = on) picks which palette:
--   ON  (global, default): ONE chosen profile's palette (EUICoreStandaloneMinimapDB.colorsPullFrom,
...
function EUICoreStandaloneMinimap.GetCustomColorsDB()
    if not EUICoreStandaloneMinimapDB then EUICoreStandaloneMinimapDB = {} end
    if not EUICoreStandaloneMinimapDB.customColors then EUICoreStandaloneMinimapDB.customColors = {} end
    if EUICoreStandaloneMinimap.GetProfilesDB then
        local pdb = EUICoreStandaloneMinimap.GetProfilesDB()
        if EUICoreStandaloneMinimapDB.colorsApplyToAllProfiles == false then
            ...
            local srcName = EUICoreStandaloneMinimapDB.colorsPullFrom or (pdb.profileOrder and pdb.profileOrder[1])
    ...
    return EUICoreStandaloneMinimapDB.customColors
end
...
function EUICoreStandaloneMinimap.IsColorEditingLocked()
    if not EUICoreStandaloneMinimapDB then return false end
    if EUICoreStandaloneMinimapDB.colorsApplyToAllProfiles == false then return false end
    if not EUICoreStandaloneMinimap.GetProfilesDB then return false end
    local pdb = EUICoreStandaloneMinimap.GetProfilesDB()
...
--  no per-module logic). Stored at EUICoreStandaloneMinimapDB.profiles[name].darkMode (sibling
...
-------------------------------------------------------------------------------
EUICoreStandaloneMinimap.DEFAULT_DARK_MODE = {
...
function EUICoreStandaloneMinimap.GetDarkModeDB()
    if EUICoreStandaloneMinimap.GetProfilesDB then
        local pdb = EUICoreStandaloneMinimap.GetProfilesDB()
    ...
    if not EUICoreStandaloneMinimapDB then EUICoreStandaloneMinimapDB = {} end
    EUICoreStandaloneMinimapDB.darkMode = EUICoreStandaloneMinimapDB.darkMode or {}
    return EUICoreStandaloneMinimapDB.darkMode
end
...
function EUICoreStandaloneMinimap.GetDarkModeFill()
    local d = EUICoreStandaloneMinimap.GetDarkModeDB()
    local def = EUICoreStandaloneMinimap.DEFAULT_DARK_MODE
...
function EUICoreStandaloneMinimap.GetDarkModeBg()
    local d = EUICoreStandaloneMinimap.GetDarkModeDB()
    local def = EUICoreStandaloneMinimap.DEFAULT_DARK_MODE
...
EUICoreStandaloneMinimap._colorCache = { class = {}, power = {}, classResource = {}, resource = {}, classCustomized = {} }
EUICoreStandaloneMinimap._colorCacheDirty = true
EUICoreStandaloneMinimap._COLOR_WHITE = { r = 1, g = 1, b = 1 }
EUICoreStandaloneMinimap._powerBgDarkenFactor = 1

function EUICoreStandaloneMinimap.InvalidateColorCache()
    EUICoreStandaloneMinimap._colorCacheDirty = true
end
...
function EUICoreStandaloneMinimap._BuildColorPalette(out, defaults, custom, darkenPct)
    wipe(out)
    if defaults then
...
function EUICoreStandaloneMinimap._RebuildColorCache()
    local cc = EUICoreStandaloneMinimap.GetCustomColorsDB()
    local dm = EUICoreStandaloneMinimap.GetDarkModeDB()
    local cache = EUICoreStandaloneMinimap._colorCache
    EUICoreStandaloneMinimap._BuildColorPalette(cache.class,          EUICoreStandaloneMinimap.CLASS_COLOR_MAP,               cc and cc.class,          dm and dm.classDarken)
    EUICoreStandaloneMinimap._BuildColorPalette(cache.power,          EUICoreStandaloneMinimap.DEFAULT_POWER_COLORS,          cc and cc.power,          dm and dm.powerDarken)
    EUICoreStandaloneMinimap._BuildColorPalette(cache.classResource,  EUICoreStandaloneMinimap.DEFAULT_CLASS_RESOURCE_COLORS, cc and cc.classResource,  dm and dm.resourceDarken)
    EUICoreStandaloneMinimap._BuildColorPalette(cache.resource,       EUICoreStandaloneMinimap.DEFAULT_RESOURCE_COLORS,       cc and cc.resource,       dm and dm.resourceDarken)
    ...
    EUICoreStandaloneMinimap._powerBgDarkenFactor = bgd > 0 and math.max(0, 1 - bgd / 100) or 1
    ...
    wipe(customized)
    for token, def in pairs(EUICoreStandaloneMinimap.CLASS_COLOR_MAP) do
    ...
    EUICoreStandaloneMinimap._restrictedCandidatesDirty = true
    EUICoreStandaloneMinimap._colorCacheDirty = false
end
...
EUICoreStandaloneMinimap._darkModeRefreshers = EUICoreStandaloneMinimap._darkModeRefreshers or {}
function EUICoreStandaloneMinimap.RegisterDarkModeRefresh(fn)
    if type(fn) == "function" then
        EUICoreStandaloneMinimap._darkModeRefreshers[#EUICoreStandaloneMinimap._darkModeRefreshers + 1] = fn
    end
end
function EUICoreStandaloneMinimap.RefreshDarkMode()
    -- Darken amounts feed the colour cache; drop it so refreshers + the OUF push below resolve freshly darkened colours.
    EUICoreStandaloneMinimap.InvalidateColorCache()
    for _, fn in ipairs(EUICoreStandaloneMinimap._darkModeRefreshers) do pcall(fn) end
    if EUICoreStandaloneMinimap.ApplyColorsToOUF then EUICoreStandaloneMinimap.ApplyColorsToOUF() end
end
...
EUICoreStandaloneMinimap._darkModeToggles = EUICoreStandaloneMinimap._darkModeToggles or {}
function EUICoreStandaloneMinimap.RegisterDarkModeToggle(provider)
    if type(provider) == "table" and type(provider.isOn) == "function"
        and type(provider.setOn) == "function" then
        EUICoreStandaloneMinimap._darkModeToggles[#EUICoreStandaloneMinimap._darkModeToggles + 1] = provider
    end
end
...
function EUICoreStandaloneMinimap.IsDarkModeAllOn(filter)
    local matched = false
    for _, p in ipairs(EUICoreStandaloneMinimap._darkModeToggles) do
...
function EUICoreStandaloneMinimap.SetDarkModeAll(on, filter)
    ...
    EUICoreStandaloneMinimap.RefreshDarkMode()
    ...
    if EUICoreStandaloneMinimap.Conditions_Recheck then EUICoreStandaloneMinimap.Conditions_Recheck() end
end
...
EUICoreStandaloneMinimap.FONT_FILES = {
...
EUICoreStandaloneMinimap.FONT_CYRILLIC = {
    ["Expressway"]       = true,
...
EUICoreStandaloneMinimap.FONT_BLIZZARD = {
    ["Friz Quadrata"] = "Fonts\\FRIZQT__.TTF",
    ["Arial"]         = "Fonts\\ARIALN.TTF",
    ["Morpheus"]      = "Fonts\\MORPHEUS.TTF",
    ["Skurri"]        = "Fonts\\skurri.ttf",
}
EUICoreStandaloneMinimap.FONT_ORDER = {
...
EUICoreStandaloneMinimap.FONT_DISPLAY_NAMES = {
}
...
EUICoreStandaloneMinimap.SYSTEM_FONT_KEY = "__system"
...
EUICoreStandaloneMinimap.EXPRESSWAY_FORCED_KEY = "__expressway"
...
do
    local LSM = LibStub and LibStub("LibSharedMedia-3.0", true)
    if LSM then
        for name, file in pairs(EUICoreStandaloneMinimap.FONT_FILES) do
            if file then
        ...
        if smFonts then
            EUICoreStandaloneMinimap._smFontPaths = {}
            for name, path in pairs(smFonts) do
                EUICoreStandaloneMinimap._smFontPaths[name] = path
            end
        end
        -- Listen for late-registered fonts from other addons
        LSM.RegisterCallback(EUICoreStandaloneMinimap, "LibSharedMedia_Registered", function(_, mediatype, key)
            if mediatype == "font" then
                if not EUICoreStandaloneMinimap._smFontPaths then EUICoreStandaloneMinimap._smFontPaths = {} end
                local path = LSM:Fetch("font", key)
                if path then EUICoreStandaloneMinimap._smFontPaths[key] = path end
                EUICoreStandaloneMinimap.InvalidateFontCache()
            end
        end)
    end
end
...
-------------------------------------------------------------------------------
EUICoreStandaloneMinimap._fontCache = { path = {}, name = {}, outline = {}, icon = {} }
EUICoreStandaloneMinimap._fontCacheDirty = true
-- Stand-in key for a nil addonKey (the global font), which cannot index a table.
EUICoreStandaloneMinimap._FONT_KEY_GLOBAL = "\1global"

function EUICoreStandaloneMinimap.InvalidateFontCache()
    EUICoreStandaloneMinimap._fontCacheDirty = true
end

--- Returns the cache, cleared first if a font setting changed since last use.
function EUICoreStandaloneMinimap._FontCacheReady()
    local c = EUICoreStandaloneMinimap._fontCache
    if EUICoreStandaloneMinimap._fontCacheDirty then
        wipe(c.path); wipe(c.name); wipe(c.outline); wipe(c.icon)
        c.slug = nil
        EUICoreStandaloneMinimap._fontCacheDirty = false
    end
    return c
end

-- Get the fonts DB table (lazy-init)
function EUICoreStandaloneMinimap.GetFontsDB()
    if not EUICoreStandaloneMinimapDB then EUICoreStandaloneMinimapDB = {} end
    if not EUICoreStandaloneMinimapDB.fonts then
        EUICoreStandaloneMinimapDB.fonts = {
            ...
            global      = (EUICoreStandaloneMinimap.LOCALE_SCRIPT == "cyrillic")
                          and EUICoreStandaloneMinimap.SYSTEM_FONT_KEY or "Expressway",
            outlineMode = "shadow",
        }
    end
    local f = EUICoreStandaloneMinimapDB.fonts
    return f
end
...
local function ResolveFontName(fontName)
    ...
    if fontName == EUICoreStandaloneMinimap.EXPRESSWAY_FORCED_KEY then
    ...
    if LOCALE_FONT_FALLBACK then
        ...
        if EUICoreStandaloneMinimap.LOCALE_SCRIPT == "cyrillic" and fontName
           and EUICoreStandaloneMinimap.FONT_CYRILLIC[fontName] then
            local cyrFile = EUICoreStandaloneMinimap.FONT_FILES[fontName]
            if cyrFile then return MEDIA_PATH .. "fonts\\" .. cyrFile end
        end
        if fontName
           and not EUICoreStandaloneMinimap.FONT_FILES[fontName]
           and not EUICoreStandaloneMinimap.FONT_BLIZZARD[fontName] then
            local smPath = EUICoreStandaloneMinimap._smFontPaths and EUICoreStandaloneMinimap._smFontPaths[fontName]
            ...
            if LSM and LSM:IsValid("font", fontName) then
                ...
                if fetched then
                    if not EUICoreStandaloneMinimap._smFontPaths then EUICoreStandaloneMinimap._smFontPaths = {} end
                    EUICoreStandaloneMinimap._smFontPaths[fontName] = fetched
                    return fetched
                end
            end
        end
    ...
    local bliz = EUICoreStandaloneMinimap.FONT_BLIZZARD[fontName]
    if bliz then return bliz end
    local file = EUICoreStandaloneMinimap.FONT_FILES[fontName]
    if file then
...
EUICoreStandaloneMinimap.ResolveFontName = ResolveFontName

-- Per-module font overrides: all state stored on the EUICoreStandaloneMinimap table
-- to stay under the 200-local / 60-upvalue Lua 5.1 caps.
EUICoreStandaloneMinimap._addonKeyToFolder = {
    actionBars   = "EUICoreStandaloneMinimapActionBars",
    nameplates   = "EUICoreStandaloneMinimapNameplates",
    unitFrames   = "EUICoreStandaloneMinimapUnitFrames",
    cdm          = "EUICoreStandaloneMinimapCooldownManager",
    resourceBars = "EUICoreStandaloneMinimapResourceBars",
    auraBuff     = "EUICoreStandaloneMinimapAuraBuffReminders",
    extras       = "EUICoreStandaloneMinimapQoL",
    friends      = "EUICoreStandaloneMinimapFriends",
    minimap      = "EUIStandaloneMinimap",
    chat         = "EUICoreStandaloneMinimapChat",
    questTracker = "EUICoreStandaloneMinimapQuestTracker",
    mythicTimer  = "EUICoreStandaloneMinimapMythicTimer",
    blizzardSkin = "EUICoreStandaloneMinimapBlizzardSkin",
    damageMeters = "EUICoreStandaloneMinimapDamageMeters",
    dataBars     = "EUICoreStandaloneMinimapDataBars",
    raidFrames   = "EUICoreStandaloneMinimapRaidFrames",
    bags         = "EUICoreStandaloneMinimapBags",
    quickdraw    = "EUICoreStandaloneMinimapQuickdraw",
}
EUICoreStandaloneMinimap._moduleFontCache = {}
EUICoreStandaloneMinimap._moduleFontCacheVer = 0

-- Resolve an addonKey to a moduleFonts entry (nil = global). Cached per-key, zero-alloc.
function EUICoreStandaloneMinimap.GetModuleFontEntry(addonKey)
    if not addonKey then return nil end
    local db = EUICoreStandaloneMinimap.GetFontsDB()
    local mfList = db.moduleFonts
    if not mfList or #mfList == 0 then return nil end

    local cache = EUICoreStandaloneMinimap._moduleFontCache
    local ver = #mfList
    if ver ~= EUICoreStandaloneMinimap._moduleFontCacheVer then
        wipe(cache)
        EUICoreStandaloneMinimap._moduleFontCacheVer = ver
    end
    ...
    local folder = EUICoreStandaloneMinimap._addonKeyToFolder[addonKey] or addonKey
...
function EUICoreStandaloneMinimap.GetFontPath(addonKey)
    local c = EUICoreStandaloneMinimap._FontCacheReady().path
    local k = addonKey or EUICoreStandaloneMinimap._FONT_KEY_GLOBAL
    local hit = c[k]
    if hit then return hit end

    local db = EUICoreStandaloneMinimap.GetFontsDB()
    local override = EUICoreStandaloneMinimap.GetModuleFontEntry(addonKey)
    local path
...
function EUICoreStandaloneMinimap.GetFontName(addonKey)
    local c = EUICoreStandaloneMinimap._FontCacheReady().name
    local k = addonKey or EUICoreStandaloneMinimap._FONT_KEY_GLOBAL
    local hit = c[k]
    if hit then return hit end
...
function EUICoreStandaloneMinimap.GetFontOutlineFlag(addonKey)
    local c = EUICoreStandaloneMinimap._FontCacheReady().outline
    local k = addonKey or EUICoreStandaloneMinimap._FONT_KEY_GLOBAL
    ...
    flag = EUICoreStandaloneMinimap.SlugFlag(flag)
    c[k] = flag
    return flag
end
...
-- the account-global EUICoreStandaloneMinimapDB.neverShowSlug. OFF by default.
function EUICoreStandaloneMinimap.IsSlugDisabled()
    local c = EUICoreStandaloneMinimap._FontCacheReady()
    -- Cached value is a boolean, so nil is the only safe "not yet computed".
    if c.slug ~= nil then return c.slug end

    local f = EUICoreStandaloneMinimap.GetFontsDB()
    local v = f and f.neverShowSlug
    if v == nil then v = EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.neverShowSlug end
    v = (v == true)
    c.slug = v
    return v
end
...
function EUICoreStandaloneMinimap.StripSlugFlag(flag)
...
function EUICoreStandaloneMinimap.SlugFlag(flag)
    if EUICoreStandaloneMinimap.IsSlugDisabled() then return EUICoreStandaloneMinimap.StripSlugFlag(flag) end
    return flag
end

-- Returns true when the outline mode uses drop shadow instead of outline.
-- Pass an addonKey to get per-module override; nil returns the global setting.
function EUICoreStandaloneMinimap.GetFontUseShadow(addonKey)
    local db = EUICoreStandaloneMinimap.GetFontsDB()
    local override = EUICoreStandaloneMinimap.GetModuleFontEntry(addonKey)
    local mode
    if override and override.outline and override.outline ~= "__global" then
...
do
    local shadowObj = CreateFont("EUICoreStandaloneMinimapShadowFont")
    shadowObj:SetFont("Fonts\\FRIZQT__.TTF", 12, "")
    shadowObj:SetShadowColor(0, 0, 0, 1)
    shadowObj:SetShadowOffset(1, -1)
    local noShadowObj = CreateFont("EUICoreStandaloneMinimapNoShadowFont")
    ...
    function EUICoreStandaloneMinimap.PrimeFontShadow(fs, useShadow)
...
function EUICoreStandaloneMinimap.ApplyGlobalFontToGameText()
    local db = EUICoreStandaloneMinimap.GetFontsDB()
...
function EUICoreStandaloneMinimap.ApplyModuleFontFailsafe()
    local IsLoaded = C_AddOns and C_AddOns.IsAddOnLoaded
    local GetPath = EUICoreStandaloneMinimap.GetFontPath
    local GetOutline = EUICoreStandaloneMinimap.GetFontOutlineFlag
    ...
    if IsLoaded("EUICoreStandaloneMinimapChat") then
    ...
    if IsLoaded("EUICoreStandaloneMinimapQuestTracker") then
    ...
    if IsLoaded("EUICoreStandaloneMinimapBlizzardSkin") and (not EUICoreStandaloneMinimapDB or EUICoreStandaloneMinimapDB.customTooltips ~= false) then
...
function EUICoreStandaloneMinimap.GetIconTextOutlineFlag(moduleKey)
    local c = EUICoreStandaloneMinimap._FontCacheReady().icon
    local k = moduleKey or EUICoreStandaloneMinimap._FONT_KEY_GLOBAL
    local hit = c[k]
    if hit then return hit end

    -- Per-profile (rides profile export); the account-global table is the read-time fallback.
    local f = EUICoreStandaloneMinimap.GetFontsDB()
    local t = (f and f.outlineIconText) or (EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.outlineIconText)
    local flag
    if t and t[moduleKey] == false then
        -- Follows the outline mode, which is already slug-gated at the source.
        flag = (EUICoreStandaloneMinimap.GetFontOutlineFlag and EUICoreStandaloneMinimap.GetFontOutlineFlag(moduleKey)) or ""
    else
        -- Forced crisp outline; "Never Show Slug" still drops the slug token.
        flag = EUICoreStandaloneMinimap.SlugFlag("OUTLINE, SLUG")
    end
    c[k] = flag
    return flag
end
...
function EUICoreStandaloneMinimap.ApplyIconTextFont(fs, fontPath, size, moduleKey)
    if not (fs and fs.SetFont) then return end
    local flag = EUICoreStandaloneMinimap.GetIconTextOutlineFlag(moduleKey)
    -- Prime the shadow FontObject before SetFont (see PrimeFontShadow).
    EUICoreStandaloneMinimap.PrimeFontShadow(fs, flag == "")
    fs:SetFont(fontPath, size, flag)
end

-- Build font dropdown values/order ("EUI Global Font" first) for W:DualRow configs.
function EUICoreStandaloneMinimap.BuildFontDropdownData()
    ...
    if EUICoreStandaloneMinimap.LOCALE_FONT_FALLBACK then
        local values = { ["__global"] = { text = "EUI Global Font" },
                         [EUICoreStandaloneMinimap.SYSTEM_FONT_KEY] = { text = "System Default", font = EUICoreStandaloneMinimap.LOCALE_FONT_FALLBACK },
                         [EUICoreStandaloneMinimap.EXPRESSWAY_FORCED_KEY] = { text = "Expressway (Latin only)",
                             font = EUICoreStandaloneMinimap.MEDIA_PATH .. "fonts\\Expressway.TTF" } }
        local order  = { "__global", EUICoreStandaloneMinimap.SYSTEM_FONT_KEY, EUICoreStandaloneMinimap.EXPRESSWAY_FORCED_KEY }
        if EUICoreStandaloneMinimap.AppendExternalSharedMediaFonts then
            EUICoreStandaloneMinimap.AppendExternalSharedMediaFonts(values, order)
        end
        return values, order
    end
    local values = { ["__global"] = { text = "EUI Global Font" } }
    local order  = { "__global", "---" }
    local FONT_DIR = EUICoreStandaloneMinimap.MEDIA_PATH .. "fonts\\"
    for _, name in ipairs(EUICoreStandaloneMinimap.FONT_ORDER) do
        if name == "---" then
            order[#order + 1] = "---"
        else
            local path = EUICoreStandaloneMinimap.FONT_BLIZZARD[name]
                or (FONT_DIR .. (EUICoreStandaloneMinimap.FONT_FILES[name] or "Expressway.TTF"))
            local displayName = (EUICoreStandaloneMinimap.FONT_DISPLAY_NAMES and EUICoreStandaloneMinimap.FONT_DISPLAY_NAMES[name]) or name
            values[name] = { text = displayName, font = path }
            order[#order + 1] = name
        end
    end
    if EUICoreStandaloneMinimap.AppendSharedMediaFonts then
        EUICoreStandaloneMinimap.AppendSharedMediaFonts(values, order, { keyByName = true })
    end
    return values, order
end
...
function EUICoreStandaloneMinimap.GetClassColor(classToken)
    if EUICoreStandaloneMinimap._colorCacheDirty then EUICoreStandaloneMinimap._RebuildColorCache() end
    return EUICoreStandaloneMinimap._colorCache.class[classToken] or EUICoreStandaloneMinimap._COLOR_WHITE
end
...
EUICoreStandaloneMinimap._restrictedCandidates = {}
EUICoreStandaloneMinimap._restrictedCandidatesDirty = true

-- Namespaced, not file-locals: this chunk sits at Lua's 200-local ceiling.
function EUICoreStandaloneMinimap._RebuildRestrictedCandidates()
    local out = EUICoreStandaloneMinimap._restrictedCandidates
    wipe(out)
    local customized = EUICoreStandaloneMinimap._colorCache.classCustomized
    ...
    EUICoreStandaloneMinimap._restrictedCandidatesDirty = false
end

-- Created on the first restricted lookup, so a profile that never needs one never registers it.
function EUICoreStandaloneMinimap._EnsureRestrictedRosterWatcher()
    if EUICoreStandaloneMinimap._restrictedRosterWatcher then return end
    local f = CreateFrame("Frame")
    f:RegisterEvent("GROUP_ROSTER_UPDATE")
    f:SetScript("OnEvent", function() EUICoreStandaloneMinimap._restrictedCandidatesDirty = true end)
    EUICoreStandaloneMinimap._restrictedRosterWatcher = f
end

function EUICoreStandaloneMinimap.GetClassColorForRestrictedUnit(unit, secretClassToken)
    if EUICoreStandaloneMinimap._colorCacheDirty then EUICoreStandaloneMinimap._RebuildColorCache() end
    if not next(EUICoreStandaloneMinimap._colorCache.classCustomized) then return false end
    ...
    EUICoreStandaloneMinimap._EnsureRestrictedRosterWatcher()
    if EUICoreStandaloneMinimap._restrictedCandidatesDirty then EUICoreStandaloneMinimap._RebuildRestrictedCandidates() end
    local candidates = EUICoreStandaloneMinimap._restrictedCandidates
...
function EUICoreStandaloneMinimap.GetPowerColor(powerKey)
    if EUICoreStandaloneMinimap._colorCacheDirty then EUICoreStandaloneMinimap._RebuildColorCache() end
    return EUICoreStandaloneMinimap._colorCache.power[powerKey]
end
...
function EUICoreStandaloneMinimap.GetPowerBgDarkenFactor()
    if EUICoreStandaloneMinimap._colorCacheDirty then EUICoreStandaloneMinimap._RebuildColorCache() end
    return EUICoreStandaloneMinimap._powerBgDarkenFactor
end
...
function EUICoreStandaloneMinimap.GetResourceColor(classToken)
    if EUICoreStandaloneMinimap._colorCacheDirty then EUICoreStandaloneMinimap._RebuildColorCache() end
    return EUICoreStandaloneMinimap._colorCache.resource[classToken]
end

-- Reset colors for a specific class (class color + resource color + power stays)
function EUICoreStandaloneMinimap.ResetClassColors(classToken)
    local db = EUICoreStandaloneMinimap.GetCustomColorsDB()
...
function EUICoreStandaloneMinimap.ResetPowerColor(powerKey)
    local db = EUICoreStandaloneMinimap.GetCustomColorsDB()
...
EUICoreStandaloneMinimap.POWER_KEY_TO_ENUM = {
    MANA         = 0,
    RAGE         = 1,
    FOCUS        = 2,
    ENERGY       = 3,
...
EUICoreStandaloneMinimap.POWER_ENUM_TO_KEY = {}
for k, v in pairs(EUICoreStandaloneMinimap.POWER_KEY_TO_ENUM) do
    EUICoreStandaloneMinimap.POWER_ENUM_TO_KEY[v] = k
end
...
function EUICoreStandaloneMinimap.ResolveUnitPowerColor(unit)
    ...
    if unit == "player" and EUICoreStandaloneMinimap.GetPlayerPowerOverride then
        local override = EUICoreStandaloneMinimap.GetPlayerPowerOverride()
        if override ~= nil then
            local overrideKey = EUICoreStandaloneMinimap.POWER_ENUM_TO_KEY[override]
            local overrideInfo = overrideKey and EUICoreStandaloneMinimap.GetPowerColor(overrideKey)
            if overrideInfo then return overrideInfo.r, overrideInfo.g, overrideInfo.b end
        end
    end
    local pType, pToken, altR, altG, altB = UnitPowerType(unit)
    local info = EUICoreStandaloneMinimap.GetPowerColor(pToken)
    ...
    local key = EUICoreStandaloneMinimap.POWER_ENUM_TO_KEY[pType]
    info = key and EUICoreStandaloneMinimap.GetPowerColor(key)
    if info then return info.r, info.g, info.b end
    return nil
end

-- Apply custom class colors to oUF (call after settings change)
function EUICoreStandaloneMinimap.ApplyColorsToOUF()
    ...
    local colors = EUICoreStandaloneMinimap._UFColors
    if colors then
        if colors.class then
            for classToken, _ in pairs(CLASS_COLOR_MAP) do
                local cc = EUICoreStandaloneMinimap.GetClassColor(classToken)
        ...
        if colors.power then
            for powerKey, enumVal in pairs(EUICoreStandaloneMinimap.POWER_KEY_TO_ENUM) do
                local pc = EUICoreStandaloneMinimap.GetPowerColor(powerKey)
        ...
        if EUICoreStandaloneMinimap._UFEngineForceAll then
            EUICoreStandaloneMinimap._UFEngineForceAll("ForceUpdate")
        end
    end
        ...
        if ns_NP.friendlyPlates then
            for _, plate in pairs(ns_NP.friendlyPlates) do
                if plate.unit and UnitIsPlayer(plate.unit) then
                    ...
                    local cc = classToken and EUICoreStandaloneMinimap.GetClassColor(classToken)
    ...
    local ERF = _G.EUICoreStandaloneMinimapRaidFrames
    ...
    local ok, EAB = pcall(function()
        return EUICoreStandaloneMinimap.Lite and EUICoreStandaloneMinimap.Lite.GetAddon("EUICoreStandaloneMinimapActionBars", true)
    end)
    ...
    if EUICoreStandaloneMinimap._DM_RefreshColors then
        EUICoreStandaloneMinimap._DM_RefreshColors()
    end
end
...
do
    ...
    function EUICoreStandaloneMinimap.HandleTipOfTheSpear(event, unit, _, spellID)
    ...
    function EUICoreStandaloneMinimap.GetTipOfTheSpear()
...
do
    ...
    do
        ...
        if cls == "WARRIOR" then
            ...
            EUICoreStandaloneMinimap._wwPendFrame = pf
            ...
            EUICoreStandaloneMinimap._wwResolvePend = function()
                local sid = EUICoreStandaloneMinimap._wwPendSid
                if not sid then return end
                if GetTime() > (EUICoreStandaloneMinimap._wwPendUntil or 0) then
                    EUICoreStandaloneMinimap._wwPendSid = nil
            ...
            pf:SetScript("OnEvent", EUICoreStandaloneMinimap._wwResolvePend)
        end
    end

    function EUICoreStandaloneMinimap.HandleWhirlwindStacks(event, unit, castGUID, spellID)
        if event == "PLAYER_DEAD" or event == "PLAYER_ALIVE" then
            stacks, expiresAt = 0, nil
            bladestormEndsAt = 0
            wipe(seenGUID)
            guidCount = 0
            if EUICoreStandaloneMinimap._wwPendFrame then
                EUICoreStandaloneMinimap._wwPendFrame:UnregisterEvent("PLAYER_STOPPED_MOVING")
                EUICoreStandaloneMinimap._wwPendSid = nil
            end
            return
        end
        ...
        if EUICoreStandaloneMinimap._wwResolvePend then EUICoreStandaloneMinimap._wwResolvePend() end
        ...
        if GENERATORS[spellID] then
            ...
            if not EnemyInStrikeRange(spellID) then
                local pf = EUICoreStandaloneMinimap._wwPendFrame
                if pf then
                    EUICoreStandaloneMinimap._wwPendSid = spellID
                    EUICoreStandaloneMinimap._wwPendUntil = GetTime() + 1.5
    ...
    function EUICoreStandaloneMinimap.GetWhirlwindStacks()
...
do
    ...
    -- EUICoreStandaloneMinimap._ssExecWindow so the second is skipped (one charge). A field, not a
    ...
    local function dbg(...)
        if EUICoreStandaloneMinimap._SSDEBUG then print("|cff33ff99[SS]|r", ...) end
    end

    function EUICoreStandaloneMinimap.HandleSweepingStrikes(event, unit, castGUID, spellID)
        if event == "PLAYER_DEAD" or event == "PLAYER_ALIVE" then
            stacks, expiresAt = 0, nil
            fobWindow = 0
            bladestormUntil = 0
        ...
        if EUICoreStandaloneMinimap._SSDEBUG then
        ...
        elseif SPENDERS[spellID] and stacks > 0 then
            ...
            if isExec and GetTime() < (EUICoreStandaloneMinimap._ssExecWindow or 0) then return end
            ...
            if stacks == 0 then expiresAt = nil end
            if isExec then EUICoreStandaloneMinimap._ssExecWindow = GetTime() + 0.3 end
    ...
    -- + C_Secrets.ShouldSpellAuraBeSecret probe in EUICoreStandaloneMinimapAuraBuffReminders. Until
    ...
    function EUICoreStandaloneMinimap.GetSweepingStrikes()
...
EUICoreStandaloneMinimap._RefreshSpecID = function()
    local spec = C_SpecializationInfo and C_SpecializationInfo.GetSpecialization()
    EUICoreStandaloneMinimap._specID = (spec and C_SpecializationInfo.GetSpecializationInfo(spec)) or 0
end
EUICoreStandaloneMinimap._specWatcher = EUICoreStandaloneMinimap._specWatcher or CreateFrame("Frame")
EUICoreStandaloneMinimap._specWatcher:RegisterEvent("PLAYER_LOGIN")
EUICoreStandaloneMinimap._specWatcher:RegisterEvent("PLAYER_SPECIALIZATION_CHANGED")
EUICoreStandaloneMinimap._specWatcher:RegisterEvent("PLAYER_ENTERING_WORLD")
EUICoreStandaloneMinimap._specWatcher:SetScript("OnEvent", EUICoreStandaloneMinimap._RefreshSpecID)

function EUICoreStandaloneMinimap.GetSoulFragments()
    local specID = EUICoreStandaloneMinimap._specID
    if not specID then           -- pre-login / not resolved yet: resolve once
        EUICoreStandaloneMinimap._RefreshSpecID()
        specID = EUICoreStandaloneMinimap._specID
    end
...
function EUICoreStandaloneMinimap.GetMaelstromWeapon()
...
EUICoreStandaloneMinimap.RESOURCE_BAR_ANCHOR_KEYS = {
    none = true,
    mouse = true,
    partyframe = true,
    playerframe = true,
...
local PLAYER_FRAME_SOURCES = {
    { addon = "EUICoreStandaloneMinimapUnitFrames", global = "EUICoreStandaloneMinimapUnitFrames_Player" },
...
function EUICoreStandaloneMinimap.InvalidateFrameCache()
    _cachedPartyFrame  = nil
    _cachedPlayerFrame = nil
    _cachedRosterToken = -1
end

function EUICoreStandaloneMinimap.FindPlayerPartyFrame()
...
function EUICoreStandaloneMinimap.FindPlayerUnitFrame()
...
EUICoreStandaloneMinimap.THEME_PRESETS   = THEME_PRESETS
EUICoreStandaloneMinimap.THEME_ORDER     = THEME_ORDER
...
EUICoreStandaloneMinimap.EXPRESSWAY = LOCALE_FONT_FALLBACK or EXPRESSWAY
EUICoreStandaloneMinimap.MEDIA_PATH = MEDIA_PATH
EUICoreStandaloneMinimap.ICONS_PATH = ICONS_PATH
...
do
    ...
    local function InProtectedInstance()
        if EUICoreStandaloneMinimap.IsDevModeActive and EUICoreStandaloneMinimap.IsDevModeActive() then return true end
        local _, instanceType = IsInInstance()
    ...
    EUICoreStandaloneMinimap.InProtectedInstance = InProtectedInstance
    ...
    function EUICoreStandaloneMinimap.ResolveHearthSlot()
        local _, cls = UnitClass("player")
    ...
    function EUICoreStandaloneMinimap.ResolveDalaranSlot()
    ...
    function EUICoreStandaloneMinimap.ResolveHousingSlot()
        return "housing", 0, HOUSING_ICON
    end
end

-- Safe scroll range helper (avoids tainted secret number values)
function EUICoreStandaloneMinimap.SafeScrollRange(sf)
...
-- Utility functions
EUICoreStandaloneMinimap.SolidTex          = SolidTex
EUICoreStandaloneMinimap.MakeFont          = MakeFont
EUICoreStandaloneMinimap.MakeBorder        = MakeBorder
EUICoreStandaloneMinimap.DisablePixelSnap  = DisablePixelSnap
EUICoreStandaloneMinimap.RowBg             = RowBg
EUICoreStandaloneMinimap.ResetRowCounters  = ResetRowCounters
EUICoreStandaloneMinimap.lerp              = lerp
EUICoreStandaloneMinimap.MakeDropdownArrow = MakeDropdownArrow
EUICoreStandaloneMinimap.RegAccent         = RegAccent

-- Internal references (needed by Widget Factory accent system)
EUICoreStandaloneMinimap.DEFAULT_ACCENT_R = DEFAULT_ACCENT_R
EUICoreStandaloneMinimap.DEFAULT_ACCENT_G = DEFAULT_ACCENT_G
EUICoreStandaloneMinimap.DEFAULT_ACCENT_B = DEFAULT_ACCENT_B
EUICoreStandaloneMinimap._ResolveFactionTheme = ResolveFactionTheme
EUICoreStandaloneMinimap._playerClass     = playerClass
EUICoreStandaloneMinimap._accentElements  = _accentElements
EUICoreStandaloneMinimap._widgetRefreshList = _widgetRefreshList
EUICoreStandaloneMinimap._rowCounters     = rowCounters
...
-------------------------------------------------------------------------------
function EUICoreStandaloneMinimap.MakeUnlockElement(opts)
    return {
        key           = opts.key,
        label         = opts.label,
        group         = opts.group,
...
-------------------------------------------------------------------------------
if not EUICoreStandaloneMinimap.ResolveThemeColor then
    EUICoreStandaloneMinimap.ResolveThemeColor = function(theme)
        ...
        elseif theme == "Custom Color" then
            local sa = EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.accentColor
...
-------------------------------------------------------------------------------
--  Load-order stub: GetActiveTheme -- the real one lives in EUICoreStandaloneMinimap_UICore.lua
--  (loads right after this file); covers callers in the rest of THIS file's scope. Identical body, harmlessly replaced.
-------------------------------------------------------------------------------
if not EUICoreStandaloneMinimap.GetActiveTheme then
    EUICoreStandaloneMinimap.GetActiveTheme = function()
        return EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.activeTheme or "EUICoreStandaloneMinimap"
    end
end

-------------------------------------------------------------------------------
--  Load-order stub: ResolveActiveAccent -- the real one (and its ResolveProfileAccent /
--  GetActiveProfileData helpers) lives in EUICoreStandaloneMinimap_UICore.lua, which loads right after
--  this file; mirrors ResolveProfileAccent's resolution order so the accent matches.
-------------------------------------------------------------------------------
if not EUICoreStandaloneMinimap.ResolveActiveAccent then
    EUICoreStandaloneMinimap.ResolveActiveAccent = function()
        local theme = (EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.activeTheme) or "EUICoreStandaloneMinimap"
        local themeR, themeG, themeB = EUICoreStandaloneMinimap.ResolveThemeColor(theme)
        local db = EUICoreStandaloneMinimapDB
...
function EUICoreStandaloneMinimap.ResolveTexturePath(texTable, key, fallback)
...
-- On EUICoreStandaloneMinimap (not new file-scope locals): this file is at the local/upvalue cap.
EUICoreStandaloneMinimap._smTexConsumers = EUICoreStandaloneMinimap._smTexConsumers or {}

function EUICoreStandaloneMinimap.AppendSharedMediaTextures(names, order, castBarNames, textures)
    local LSM = LibStub and LibStub("LibSharedMedia-3.0", true)
    if not LSM then return end

    -- Icon textures some SM packs wrongly register as statusbar (cached once).
    local blacklist = EUICoreStandaloneMinimap._smTexBlacklist
    if not blacklist then
        blacklist = { play_icon = true, stop_icon = true, user_icon = true, users_icon = true }
        EUICoreStandaloneMinimap._smTexBlacklist = blacklist
    end
    ...
    local c = EUICoreStandaloneMinimap._smTexConsumers[textures]
    if not c then
        c = { names = names, order = order, castBarNames = castBarNames, textures = textures }
        EUICoreStandaloneMinimap._smTexConsumers[textures] = c
    end
    ...
    if not EUICoreStandaloneMinimap._smTexCallbackInstalled then
        EUICoreStandaloneMinimap._smTexCallbackInstalled = true
        EUICoreStandaloneMinimap._smTexCBOwner = EUICoreStandaloneMinimap._smTexCBOwner or {}
        LSM.RegisterCallback(EUICoreStandaloneMinimap._smTexCBOwner, "LibSharedMedia_Registered", function(_, mediatype, key)
            if mediatype ~= "statusbar" then return end
            local path = LSM:Fetch("statusbar", key)
            if not path then return end
            for _, cc in pairs(EUICoreStandaloneMinimap._smTexConsumers) do
...
-------------------------------------------------------------------------------
function EUICoreStandaloneMinimap.AppendSharedMediaSounds(paths, names, order)
    local LSM = LibStub and LibStub("LibSharedMedia-3.0", true)
    if not LSM then return end
...
-------------------------------------------------------------------------------
function EUICoreStandaloneMinimap.AppendSharedMediaFonts(values, order, opts)
    local LSM = LibStub and LibStub("LibSharedMedia-3.0", true)
    if not LSM then return end
    local smFonts = LSM:HashTable("font")
...
-- Append only EXTERNAL SharedMedia fonts (not bundled with EUICoreStandaloneMinimap) to a dropdown
...
function EUICoreStandaloneMinimap.AppendExternalSharedMediaFonts(values, order)
    local LSM = LibStub and LibStub("LibSharedMedia-3.0", true)
    if not LSM then return end
    local smFonts = LSM:HashTable("font")
    if not smFonts then return end
    ...
    for name, path in pairs(smFonts) do
        EUICoreStandaloneMinimap._smFontPaths[name] = path
        if not EUICoreStandaloneMinimap.FONT_FILES[name] and not EUICoreStandaloneMinimap.FONT_BLIZZARD[name]
...
--  LoadOnDemand EUICoreStandaloneMinimapOptions addon: nothing of it is even PARSED until
--  EnsureLoaded loads the addon on first panel open.
-------------------------------------------------------------------------------
EUICoreStandaloneMinimap._deferredInits = {}
EUICoreStandaloneMinimap._deferredLoaded = false

-- Module-namespace registry: every child addon publishes its private ns here at
-- load. The LOD options files (which get EUICoreStandaloneMinimapOptions' own useless vararg
...
EUICoreStandaloneMinimap._ModuleNS = {}
...
EUICoreStandaloneMinimap._unlockCoreInit = nil

function EUICoreStandaloneMinimap:EnsureUnlockCore()
...
-- only when the EUICoreStandaloneMinimapOptions addon is missing or disabled in the AddOn List.
function EUICoreStandaloneMinimap.EnsureOptionsLoaded()
    ...
    if C_AddOns.IsAddOnLoaded("EUICoreStandaloneMinimapOptions") then return true end
    local ok, reason = C_AddOns.LoadAddOn("EUICoreStandaloneMinimapOptions")
    if not ok then
        EUICoreStandaloneMinimap.Print("|cffff6060[EUICoreStandaloneMinimap]|r Options could not load (" .. tostring(reason) .. "). Enable the \"EUICoreStandaloneMinimap Options\" addon in the AddOn List.")
    end
    return ok and true or false
end

-- The options LOD split moved the child modules' slash registrations into
-- EUICoreStandaloneMinimapOptions, where they cannot exist until the panel first loads.
    ...
    for _, e in ipairs(LOD_SLASH) do
        ...
        local function bootstrap(msg)
            ...
            C_Timer.After(0, function()
                ...
                if not EUICoreStandaloneMinimap.EnsureOptionsLoaded() then return end
...
function EUICoreStandaloneMinimap:EnsureLoaded()
...
EUICoreStandaloneMinimap._popupFrames = _popupFrames
...
EUICoreStandaloneMinimap.GetPopupScale = GetPopupScale
...
EUICoreStandaloneMinimap.POPUP_REF_DENSITY = 768 / (1440 * 0.64)
...
function EUICoreStandaloneMinimap.PopupBump(mult)
    return (mult or 1) * EUICoreStandaloneMinimap.POPUP_REF_DENSITY
end
...
function EUICoreStandaloneMinimap.ClampPopupToScreen(popup, w, h)
...
if not EUICoreStandaloneMinimap._onScaleChanged then EUICoreStandaloneMinimap._onScaleChanged = {} end
EUICoreStandaloneMinimap._onScaleChanged[#EUICoreStandaloneMinimap._onScaleChanged + 1] = RefreshPopupScales

-------------------------------------------------------------------------------
--  Custom Confirmation Popup  (matches EUICoreStandaloneMinimap aesthetic)
--  Usage:  EUICoreStandaloneMinimap:ShowConfirmPopup({ title, message, confirmText, cancelText, onConfirm, onCancel })
-------------------------------------------------------------------------------
local confirmPopup
...
local function CreateConfirmPopup()
    ...
    popBgAtlas:SetTexture("Interface\\AddOns\\EUIStandaloneMinimap\\media\\modern_blizz.png")
    ...
    disc:SetFont(EUICoreStandaloneMinimap.EXPRESSWAY, 11, "")
...
EUICoreStandaloneMinimap._InvalidateConfirmPopup = InvalidateConfirmPopup

function EUICoreStandaloneMinimap:ShowConfirmPopup(opts)
    -- Force-close any widget tooltip so it doesn't linger behind the popup
    if EUICoreStandaloneMinimap.HideWidgetTooltip then EUICoreStandaloneMinimap.HideWidgetTooltip() end
    ...
    popup._title:SetText(EUICoreStandaloneMinimap.L(opts.title or "Confirm"))
    popup._msg:SetText(EUICoreStandaloneMinimap.L(opts.message or "Are you sure?"))
    if opts.disclaimer then
        popup._disclaimer:SetText(EUICoreStandaloneMinimap.L(opts.disclaimer))
    ...
    if opts.scaleWarning and opts.scaleWarning ~= "" then
        ...
        popup._scaleWarnLabel:SetText(EUICoreStandaloneMinimap.L(opts.scaleWarning))
    ...
    if opts.checkbox then
        popup._cbChecked = false
        popup._cbCheck:Hide()
        popup._cbLabel:SetText(EUICoreStandaloneMinimap.L(opts.checkbox))
    ...
    if opts.typeToConfirm then
        if not popup._typeRow then
            ...
            box:SetFont(EUICoreStandaloneMinimap.EXPRESSWAY or "Fonts\\FRIZQT__.TTF", 13, "")
        ...
        row._label:SetText(string.format(EUICoreStandaloneMinimap.L('Type "%s" to enable:'), tostring(opts.typeToConfirm)))
        row._box:SetText("")
    ...
    popup._cancelBtn._lbl:SetText(EUICoreStandaloneMinimap.L(opts.cancelText or "Cancel"))
    popup._confirmBtn._lbl:SetText(EUICoreStandaloneMinimap.L(opts.confirmText or "Confirm"))
...
-- There is no beta-reset welcome popup or wipe gate (EUICoreStandaloneMinimap:ShowWelcomePopup does not exist); manual reset lives in Global Settings > Reset.

-------------------------------------------------------------------------------
--  Scrollable Info Popup  (read-only content with custom scroll + close button)
--  Usage:  EUICoreStandaloneMinimap:ShowInfoPopup({ title, content, width, height })
...
local function CreateInfoPopup()
    ...
    contentFS:SetFont(EUICoreStandaloneMinimap.EXPRESSWAY, 11, "")
    ...
    local function UpdateThumb()
        local maxScroll = EUICoreStandaloneMinimap.SafeScrollRange(sf)
    ...
    sf:SetScript("OnMouseWheel", function(self, delta)
        local maxScroll = EUICoreStandaloneMinimap.SafeScrollRange(self)
    ...
    EUICoreStandaloneMinimap.MakeStyledButton(closeBtn, "Close", 11,
        EUICoreStandaloneMinimap.RB_COLOURS, function() dimmer:Hide() end)
...
function EUICoreStandaloneMinimap:ShowInfoPopup(opts)
    if EUICoreStandaloneMinimap.HideWidgetTooltip then EUICoreStandaloneMinimap.HideWidgetTooltip() end
    local popup = CreateInfoPopup()

    popup._title:SetText(EUICoreStandaloneMinimap.L(opts.title or "Information"))
    popup._contentFS:SetText(EUICoreStandaloneMinimap.L(opts.content) or "")
...
-------------------------------------------------------------------------------
--  Custom Input Popup  (matches EUICoreStandaloneMinimap aesthetic, with EditBox)
--  Usage:  EUICoreStandaloneMinimap:ShowInputPopup({ title, message, placeholder, confirmText, cancelText, onConfirm, onCancel })
--          onConfirm receives the entered text as its first argument.
-------------------------------------------------------------------------------
function EUICoreStandaloneMinimap:ShowInputPopup(opts)
    ...
    popup._title:SetText(EUICoreStandaloneMinimap.L(opts.title or "Enter Name"))
    popup._msg:SetText(EUICoreStandaloneMinimap.L(opts.message or ""))
    popup._placeholder:SetText(EUICoreStandaloneMinimap.L(opts.placeholder or "Enter name..."))
    popup._cancelBtn._lbl:SetText(EUICoreStandaloneMinimap.L(opts.cancelText or "Cancel"))
    popup._confirmBtn._lbl:SetText(EUICoreStandaloneMinimap.L(opts.confirmText or "Save"))
    popup._onCancel = opts.onDismiss or opts.onCancel or nil
...
local function CreateMainFrame()
    ...
    --  Root frame + scaling
    -----------------------------------------------------------------------
    mainFrame = CreateFrame("Frame", "EUICoreStandaloneMinimapFrame", UIParent)
    EUICoreStandaloneMinimap._mainFrame = mainFrame
    ...
    mainFrame:SetScript("OnShow", function()
        ...
        local userScale2 = (EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.panelScale) or 1.0
    ...
    mainFrame:SetScript("OnHide", function()
        ...
        if EUICoreStandaloneMinimap.CloseSyncPopup then EUICoreStandaloneMinimap.CloseSyncPopup() end
    ...
    EUICoreStandaloneMinimap.RegisterEscapeClose(mainFrame)
    ...
    local function ApplyBgTintToLayer(layer, theme, r, g, b)
        if theme == "EUICoreStandaloneMinimap" or theme == "Horde" or theme == "Alliance"
    ...
    local function ApplyThemeBG(theme, r, g, b)
        theme = ResolveFactionTheme(theme)
        local file = THEME_BG_FILES[theme] or THEME_BG_FILES["EUICoreStandaloneMinimap"]
    ...
    local function ApplyBgTint(r, g, b)
        local theme = ResolveFactionTheme((EUICoreStandaloneMinimapDB or {}).activeTheme or "EUICoreStandaloneMinimap")
        ApplyBgTintToLayer(bgFront, theme, r, g, b)
    end
    ...
    local _initTheme = ResolveFactionTheme((EUICoreStandaloneMinimapDB or {}).activeTheme or "EUICoreStandaloneMinimap")
    local _initFile = THEME_BG_FILES[_initTheme] or THEME_BG_FILES["EUICoreStandaloneMinimap"]
    local _initR, _initG, _initB = EUICoreStandaloneMinimap.ResolveThemeColor(_initTheme)
    bgA:SetTexture(MEDIA_PATH .. _initFile)
    ApplyBgTintToLayer(bgA, _initTheme, _initR, _initG, _initB)
    EUICoreStandaloneMinimap._bgTexture = bgA
    EUICoreStandaloneMinimap._applyBgTint = ApplyBgTint
    EUICoreStandaloneMinimap._applyThemeBG = ApplyThemeBG

    -----------------------------------------------------------------------
    --  Click area  (1300x946, centred)
    -----------------------------------------------------------------------
    clickArea = CreateFrame("Frame", "EUICoreStandaloneMinimapClickArea", mainFrame)
    EUICoreStandaloneMinimap._clickArea = clickArea
    ...
    closeBtn:SetScript("OnClick", function() EUICoreStandaloneMinimap:Hide() end)
    ...
    EUICoreStandaloneMinimap._sidebar = sidebar
    ...
    do
        ...
        label:SetText(EUICoreStandaloneMinimap.L("Unlock Mode"))
        btn._label = label
        ...
        btn:SetScript("OnClick", function()
            if EUICoreStandaloneMinimap._openUnlockMode then
                EUICoreStandaloneMinimap._unlockReturnModule = activeModule
                EUICoreStandaloneMinimap._unlockReturnPage   = activePage
                C_Timer.After(0, EUICoreStandaloneMinimap._openUnlockMode)
            end
        end)

        EUICoreStandaloneMinimap._unlockSidebarBtn = btn
        ...
        if EUICoreStandaloneMinimap.VideoGuides and EUICoreStandaloneMinimap.VideoGuides.AttachTip then
            EUICoreStandaloneMinimap.VideoGuides.AttachTip(btn, "unlock_mode", {
    ...
    do
        ...
        local label = MakeFont(btn, 14, nil, TEXT_DIM.r, TEXT_DIM.g, TEXT_DIM.b, TEXT_DIM.a)
        label:SetPoint("LEFT", icon, "RIGHT", NAV_TXT_GAP, 0)
        label:SetText(EUICoreStandaloneMinimap.L("Global Settings"))
        btn._label = label
        ...
        btn:SetScript("OnEnter", function(self)
            if self._ovLocked then
                if EUICoreStandaloneMinimap.ShowWidgetTooltip then
                    EUICoreStandaloneMinimap.ShowWidgetTooltip(self, "This module can't be overridden. Exit the override editing session to open it.")
                end
                return
            end
            hlTex:SetAlpha(0.06)
        ...
        btn:SetScript("OnClick", function(self)
            ...
            if modules[self._folder] then
                EUICoreStandaloneMinimap:SelectModule(self._folder)
            end
        end)
    ...
    do
        ...
        local label = MakeFont(btn, 14, nil, TEXT_DIM.r, TEXT_DIM.g, TEXT_DIM.b, TEXT_DIM.a)
        label:SetPoint("LEFT", icon, "RIGHT", NAV_TXT_GAP, 0)
        label:SetText(EUICoreStandaloneMinimap.L("Patch Notes"))
        btn._label = label
        ...
        btn:SetScript("OnClick", function(self)
            ...
            if EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.patchDotPending then
                EUICoreStandaloneMinimapDB.patchDotPending = nil
                if EUICoreStandaloneMinimap._UpdatePatchDot then EUICoreStandaloneMinimap._UpdatePatchDot() end
            end
            if modules[self._folder] then
                EUICoreStandaloneMinimap:SelectModule(self._folder)
            end
        ...
        -- stamp near EUICoreStandaloneMinimap.VERSION) and patchDotDisabled is unset. Built lazily.
        local dot
        EUICoreStandaloneMinimap._UpdatePatchDot = function()
            local show = EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.patchDotPending
                and not EUICoreStandaloneMinimapDB.patchDotDisabled and true or false
            if not dot then
                ...
                mask:SetTexture("Interface\\AddOns\\EUIStandaloneMinimap\\media\\portraits\\circle_mask.tga",
        ...
        EUICoreStandaloneMinimap._UpdatePatchDot()

        sidebarButtons["_EUIPatchNotes"] = btn
        EUICoreStandaloneMinimap._patchNotesSidebarBtn = btn
    end
    ...
    do
        ...
        local label = MakeFont(btn, 14, nil, TEXT_DIM.r, TEXT_DIM.g, TEXT_DIM.b, TEXT_DIM.a)
        label:SetPoint("LEFT", icon, "RIGHT", NAV_TXT_GAP, 0)
        label:SetText(EUICoreStandaloneMinimap.L("Profiles & Presets"))
        btn._label = label
        ...
        EUICoreStandaloneMinimap._profilesSidebarBtn = btn
    end
    ...
    local sbBg = SolidTex(sidebarSearchFrame, "BACKGROUND",
        EUICoreStandaloneMinimap.SL_INPUT_R, EUICoreStandaloneMinimap.SL_INPUT_G, EUICoreStandaloneMinimap.SL_INPUT_B, EUICoreStandaloneMinimap.SL_INPUT_A + 0.10)
    sbBg:SetAllPoints()
    local sbBrd = MakeBorder(sidebarSearchFrame,
        EUICoreStandaloneMinimap.BORDER_R, EUICoreStandaloneMinimap.BORDER_G, EUICoreStandaloneMinimap.BORDER_B, 0.10)

    local sbEdit = CreateFrame("EditBox", nil, sidebarSearchFrame)
    sbEdit:SetAllPoints()
    sbEdit:SetAutoFocus(false)
    sbEdit:SetFont(EUICoreStandaloneMinimap.EXPRESSWAY, 13, "")
    ...
    sbPlaceholder:SetText(EUICoreStandaloneMinimap.L("Search Features..."))
    ...
    local function _sbBorderHover(a) sbBrd:SetColor(EUICoreStandaloneMinimap.BORDER_R, EUICoreStandaloneMinimap.BORDER_G, EUICoreStandaloneMinimap.BORDER_B, a) end
    ...
    EUICoreStandaloneMinimap._sidebarSearchBox = sbEdit
    EUICoreStandaloneMinimap._sidebarSearchText = ""
    ...
    sbEdit:SetScript("OnTextChanged", function(self)
        ...
        EUICoreStandaloneMinimap._sidebarSearchText = text
        -- Deliberately NO sidebar filtering here: the global search results popup
        -- (EUICoreStandaloneMinimap_GlobalSearch.lua) lists matches without reshuffling the nav.
    end)
    ...
    EUICoreStandaloneMinimap._addonScrollFrame = addonScrollFrame
    EUICoreStandaloneMinimap._addonScrollChild = addonScrollChild
    ...
    EUICoreStandaloneMinimap._addonScrollArrow = arrowBtn

    local function UpdateAddonThumb()
        local maxScroll = EUICoreStandaloneMinimap.SafeScrollRange and EUICoreStandaloneMinimap.SafeScrollRange(addonScrollFrame) or 0
    ...
    addonScrollFrame:SetScript("OnMouseWheel", function(self, delta)
        local maxScroll = EUICoreStandaloneMinimap.SafeScrollRange and EUICoreStandaloneMinimap.SafeScrollRange(self) or 0
        if maxScroll <= 0 then return end
    ...
    -- with label + power), sized to fit all addons without scrolling. On EUICoreStandaloneMinimap so
    -- RefreshSidebarStates / _applySidebarSearch read the same values.
    EUICoreStandaloneMinimap.SIDEBAR_GROUP_ROW_H = 28
    EUICoreStandaloneMinimap.SIDEBAR_CHILD_ROW_H = 28   -- includes 6px air gap between addons
    EUICoreStandaloneMinimap.SIDEBAR_GROUP_GAP   = 10   -- extra vertical space between groups
    local GROUP_ROW_H    = EUICoreStandaloneMinimap.SIDEBAR_GROUP_ROW_H
    local CHILD_ROW_H    = EUICoreStandaloneMinimap.SIDEBAR_CHILD_ROW_H
    local CHILD_INDENT_X = NAV_LEFT + 16   -- label indent past the group label

    -- Register the addon-enable helper once (on EUICoreStandaloneMinimap to avoid new upvalues).
    if not EUICoreStandaloneMinimap._addonToggleInit then
        EUICoreStandaloneMinimap._addonToggleInit = true
        EUICoreStandaloneMinimap.IsAddonEnabled = function(name)
    ...
    local function CreateGroupHeader(group)
        ...
        label:SetText(EUICoreStandaloneMinimap.L(group.label))
    ...
    local function CreateAddonChildRow(info)
        ...
        label:SetText(EUICoreStandaloneMinimap.L(info.display))
        btn._label = label
        ...
        if info.folder == "EUICoreStandaloneMinimapCooldownManager"
            and EUICoreStandaloneMinimap.VideoGuides and EUICoreStandaloneMinimap.VideoGuides.AttachTip then
            EUICoreStandaloneMinimap.VideoGuides.AttachTip(btn, "cooldown_manager", {
        ...
        if not IS_STANDALONE and not info.comingSoon and not info.maintenance and not info.alwaysLoaded then
            ...
            pwrBtn:SetScript("OnEnter", function(self)
                ...
                if EUICoreStandaloneMinimap.ShowWidgetTooltip then
                    EUICoreStandaloneMinimap.ShowWidgetTooltip(self, enabled and "Disable " .. self._display or "Enable " .. self._display)
                end
            end)
            ...
            pwrBtn:SetScript("OnClick", function(self)
                ...
                EUICoreStandaloneMinimap:ShowConfirmPopup({
                    title       = EUICoreStandaloneMinimap.Lf("%1$s Module", enabled and EUICoreStandaloneMinimap.L("Disable") or EUICoreStandaloneMinimap.L("Enable")),
                    message     = EUICoreStandaloneMinimap.Lf("Are you sure you want to %1$s %2$s?", EUICoreStandaloneMinimap.L(action), EUICoreStandaloneMinimap.L(self._display)),
                    confirmText = enabled and "Disable & Reload" or "Enable & Reload",
                    cancelText  = "Cancel",
                    onConfirm   = function()
                        if folder == "EUICoreStandaloneMinimapBags" and EUICoreStandaloneMinimapDB then
                            EUICoreStandaloneMinimapDB.bagsUserChosen = true
                        end
                        if enabled then
        ...
        if not IS_STANDALONE and not info.comingSoon and not info.maintenance and not EUICoreStandaloneMinimap._syncExempt[info.folder] then
            ...
            syncTex:SetTexture(EUICoreStandaloneMinimap.SYNC_ICON)
            ...
            local isGlobalOnly = EUICoreStandaloneMinimap._syncGlobalOnly and EUICoreStandaloneMinimap._syncGlobalOnly[info.folder]
            local function RefreshSyncState()
                ...
                local profCount = 0
                if EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.profiles then
                    for _ in pairs(EUICoreStandaloneMinimapDB.profiles) do
                ...
                local activeProf = EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.activeProfile or "Default"
                local activeSynced = isGlobalOnly or EUICoreStandaloneMinimap.IsProfileSynced(syncFolder, activeProf)
                -- Check global hide settings
                if EUICoreStandaloneMinimapDB then
                    if EUICoreStandaloneMinimapDB.hideSyncIcons then
                        if EUICoreStandaloneMinimapDB.hideSyncIconsOnlyFull then
            ...
            if not EUICoreStandaloneMinimap._syncRefreshFns then EUICoreStandaloneMinimap._syncRefreshFns = {} end
            EUICoreStandaloneMinimap._syncRefreshFns[info.folder] = RefreshSyncState
            syncBtn:SetScript("OnEnter", function(self)
                if isGlobalOnly then
                    ...
                    if EUICoreStandaloneMinimap.ShowWidgetTooltip then
                        EUICoreStandaloneMinimap.ShowWidgetTooltip(self, "No Profile Level Customizations")
                    end
                    return
                end
                local activeProf = EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.activeProfile or "Default"
                local activeSynced = EUICoreStandaloneMinimap.IsProfileSynced(self._folder, activeProf)
                if activeSynced then
                    self._tex:SetVertexColor(SYNC_HOVER_R, SYNC_HOVER_G, SYNC_HOVER_B, 1)
                else
                ...
                if EUICoreStandaloneMinimap.ShowWidgetTooltip then
                    ...
                    EUICoreStandaloneMinimap.ShowWidgetTooltip(self, tip)
                end
            end)
            ...
            syncBtn:SetScript("OnClick", function(self)
                ...
                if EUICoreStandaloneMinimap.OpenSyncPopup then
                    EUICoreStandaloneMinimap.OpenSyncPopup(self._folder, self._display, self)
                end
            end)
        ...
        btn:SetScript("OnEnter", function(self)
            if self._comingSoon then
                if EUICoreStandaloneMinimap.ShowWidgetTooltip then
                    EUICoreStandaloneMinimap.ShowWidgetTooltip(self, "Coming soon")
                end
                return
            end
            if self._maintenance then
                if EUICoreStandaloneMinimap.ShowWidgetTooltip then
                    EUICoreStandaloneMinimap.ShowWidgetTooltip(self, "In Maintenance")
                end
                return
            end
            if self._ovLocked then
    ...
    -- EUICoreStandaloneMinimap fields to avoid upvalues in CreateMainFrame (60-upvalue cap); cumulative `_y` walks each row so group and child heights can differ.
    local _y = 0
    local _groupHeaders = EUICoreStandaloneMinimap._sidebarGroupButtons
    local _infoByFolder = EUICoreStandaloneMinimap._addonInfoByFolder
    local GROUP_GAP = EUICoreStandaloneMinimap.SIDEBAR_GROUP_GAP
    for i, group in ipairs(EUICoreStandaloneMinimap.ADDON_GROUPS) do
    ...
    EUICoreStandaloneMinimap._sidebarButtons = sidebarButtons
    -- Lock/unlock excluded modules during an override editing session: their settings cannot be
    -- captured, so the row grays out and blocks clicks. Called from the session enter/exit paths in EUICoreStandaloneMinimap_SpecOverrides.
    EUICoreStandaloneMinimap.RefreshSidebarOverrideLocks = function()
        local active = EUICoreStandaloneMinimap.SpecOverrides_EditSessionActive
            and EUICoreStandaloneMinimap.SpecOverrides_EditSessionActive() or false
        for folder, btn in pairs(sidebarButtons) do
            local lock = (active and EUICoreStandaloneMinimap.SpecOverrides_ModuleExcluded
                and EUICoreStandaloneMinimap.SpecOverrides_ModuleExcluded(folder)) or false
            if lock then
    ...
    EUICoreStandaloneMinimap._refreshAllSyncIcons = function()
    ...
    versionText:SetText("v" .. (EUICoreStandaloneMinimap.VERSION or "1.0"))
    ...
    tabBar._tabButtons = {}
    EUICoreStandaloneMinimap._tabBar = tabBar

    -----------------------------------------------------------------------
    --  Content header  (optional non-scrolling region above the scroll area)
    --  Modules call EUICoreStandaloneMinimap:SetContentHeader(buildFunc) to populate it.
    ...
    EUICoreStandaloneMinimap._contentHeader = contentHeaderFrame
    ...
    -----------------------------------------------------------------------
    scrollFrame = CreateFrame("ScrollFrame", "EUICoreStandaloneMinimapScrollFrame", clickArea)
    EUICoreStandaloneMinimap._scrollFrame = scrollFrame
    ...
    UpdateScrollThumb = function()
        local maxScroll = EUICoreStandaloneMinimap.SafeScrollRange(scrollFrame)
        if maxScroll <= 0 then
            scrollTrack:Hide()
            return
        end
    ...
    EUICoreStandaloneMinimap.SmoothScrollTo = SmoothScrollTo
    ...
    function EUICoreStandaloneMinimap.GetContentScroll()
    ...
    function EUICoreStandaloneMinimap:SetContentHeader(buildFunc)
    ...
    function EUICoreStandaloneMinimap:UpdateContentHeaderHeight(h)
    ...
    function EUICoreStandaloneMinimap:SetContentHeaderHeightSilent(h)
        if not contentHeaderFrame:IsShown() then return end
        contentHeaderH = h
        PanelPP.Height(contentHeaderFrame, h)
        ApplyContentLayout()
    ...
    function EUICoreStandaloneMinimap:ClearContentHeader()
        ClearContentHeaderInner()
    end

    -- Lightweight hide (no orphaning), for when the header is already cached.
    function EUICoreStandaloneMinimap:HideContentHeader()
        local ch = { contentHeaderFrame:GetChildren() }
        for _, c in ipairs(ch) do c:Hide() end
        local rg = { contentHeaderFrame:GetRegions() }
        for _, r in ipairs(rg) do
    ...
    function EUICoreStandaloneMinimap:SaveContentHeaderToCache(cacheKey)
        return SaveContentHeaderToCache(cacheKey)
    end
    function EUICoreStandaloneMinimap:RestoreContentHeaderFromCache(cacheKey)
        return RestoreContentHeaderFromCache(cacheKey)
    end
    function EUICoreStandaloneMinimap:InvalidateContentHeaderCache()
    ...
    local function MakeFooterBtn(parent, w, h, anchorPoint, anchorTo, anchorRel, ax, ay,
        ...
        lbl:SetAlpha(textA); lbl:SetPoint("CENTER"); lbl:SetText(EUICoreStandaloneMinimap.L(label))
        btn._label = lbl
        do
            local FADE_DUR = 0.1
            local progress, target = 0, 0
    ...
    local resetBtn = MakeFooterBtn(footerFrame, FOOTER_BTN_W, FOOTER_BTN_H,
        ...
        "Reset", function()
            ...
            local msg = EUICoreStandaloneMinimap.Lf("Are you sure you want to reset all %1$s settings to their defaults? This will reload your UI.", EUICoreStandaloneMinimap.L(addonTitle))
            local disclaimer
            if activeModule == (EUICoreStandaloneMinimap.GLOBAL_KEY or "_EUIGlobal") then
                disclaimer = "This will not reset addon-specific Quick Setup."
            end
            EUICoreStandaloneMinimap:ShowConfirmPopup({
                title       = EUICoreStandaloneMinimap.Lf("Reset %1$s", EUICoreStandaloneMinimap.L(addonTitle)),
                message     = msg,
    ...
    EUICoreStandaloneMinimap._UpdateResetButtonVisible = function(hasReset)
    ...
    do
        ...
        for i = #socialDefs, 1, -1 do
            ...
            btn:SetScript("OnEnter", function(self)
                ...
                if def.tooltip and EUICoreStandaloneMinimap.ShowWidgetTooltip then
                    EUICoreStandaloneMinimap.ShowWidgetTooltip(self, def.tooltip)
                end
            end)
            btn:SetScript("OnLeave", function(self)
    ...
    do
        ...
        lbl:SetAlpha(0.7); lbl:SetPoint("CENTER"); lbl:SetText(EUICoreStandaloneMinimap.L("Close"))
...
EUICoreStandaloneMinimap.TAB_LABEL_OVERRIDES = EUICoreStandaloneMinimap.TAB_LABEL_OVERRIDES or {}
...
CreateTabButton = function(index, name)
    ...
    label:SetText(EUICoreStandaloneMinimap.L(EUICoreStandaloneMinimap.TAB_LABEL_OVERRIDES[name] or name))
    btn._label = label
    btn._name  = name
    ...
    btn:SetScript("OnClick", function(self) EUICoreStandaloneMinimap:SelectPage(self._name) end)
...
BuildTabs = function(pageNames, disabledPages, disabledTooltips)
    ...
    for i, name in ipairs(pageNames) do
        ...
        if disabledSet[name] then
            ...
            if tip then
                btn:SetScript("OnEnter", function(self)
                    if EUICoreStandaloneMinimap.ShowWidgetTooltip then EUICoreStandaloneMinimap.ShowWidgetTooltip(self, tip) end
                end)
    ...
    if not tabBar._searchBox then
        ...
        editBox:SetAutoFocus(false)
        editBox:SetFont(EUICoreStandaloneMinimap.EXPRESSWAY, 13, "")
        ...
        placeholder:SetText(EUICoreStandaloneMinimap.L("Search Module Settings..."))
        ...
        editBox:SetScript("OnTextChanged", function(self, userInput)
            ...
            EUICoreStandaloneMinimap:ApplyInlineSearch(text, true)
            if text ~= "" then
                searchDebounceTimer = C_Timer.NewTimer(0.5, function()
                    searchDebounceTimer = nil
                    EUICoreStandaloneMinimap:ApplyInlineSearch(text)
                end)
            end
        end)
        ...
        -- and behavior live in EUICoreStandaloneMinimap_SpecOverrides.lua.
        if EUICoreStandaloneMinimap.SpecOverrides_SetupButton then
            ...
            EUICoreStandaloneMinimap.SpecOverrides_SetupButton(soBtn)
...
EUICoreStandaloneMinimap.PlaySearchHighlight = PlaySearchHighlight
EUICoreStandaloneMinimap.GetSearchHighlight = GetSearchHighlight
...
function EUICoreStandaloneMinimap:NavigateToElementSettings(moduleName, pageName, sectionName, preSelectFn, highlightText)
    ...
    local function ResolveHighlightSlot(row, text)
        ...
        local locText = EUICoreStandaloneMinimap.L and EUICoreStandaloneMinimap.L(text) or text
    ...
    if self:_SplitFirstOpen(function()
        EUICoreStandaloneMinimap:NavigateToElementSettings(moduleName, pageName, sectionName, preSelectFn, highlightText)
    end) then return end
        ...
        for _, sec in ipairs(sections) do
            if sec.header._sectionName == sectionName then
                ...
                if a then
                    ...
                    EUICoreStandaloneMinimap.SmoothScrollTo(scrollPos)
...
function EUICoreStandaloneMinimap:ApplyInlineSearch(query, skipHighlights)
    ...
    if EUICoreStandaloneMinimap.SetLessCommonSearchActive then
        EUICoreStandaloneMinimap.SetLessCommonSearchActive(query ~= nil and query ~= "")
    end
    ...
    if EUICoreStandaloneMinimap._onInlineSearch then EUICoreStandaloneMinimap._onInlineSearch(query or "") end
    ...
    for _, sec in ipairs(sections) do
        ...
        local excluded = EUICoreStandaloneMinimap._searchExcludeSection
            and EUICoreStandaloneMinimap._searchExcludeSection(sectionName)
...
ClearContent = function()
    ...
    if EUICoreStandaloneMinimap.ClearContentHeader then
        EUICoreStandaloneMinimap:ClearContentHeader()
    end
    ...
    if EUICoreStandaloneMinimap._copyPopup then EUICoreStandaloneMinimap._copyPopup:Hide() end
    if EUICoreStandaloneMinimap._copyBackdrop then EUICoreStandaloneMinimap._copyBackdrop:Hide() end
...
--  Usage:  local left, right, splitFrame = EUICoreStandaloneMinimap:CreateSplitColumns(parent, yOffset)
...
-------------------------------------------------------------------------------
function EUICoreStandaloneMinimap:CreateSplitColumns(parent, yOffset)
...
--  Module Registration
-------------------------------------------------------------------------------
function EUICoreStandaloneMinimap:RegisterModule(folderName, config)
    -- Only allow registration from EUICoreStandaloneMinimap addon files.
    ...
    local ALLOWED = {
        EUICoreStandaloneMinimap = true,
        EUICoreStandaloneMinimapOptions = true,  -- the LoadOnDemand options surface: every module's options file registers from here
        EUICoreStandaloneMinimapActionBars = true,
        EUICoreStandaloneMinimapAuraBuffReminders = true,
        EUICoreStandaloneMinimapCooldownManager = true,
        EUICoreStandaloneMinimapNameplates = true,
        EUICoreStandaloneMinimapPartyMode = true,
        EUICoreStandaloneMinimapRaidFrames = true,
        EUICoreStandaloneMinimapResourceBars = true,
        EUICoreStandaloneMinimapUnitFrames = true,
        EUICoreStandaloneMinimapMythicTimer = true,
        -- v6.6 split
        EUICoreStandaloneMinimapQoL = true,
        EUICoreStandaloneMinimapBlizzardSkin = true,
        EUICoreStandaloneMinimapQuestTracker = true,
        EUIStandaloneMinimap = true,
        EUICoreStandaloneMinimapFriends = true,
        EUICoreStandaloneMinimapChat = true,
        EUICoreStandaloneMinimapDamageMeters = true,
        EUICoreStandaloneMinimapBags = true,
        EUICoreStandaloneMinimapDataBars = true,
        EUICoreStandaloneMinimapQuickdraw = true,
    }
...
--- Reset every registered module's settings and the shared EUICoreStandaloneMinimapDB.
--- Called by the "Reset ALL EUI Addon Settings" button in Global Settings.
function EUICoreStandaloneMinimap:ResetAllModules()
    ...
    if EUICoreStandaloneMinimapDB then
        EUICoreStandaloneMinimapDB.unlockAnchors = nil
        -- Wipe profile system data so the user starts fresh
        EUICoreStandaloneMinimapDB.profiles = nil
        EUICoreStandaloneMinimapDB.profileOrder = nil
        EUICoreStandaloneMinimapDB.specProfiles = nil
        EUICoreStandaloneMinimapDB.activeProfile = nil
    end
end
...
_pageCache = {}
EUICoreStandaloneMinimap._pageCache = _pageCache
...
function EUICoreStandaloneMinimap:InvalidatePageCache()
    for key, entry in pairs(_pageCache) do
        if entry.wrapper then
            entry.wrapper:Hide()
            entry.wrapper:SetParent(nil)
    ...
    _activePageWrapper = nil
    if EUICoreStandaloneMinimap.InvalidateContentHeaderCache then
        EUICoreStandaloneMinimap:InvalidateContentHeaderCache()
    end
end
...
function EUICoreStandaloneMinimap:InvalidateModulePageCache(moduleName)
...
function EUICoreStandaloneMinimap:SelectPage(pageName)
    ...
    if EUICoreStandaloneMinimap.SpecOverrides_EditSessionActive
       and EUICoreStandaloneMinimap.SpecOverrides_EditSessionActive()
       and EUICoreStandaloneMinimap.SpecOverrides_PageExcluded
       and EUICoreStandaloneMinimap.SpecOverrides_PageExcluded(activeModule, pageName) then
        return
    end
    ...
    if pageName == "Disable Addons" then
        if EUICoreStandaloneMinimap._mainFrame then EUICoreStandaloneMinimap._mainFrame:Hide() end
        C_Timer.After(0, function()
    ...
    if activePage then
        ...
        EUICoreStandaloneMinimap:SaveContentHeaderToCache(oldKey)
    end
    ...
    if cached and cached.wrapper then
        ...
        if not EUICoreStandaloneMinimap:RestoreContentHeaderFromCache(cacheKey) then
            if cached.headerBuilder then
                cached.wrapper:Hide()
                cached.wrapper:SetParent(nil)
                _pageCache[cacheKey] = nil
                cached = nil
            elseif EUICoreStandaloneMinimap.ClearContentHeader then
                EUICoreStandaloneMinimap:ClearContentHeader()
            end
        end
    end
    ...
    if cached and cached.wrapper then
        ...
        if cached._searchFiltered then
            EUICoreStandaloneMinimap:ApplyInlineSearch("")
        end
        ...
        if EUICoreStandaloneMinimap._copyPopup then EUICoreStandaloneMinimap._copyPopup:Hide() end
        if EUICoreStandaloneMinimap._copyBackdrop then EUICoreStandaloneMinimap._copyBackdrop:Hide() end
        if EUICoreStandaloneMinimap.ClearContentHeader then EUICoreStandaloneMinimap:ClearContentHeader() end
        ...
        if config.buildPage then
            ...
            EUICoreStandaloneMinimap._buildingModule = activeModule
            EUICoreStandaloneMinimap._buildingPage = pageName
            totalH = config.buildPage(pageName, wrapper, startY) or 600
            EUICoreStandaloneMinimap._buildingModule = nil
            EUICoreStandaloneMinimap._buildingPage = nil
            EUICoreStandaloneMinimap._buildingSelector = nil
...
function EUICoreStandaloneMinimap:RefreshPage(force)
    if not activeModule or not activePage then return end
    ...
    if not (mainFrame and mainFrame:IsShown()) then
        EUICoreStandaloneMinimap._pendingForceRefresh = true
        return
    end
    ...
    if config.buildPage then
        local startY = -6
        EUICoreStandaloneMinimap._buildingModule = activeModule
        EUICoreStandaloneMinimap._buildingPage = activePage
...
EUICoreStandaloneMinimap:RegisterOnShow(function()
    if EUICoreStandaloneMinimap._pendingForceRefresh then
        EUICoreStandaloneMinimap._pendingForceRefresh = nil
        EUICoreStandaloneMinimap:RefreshPage(true)
    end
end)

-- Public: snap the settings scroll back to the top (e.g. in resource bars clicking on a
-- simple section to the Advanced page)
function EUICoreStandaloneMinimap:ScrollToTop()
    if scrollFrame and scrollFrame.SetVerticalScroll then
        scrollTarget = 0
        isSmoothing = false
        if smoothFrame then smoothFrame:Hide() end
...
function EUICoreStandaloneMinimap:GetActiveModule()
    return activeModule
end

function EUICoreStandaloneMinimap:GetModuleTitle(folderName)
    local m = folderName and modules[folderName]
    return m and m.title
end

function EUICoreStandaloneMinimap:SelectModule(folderName)
    ...
    if EUICoreStandaloneMinimap.SpecOverrides_EditSessionActive
       and EUICoreStandaloneMinimap.SpecOverrides_EditSessionActive()
       and EUICoreStandaloneMinimap.SpecOverrides_ModuleExcluded
       and EUICoreStandaloneMinimap.SpecOverrides_ModuleExcluded(folderName) then
        return
    end
    ...
    headerFrame._title:SetText(EUICoreStandaloneMinimap.L(config.title or folderName))
    ...
    if rb and rb._label then
        ...
        rb._label:SetText(EUICoreStandaloneMinimap.Lf("Reset %1$s", EUICoreStandaloneMinimap.L(displayName)))
        rb._label:SetWidth(rb:GetWidth() * 0.85)
        rb._label:SetWordWrap(false)
        rb._label:SetMaxLines(1)
    end
    if EUICoreStandaloneMinimap._UpdateResetButtonVisible then
        EUICoreStandaloneMinimap._UpdateResetButtonVisible(config.onReset ~= nil)
    end
    headerFrame._desc:SetText(EUICoreStandaloneMinimap.L(config.description or ""))
    ...
    if tabBar then
        ...
        if tabBar._searchFrame then
            tabBar._searchFrame:SetShown(core or folderName == EUICoreStandaloneMinimap.GLOBAL_KEY)
        end
...
-------------------------------------------------------------------------------
function EUICoreStandaloneMinimap._applySidebarSearch(text)
    text = text and text:lower() or ""
    local scrollChild = EUICoreStandaloneMinimap._addonScrollChild
    if not scrollChild then return end
    ...
    local function addLocalized(parts, s)
        ...
        local loc = tostring(EUICoreStandaloneMinimap.L(s))
    ...
    local y = 0
    local groupHeaders = EUICoreStandaloneMinimap._sidebarGroupButtons
    local infoByFolder = EUICoreStandaloneMinimap._addonInfoByFolder
    local GROUP_H  = EUICoreStandaloneMinimap.SIDEBAR_GROUP_ROW_H
    local CHILD_H  = EUICoreStandaloneMinimap.SIDEBAR_CHILD_ROW_H
    local GROUP_GAP = EUICoreStandaloneMinimap.SIDEBAR_GROUP_GAP
    ...
    if text ~= "" and EUICoreStandaloneMinimap._addonScrollFrame then
        EUICoreStandaloneMinimap._addonScrollFrame:SetVerticalScroll(0)
    end
end
...
local function RefreshSidebarStates()
    ...
    if not activeModule then
        ...
        if modules["_EUIGlobal"] then
            EUICoreStandaloneMinimap:SelectModule("_EUIGlobal")
        elseif firstLoaded and modules[firstLoaded] then
            EUICoreStandaloneMinimap:SelectModule(firstLoaded)
        end
    end
    ...
    if EUICoreStandaloneMinimap.RefreshSidebarOverrideLocks then
        EUICoreStandaloneMinimap.RefreshSidebarOverrideLocks()
    end
end
...
local function ShowSidebarUnlockTip()
    if EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.sidebarUnlockTipSeen then return end
    if _sidebarUnlockTip and _sidebarUnlockTip:IsShown() then return end
    local anchor = EUICoreStandaloneMinimap._unlockSidebarBtn
    ...
    if not _sidebarUnlockTip then
        ...
        msg:SetJustifyH("CENTER")
        msg:SetSpacing(6)
        msg:SetText(EUICoreStandaloneMinimap.L("Unlock Mode is where you can adjust\npositioning for all the elements of EUICoreStandaloneMinimap"))

        -- Okay button
        local okBtn = CreateFrame("Button", nil, tip)
        okBtn:SetSize(86, 26)
        okBtn:SetPoint("BOTTOM", tip, "BOTTOM", 0, 13)
        EUICoreStandaloneMinimap.MakeStyledButton(okBtn, "Okay", 11,
            EUICoreStandaloneMinimap.RB_COLOURS, function()
                tip:Hide()
                if EUICoreStandaloneMinimapDB then EUICoreStandaloneMinimapDB.sidebarUnlockTipSeen = true end
            end)
...
function EUICoreStandaloneMinimap:_SplitFirstOpen(afterFn)
    if self._deferredLoaded then return false end
    self:EnsureLoaded()
    if not self._deferredLoaded then return false end
    self._openPending = true
    C_Timer.After(0, function()
        EUICoreStandaloneMinimap._openPending = nil
        afterFn()
    end)
    return true
end

function EUICoreStandaloneMinimap:Show()
    if self._openPending then return end
    if self:_SplitFirstOpen(function() EUICoreStandaloneMinimap:Show() end) then return end
    CreateMainFrame()
    RefreshSidebarStates()
    mainFrame:Show()
    ShowSidebarUnlockTip()
end
function EUICoreStandaloneMinimap:Hide()   if mainFrame then mainFrame:Hide() end end
function EUICoreStandaloneMinimap:Toggle()
    if self._openPending then return end
    if self:_SplitFirstOpen(function() EUICoreStandaloneMinimap:Toggle() end) then return end
    CreateMainFrame()
...
function EUICoreStandaloneMinimap:IsShown() return mainFrame and mainFrame:IsShown() end
function EUICoreStandaloneMinimap:GetScrollFrame() return scrollFrame end
...
function EUICoreStandaloneMinimap:GetMainFrame() return mainFrame end
function EUICoreStandaloneMinimap:GetActivePage() return activePage end
...
do
    ...
    local function OnScaleUpdate(self, dt)
        ...
        if t >= 1 then
            ...
            if EUICoreStandaloneMinimap._onScaleChanged then
                for _, fn in ipairs(EUICoreStandaloneMinimap._onScaleChanged) do fn() end
            end
        end
    end

    function EUICoreStandaloneMinimap:SetPanelScale(userScale)
        if not mainFrame then return end
        local physW = (GetPhysicalScreenSize())
        local baseScale = GetScreenWidth() / physW
        local targetScale = baseScale * (userScale or 1.0)
        if EUICoreStandaloneMinimapDB then EUICoreStandaloneMinimapDB.panelScale = userScale end
...
--  Slash commands
-------------------------------------------------------------------------------
EUICoreStandaloneMinimap.VERSION = "8.9.1"

-- Register this addon's version into a shared global table (taint-free at load time)
if not _G._EUI_AddonVersions then _G._EUI_AddonVersions = {} end
_G._EUI_AddonVersions[EUI_HOST_ADDON] = EUICoreStandaloneMinimap.VERSION
...
do
    ...
    f:SetScript("OnEvent", function(self)
        ...
        if not EUICoreStandaloneMinimapDB then EUICoreStandaloneMinimapDB = {} end
        local prev = EUICoreStandaloneMinimapDB.lastLoginVersion
        if prev and prev ~= EUICoreStandaloneMinimap.VERSION then
            EUICoreStandaloneMinimapDB.patchDotPending = true
        end
        EUICoreStandaloneMinimapDB.lastLoginVersion = EUICoreStandaloneMinimap.VERSION
        if EUICoreStandaloneMinimap._UpdatePatchDot then EUICoreStandaloneMinimap._UpdatePatchDot() end
    end)
end
...
do
    ...
    f:SetScript("OnEvent", function(self)
        ...
        C_Timer.After(2, function()
            ...
            local msg = "The following EUICoreStandaloneMinimap addons are out of date. "
                .. "Please update so all addons are the same version:\n\n"
                .. table.concat(outdated, ", ")
            if EUICoreStandaloneMinimap.ShowConfirmPopup then
                EUICoreStandaloneMinimap:ShowConfirmPopup({
                    title       = "Out of Date",
                    message     = msg,
                    confirmText = "OK",
...
--------------------------------------------------------------------------------
-- Conflict check is wrapped in a function so the first-install popup (EUICoreStandaloneMinimap_FirstInstall.lua)
...
EUICoreStandaloneMinimap._RunConflictCheck = function()
    ...
    do
        ...
        -- Blizzard UI Enhanced has sub-features stored as flags on EUICoreStandaloneMinimapDB; conflicts against a specific sub-feature only fire when that feature is actually enabled.
        local function BlizzardSkinSubEnabled(key)
            if not EUICoreStandaloneMinimapDB then return true end
            return EUICoreStandaloneMinimapDB[key] ~= false
        end
        local conflicts = {
            { addon = "ElvUI",                    label = "ElvUI",                      targets = "all",                              message = "Many of ElvUI's modules are incompatible with EUICoreStandaloneMinimap. Make sure to disable any conflicting modules." },
            { addon = "DandersFrames",            label = "Danders Frames",             targets = { "EUICoreStandaloneMinimapRaidFrames" } },
            { addon = "HarreksAdvancedRaidFrames", label = "Harreks Advanced Raid Frames", targets = { "EUICoreStandaloneMinimapRaidFrames" } },
            { addon = "Grid2",                    label = "Grid2",                      targets = { "EUICoreStandaloneMinimapRaidFrames" } },
            ...
            { addon = "Clique",                   label = "Clique",                     targets = { "EUICoreStandaloneMinimapRaidFrames" },
              moduleCheck = function() return _G._ERF_IsHoverCastEnabled and _G._ERF_IsHoverCastEnabled() end,
              message = "Clique controls click-casting on the same Raid Frames as EUICoreStandaloneMinimap's HoverCast, so they conflict. Disable the Clique addon to use HoverCast." },
            { addon = "TellMeWhen",               label = "TellMeWhen",                 targets = "all",                              message = "TellMeWhen overlaps with EUICoreStandaloneMinimap's core positional architecture. If you ONLY use for sound alerts it should be okay but may still cause issues." },
            { addon = "Bartender4",               label = "Bartender4",                 targets = { "EUICoreStandaloneMinimapActionBars" } },
            { addon = "Dominos",                  label = "Dominos",                    targets = { "EUICoreStandaloneMinimapActionBars" } },
            { addon = "ImprovedTalentLoadouts",   label = "Improved Talent Loadouts",   targets = { "EUICoreStandaloneMinimapActionBars" } },
            { addon = "UnhaltedUnitFrames",       label = "Unhalted Unit Frames",       targets = { "EUICoreStandaloneMinimapUnitFrames" } },
            { addon = "Platynator",               label = "Platynator",                 targets = { "EUICoreStandaloneMinimapNameplates" } },
            { addon = "Plater",                   label = "Plater Nameplates",          targets = { "EUICoreStandaloneMinimapNameplates" } },
            { addon = "Kui_Nameplates",            label = "KUI Nameplates",             targets = { "EUICoreStandaloneMinimapNameplates" } },
            { addon = "TidyPlates",               label = "TidyPlates",                 targets = { "EUICoreStandaloneMinimapNameplates" } },
            { addon = "TidyPlates_ThreatPlates",  label = "TidyPlates ThreatPlates",    targets = { "EUICoreStandaloneMinimapNameplates" } },
            { addon = "Healers-Have-To-Die",      label = "Healers Have To Die",        targets = { "EUICoreStandaloneMinimapNameplates" } },
            { addon = "Aloft",                    label = "Aloft",                      targets = { "EUICoreStandaloneMinimapNameplates" } },
            { addon = "SenseiClassResourceBar",   label = "Sensei Class Resource Bar",  targets = { "EUICoreStandaloneMinimapResourceBars" } },
            { addon = "EditModeExpanded",     label = "Edit Mode Expanded",         targets = { "EUICoreStandaloneMinimapQuestTracker", "EUICoreStandaloneMinimapChat" } },
            { addon = "SexyMap",                  label = "SexyMap",                    targets = { "EUIStandaloneMinimap" }, },
            { addon = "MinimapButtonButton",      label = "MinimapButtonButton",        targets = { "EUIStandaloneMinimap" }, },
            { addon = "Leatrix_Plus",              label = "Leatrix",                    targets = { "EUICoreStandaloneMinimapChat", "EUIStandaloneMinimap" },
              message = "Leatrix Plus has chat and minimap features that conflict with EUICoreStandaloneMinimap. Disable any chat or minimap related options within Leatrix Plus to stay compatible." },
            { addon = "Prat-3.0",                 label = "Prat",                       targets = { "EUICoreStandaloneMinimapChat" } },
            { addon = "Chatter",                  label = "Chatter",                    targets = { "EUICoreStandaloneMinimapChat" } },
            { addon = "Chattynator",              label = "Chattynator",                targets = { "EUICoreStandaloneMinimapChat" } },
            { addon = "Glass",                    label = "Glass",                      targets = { "EUICoreStandaloneMinimapChat" } },
            { addon = "AdiBags",                  label = "AdiBags",                    targets = { "EUICoreStandaloneMinimapBags" } },
            { addon = "ArkInventory",             label = "ArkInventory",               targets = { "EUICoreStandaloneMinimapBags" } },
            { addon = "Baganator",                label = "Baganator",                  targets = { "EUICoreStandaloneMinimapBags" } },
            { addon = "Bagnon",                   label = "Bagnon",                     targets = { "EUICoreStandaloneMinimapBags" } },
            { addon = "BetterBags",               label = "BetterBags",                 targets = { "EUICoreStandaloneMinimapBags" } },
            { addon = "Sorted",                   label = "Sorted",                     targets = { "EUICoreStandaloneMinimapBags" } },
            { addon = "UltimateMouseCursor",      label = "Ultimate Mouse Cursor",      targets = { "EUICoreStandaloneMinimapQoL" } },
            { addon = "BetterCooldownManager",    label = "Better Cooldown Manager",    targets = { "EUICoreStandaloneMinimapCooldownManager", "EUICoreStandaloneMinimapResourceBars" } },
            { addon = "CooldownManagerCentered",    label = "Cooldown Manager Centered",    targets = { "EUICoreStandaloneMinimapCooldownManager" } },
            { addon = "SkironCooldownManager",    label = "Skiron Cooldown Manager",    targets = { "EUICoreStandaloneMinimapCooldownManager" } },
            { addon = "ArcUI",                    label = "ArcUI",                      targets = { "EUICoreStandaloneMinimapCooldownManager", } },
            { addon = "Ayije_CDM",                label = "Ayije CDM",                  targets = { "EUICoreStandaloneMinimapCooldownManager", "EUICoreStandaloneMinimapResourceBars" } },
            { addon = "MythicPlusTimer",          label = "Mythic Plus Timer",          targets = { "EUICoreStandaloneMinimapMythicTimer" } },
            { addon = "WarpDeplete",              label = "WarpDeplete",                targets = { "EUICoreStandaloneMinimapMythicTimer" } },
            { addon = "MPlusTimer",               label = "MPlusTimer",                 targets = { "EUICoreStandaloneMinimapMythicTimer" } },
            { addon = "ChonkyCharacterSheet",     label = "Chonky Character Sheet",     targets = { "EUICoreStandaloneMinimapBlizzardSkin" },
              moduleCheck = function() return BlizzardSkinSubEnabled("themedCharacterSheet") end,
              message = "Chonky Character Sheet conflicts with the EUICoreStandaloneMinimap's Character Sheet. Disable either Chonky or the Character Sheet skin in Blizzard UI Enhanced settings." },
            { addon = "DejaCharacterStats",       label = "Deja Character Stats",       targets = { "EUICoreStandaloneMinimapBlizzardSkin" },
              moduleCheck = function() return BlizzardSkinSubEnabled("themedCharacterSheet") end,
              message = "Deja Character Stats conflicts with the EUICoreStandaloneMinimap's Character Sheet. Disable either Deja or the Character Sheet skin in Blizzard UI Enhanced settings." },
            { addon = "BetterCharacterPanel",     label = "Better Character Panel",     targets = { "EUICoreStandaloneMinimapBlizzardSkin" },
              moduleCheck = function() return BlizzardSkinSubEnabled("themedCharacterSheet") end,
              message = "Better Character Panel conflicts with the EUICoreStandaloneMinimap's Character Sheet. Disable either Better Character Panel or the Character Sheet skin in Blizzard UI Enhanced settings." },
            { addon = "idTip",                    label = "idTip",                      targets = "all",
              message = "idTip conflicts with EUICoreStandaloneMinimap's tooltip systems. Disable the idTip addon to stay compatible." },
            -- Old name of EUICoreStandaloneMinimapDataBars: a leftover copy of the addon from before the rename duplicates the entire bar.
            { addon = "EUICoreStandaloneMinimapWonderBar",     label = "EUICoreStandaloneMinimap WonderBar",      targets = { "EUICoreStandaloneMinimapDataBars" },
              message = "EUICoreStandaloneMinimap WonderBar was renamed to EUICoreStandaloneMinimap DataBars. The old WonderBar addon is still installed and both create the same bar. Please disable or delete the EUICoreStandaloneMinimapWonderBar addon." },
        ...
        local exempt = { EUICoreStandaloneMinimapPartyMode = true }

        if not EUICoreStandaloneMinimapDB then EUICoreStandaloneMinimapDB = {} end
        if not EUICoreStandaloneMinimapDB.dismissedConflicts then EUICoreStandaloneMinimapDB.dismissedConflicts = {} end
        local dismissed = EUICoreStandaloneMinimapDB.dismissedConflicts
            ...
            if entry.addon ~= EUI_HOST_ADDON and IsLoaded(entry.addon)
               and moduleActive and not suppressedBySpecific then
                ...
                if entry.targets == "all" then
                    local allTargets = {
                        "EUICoreStandaloneMinimapActionBars", "EUICoreStandaloneMinimapUnitFrames", "EUICoreStandaloneMinimapNameplates",
                        "EUICoreStandaloneMinimapResourceBars", "EUICoreStandaloneMinimapAuraBuffReminders", "EUICoreStandaloneMinimapCooldownManager",
                        "EUICoreStandaloneMinimapRaidFrames",
                    }
        ...
        local function ShowNextConflict()
            ...
            for _, a in ipairs(affected) do
                -- Prefer the module's registered display title; fall back to stripping the EUICoreStandaloneMinimap prefix from the folder name.
                local displayName = (modules[a] and modules[a].title)
                    or a:gsub("^EUICoreStandaloneMinimap", "")
                names[#names + 1] = displayName
            end
            local msg = entry.message or (
                entry.label .. " is not compatible with EUICoreStandaloneMinimap's " .. table.concat(names, ", ")
            ...
            if EUICoreStandaloneMinimap.ShowConfirmPopup then
                ...
                EUICoreStandaloneMinimap.Print("|cffff6060[EUICoreStandaloneMinimap]|r " .. msg:gsub("\n", " "))
                ShowNextConflict()
            end
        end
        ShowNextConflict()
...
C_Timer.After(2, function()
    if EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.firstInstallPopupShown then
        ...
        -- popup files, plus the 12.1 launch video announcement in EUICoreStandaloneMinimap_VideoGuides.lua).
        if EUICoreStandaloneMinimap._raidFramesIntroPending or EUICoreStandaloneMinimap._patchNotesIntroPending
           or EUICoreStandaloneMinimap._windowSkinsIntroPending or EUICoreStandaloneMinimap._specOvIntroPending
           or EUICoreStandaloneMinimap._ptrManagersIntroPending or EUICoreStandaloneMinimap._launchVideoIntroPending then return end
        if EUICoreStandaloneMinimap._RunConflictCheck then EUICoreStandaloneMinimap._RunConflictCheck() end
    end
end)
...
SlashCmdList.EUIOPTIONS = function()
    C_Timer.After(0, function()
        if InCombatLockdown() then
            EUICoreStandaloneMinimap.Print("|cffff6060[EUICoreStandaloneMinimap]|r Cannot open options during combat.")
            return
        end
        EUICoreStandaloneMinimap:Toggle()
    end)
end
...
SlashCmdList.EUIPARTYMODE = function()
    C_Timer.After(0, function()
        ...
        EUICoreStandaloneMinimap:ShowModule("EUICoreStandaloneMinimapPartyMode")
    end)
end
...
SlashCmdList.PARTYMODETOGGLE = function()
    C_Timer.After(0, function()
        if EUICoreStandaloneMinimap_TogglePartyMode then
            EUICoreStandaloneMinimap_TogglePartyMode()
        else
            EUICoreStandaloneMinimap.Print("|cffff6060[EUICoreStandaloneMinimap]|r Party Mode addon is not loaded.")
        end
    end)
end
...
SlashCmdList.EUIUNLOCK = function()
    C_Timer.After(0, function()
        ...
        EUICoreStandaloneMinimap:EnsureUnlockCore()
        if EUICoreStandaloneMinimap._openUnlockMode then
            EUICoreStandaloneMinimap._openUnlockMode()
        else
            EUICoreStandaloneMinimap.Print("|cffff6060[EUICoreStandaloneMinimap]|r Unlock Mode is not available.")
        end
    end)
end
...
SlashCmdList.EUIRESETHINT = function()
    C_Timer.After(0, function()
        if EUICoreStandaloneMinimapDB then
            EUICoreStandaloneMinimapDB.previewHintDismissed = nil
            EUICoreStandaloneMinimapDB.unlockTipSeen = nil
            EUICoreStandaloneMinimapDB.sidebarUnlockTipSeen = nil
            EUICoreStandaloneMinimapDB.rfEyeHintSeen = nil
            EUICoreStandaloneMinimapDB.bmIconHintDismissed = nil
        end
        EUICoreStandaloneMinimap.Print("|cff00ff00[EUICoreStandaloneMinimap]|r All hints reset. /reload to see them again.")
    end)
end
...
SlashCmdList.EUIRESETSCALE = function()
    C_Timer.After(0, function()
        if EUICoreStandaloneMinimapDB then
            EUICoreStandaloneMinimapDB.ppUIScale = nil
            EUICoreStandaloneMinimapDB.ppUIScaleAuto = nil
        end
        EUICoreStandaloneMinimap.Print("|cff00ff00[EUICoreStandaloneMinimap]|r UI scale reset. /reload to re-snapshot from your Blizzard scale.")
    end)
end
...
SlashCmdList.EUIDEV = function()
    ...
    EUICoreStandaloneMinimap.Print("|cff00ff00[EUICoreStandaloneMinimap]|r Dev mode: all addon restriction CVars " .. state .. ".")
    if EUICoreStandaloneMinimap.UpdateDevModeIndicator then EUICoreStandaloneMinimap.UpdateDevModeIndicator() end
end
...
do
    ...
    function EUICoreStandaloneMinimap.IsDevModeActive()
    ...
    local function CreateDevBadge()
        ...
        local PP = EUICoreStandaloneMinimap.PP
        local accent = EUICoreStandaloneMinimap.ELLESMERE_GREEN or { r = 0.05, g = 0.82, b = 0.62 }

        local f = CreateFrame("Frame", "EUICoreStandaloneMinimapDevModeBadge", UIParent)
        ...
        label:SetFont(EUICoreStandaloneMinimap.EXPRESSWAY, 11,
            (EUICoreStandaloneMinimap.SlugFlag and EUICoreStandaloneMinimap.SlugFlag("OUTLINE, SLUG")) or "OUTLINE")
    ...
    function EUICoreStandaloneMinimap.UpdateDevModeIndicator()
        if not EUICoreStandaloneMinimap.IsDevModeActive() then
            if badge then
...
function EUICoreStandaloneMinimap:ShowModule(folderName)
    if InCombatLockdown() then
        EUICoreStandaloneMinimap.Print("|cffff6060[EUICoreStandaloneMinimap]|r Cannot open options during combat.")
        return
    end
    ...
    if self:_SplitFirstOpen(function() EUICoreStandaloneMinimap:ShowModule(folderName) end) then return end
    CreateMainFrame()
    RefreshSidebarStates()
    mainFrame:Show()
    ShowSidebarUnlockTip()
...
-------------------------------------------------------------------------------
do
    local ICON_PATH = "Interface\\AddOns\\EUIStandaloneMinimap\\media\\eg-logo.tga"
    ...
    local function GetAngle()
        ...
        currentAngle = (EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.minimapButtonAngle) or 220
        return currentAngle
    end

    local function SaveAngle()
        if not EUICoreStandaloneMinimapDB then EUICoreStandaloneMinimapDB = {} end
        EUICoreStandaloneMinimapDB.minimapButtonAngle = currentAngle
    end
    ...
    function EUICoreStandaloneMinimap.CreateMinimapButton()
        if btn then return btn end

        btn = CreateFrame("Button", "EUIStandaloneMinimapButton", Minimap)
        ...
        btn:SetScript("OnClick", function(_, button)
            if InCombatLockdown() then return end
            if button == "LeftButton" then
                if EUICoreStandaloneMinimap then EUICoreStandaloneMinimap:Toggle() end
            elseif button == "RightButton" then
                if EUICoreStandaloneMinimap then EUICoreStandaloneMinimap:EnsureUnlockCore() end
                if EUICoreStandaloneMinimap and EUICoreStandaloneMinimap._openUnlockMode then
                    EUICoreStandaloneMinimap._openUnlockMode()
                end
            elseif button == "MiddleButton" then
                if not EUICoreStandaloneMinimapDB then EUICoreStandaloneMinimapDB = {} end
                EUICoreStandaloneMinimapDB.showMinimapButton = false
                btn:Hide()
                local rl = EUICoreStandaloneMinimap and EUICoreStandaloneMinimap._widgetRefreshList
        ...
        btn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:AddLine("|cff0cd29fEUICoreStandaloneMinimap|r")
            GameTooltip:AddLine(EUICoreStandaloneMinimap.L("|cff0cd29dLeft-click:|r |cffE0E0E0Toggle EUICoreStandaloneMinimap|r"))
            GameTooltip:AddLine(EUICoreStandaloneMinimap.L("|cff0cd29dRight-click:|r |cffE0E0E0Enter Unlock Mode|r"))
            GameTooltip:AddLine(EUICoreStandaloneMinimap.L("|cff0cd29dMiddle-click:|r |cffE0E0E0Hide Minimap Button|r"))
            GameTooltip:Show()
        end)
        ...
        if EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.showMinimapButton == false then
            btn:Hide()
        else
            btn:Show()
        end

        _EUICoreStandaloneMinimap_MinimapRegistered = true
        return btn
    end

    function EUICoreStandaloneMinimap.ShowMinimapButton()
        if not btn then EUICoreStandaloneMinimap.CreateMinimapButton() end
        if btn then btn:Show() end
    end

    function EUICoreStandaloneMinimap.HideMinimapButton()
...
initFrame:SetScript("OnEvent", function(self, event)
    if event == "PLAYER_REGEN_DISABLED" then
        if mainFrame and mainFrame:IsShown() then
            EUICoreStandaloneMinimap:Hide()
            EUICoreStandaloneMinimap.Print("|cffff6060[EUICoreStandaloneMinimap]|r Options closed -- entering combat.")
        end
        return
    end
    ...
    EUICoreStandaloneMinimap.ApplyGlobalFontToGameText()
    ...
    EUICoreStandaloneMinimap.ApplyModuleFontFailsafe()

    ---------------------------------------------------------------------------
    --  Escape proxy: single UISpecialFrames entry for all EUI frames.
    --  Child addons call EUICoreStandaloneMinimap.RegisterEscapeClose(frame) to opt in.
    ---------------------------------------------------------------------------
    do
        local escFrames = {}
        local proxy = CreateFrame("Frame", "EUICoreStandaloneMinimap_EscapeProxy", UIParent)
        proxy:Hide()
        tinsert(UISpecialFrames, "EUICoreStandaloneMinimap_EscapeProxy")
        ...
        function EUICoreStandaloneMinimap.RegisterEscapeClose(frame)
    ...
    EUICoreStandaloneMinimap.CreateMinimapButton()

    -- Add EUICoreStandaloneMinimap + Unlock Mode buttons to the Game Menu (pause menu); both share a single Layout hook to avoid double-push conflicts.
    if GameMenuFrame and not EUICoreStandaloneMinimap._GetFFD(GameMenuFrame).euiBtn then
        -- Game menu frame+button skinning lives in EUICoreStandaloneMinimapBlizzardSkin.lua so it only
        -- applies when that addon is enabled; detect whether the skin is active so EUI's own buttons match the skinned menu style.
        local _blizzSkinLoaded = C_AddOns and C_AddOns.IsAddOnLoaded and C_AddOns.IsAddOnLoaded("EUICoreStandaloneMinimapBlizzardSkin")
        ...
        local _reskinMenu = _blizzSkinLoaded and (not EUICoreStandaloneMinimapDB or EUICoreStandaloneMinimapDB.reskinGameMenu ~= false)

        local btn = CreateFrame("Button", "EUICoreStandaloneMinimap_GameMenuButton", GameMenuFrame, "MainMenuFrameButtonTemplate")
        btn:SetSize(200, 35)
        btn:SetScript("OnClick", function()
            if InCombatLockdown() then
                EUICoreStandaloneMinimap.Print("|cffff6060[EUICoreStandaloneMinimap]|r Cannot open options during combat.")
        ...
        EUICoreStandaloneMinimap._GetFFD(GameMenuFrame).euiBtn = btn

        local unlockBtn = CreateFrame("Button", "EUICoreStandaloneMinimap_UnlockMenuButton", GameMenuFrame, "MainMenuFrameButtonTemplate")
        unlockBtn:SetSize(200, 35)
        unlockBtn:SetScript("OnClick", function()
            if InCombatLockdown() then
                EUICoreStandaloneMinimap.Print("|cffff6060[EUICoreStandaloneMinimap]|r Cannot toggle Unlock Mode during combat.")
                return
            end
            HideUIPanel(GameMenuFrame)
            if EUICoreStandaloneMinimap.ToggleUnlockMode then
                EUICoreStandaloneMinimap:ToggleUnlockMode()
            end
        end)
        EUICoreStandaloneMinimap._GetFFD(GameMenuFrame).unlockBtn = unlockBtn
        ...
        if _reskinMenu then
            for _, customBtn in ipairs({ btn, unlockBtn }) do
                ...
                cBg:SetAllPoints()
                local c=EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.popupMenuButtonBackgroundColor or {r=.1,g=.1,b=.1,a=.8}
                cBg:SetColorTexture(c.r,c.g,c.b,c.a == nil and .8 or c.a)
                EUICoreStandaloneMinimap._GetFFD(customBtn).gameMenuInset=inset
                EUICoreStandaloneMinimap._GetFFD(customBtn).gameMenuButtonBg=cBg
                if EUICoreStandaloneMinimap._applyBlizzardConfiguredBorder then EUICoreStandaloneMinimap._applyBlizzardConfiguredBorder(inset,"popupMenuButton",1) end
                local hl = customBtn:CreateTexture(nil, "HIGHLIGHT")
                hl:SetAllPoints(inset)
                hl:SetColorTexture(1, 1, 1, 0.1)
                local cfs = customBtn:GetFontString()
                if cfs then
                    local euiFont = EUICoreStandaloneMinimap.GetFontPath and EUICoreStandaloneMinimap.GetFontPath() or nil
                    ...
                    if EUICoreStandaloneMinimap._getPopupMenuElementMode
                       and EUICoreStandaloneMinimap._getPopupMenuElementMode() ~= "native"
                       and EUICoreStandaloneMinimap._getPopupMenuButtonTextColor then
                        local r,g,b=EUICoreStandaloneMinimap._getPopupMenuButtonTextColor()
        ...
        hooksecurefunc(GameMenuFrame, "Layout", function()
            ...
            if _reskinMenu then
                ...
                if header then
                    ...
                    if headerText and headerText.SetTextColor then
                        if EUICoreStandaloneMinimap._getPopupMenuButtonTextColor then
                            local r,g,b=EUICoreStandaloneMinimap._getPopupMenuButtonTextColor()
            ...
            local showEUI = not (EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.hideGameMenuButton)
            local showUnlock = EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.hideUnlockMenuButton == false
            ...
            local euiFont = EUICoreStandaloneMinimap.GetFontPath and EUICoreStandaloneMinimap.GetFontPath() or "Fonts\\FRIZQT__.TTF"
            ...
            local elemMode = EUICoreStandaloneMinimap._getPopupMenuElementMode
                and EUICoreStandaloneMinimap._getPopupMenuElementMode() or "native"
            local brandHex
            if elemMode == "native" then
                local EG = EUICoreStandaloneMinimap.ELLESMERE_GREEN or { r = .27, g = .86, b = .49 }
            ...
            if showEUI then
                ...
                if brandHex then
                    ...
                    btn:SetText("EUICoreStandaloneMinimap")
                end
                if _reskinMenu then
                    local fs = btn:GetFontString()
                    if fs then fs:SetFont(euiFont, btnFontSize, ""); if not brandHex and EUICoreStandaloneMinimap._getPopupMenuButtonTextColor then local r,g,b=EUICoreStandaloneMinimap._getPopupMenuButtonTextColor(); fs:SetTextColor(r,g,b,1) end end
                end
                btn:ClearAllPoints()
            ...
            if showUnlock then
                ...
                if _reskinMenu then
                    ...
                    if fs2 then fs2:SetFont(euiFont, btnFontSize, ""); if not brandHex and EUICoreStandaloneMinimap._getPopupMenuButtonTextColor then local r,g,b=EUICoreStandaloneMinimap._getPopupMenuButtonTextColor(); fs2:SetTextColor(r,g,b,1) end end
                end
    ...
    if EUICoreStandaloneMinimapDB then
        local theme = EUICoreStandaloneMinimapDB.activeTheme or "EUICoreStandaloneMinimap"
        ...
        if EUICoreStandaloneMinimap._applyBgTint then
            EUICoreStandaloneMinimap._applyBgTint(themeR, themeG, themeB)
        end
        ...
        local accentR, accentG, accentB = EUICoreStandaloneMinimap.ResolveActiveAccent()
        if EUICoreStandaloneMinimap.ApplyAccentColorLive then
            EUICoreStandaloneMinimap.ApplyAccentColorLive(accentR, accentG, accentB)
        else
    ...
    if TooltipDataProcessor and TooltipDataProcessor.AddTooltipPostCall then
        ...
        local function IsSpellIDModifierHeld()
            local mod = (EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.spellIDModifier) or "none"
        ...
        local function IsItemStackModifierHeld()
            local mod = (EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.itemStackModifier) or "none"
            if mod == "none" then return true end
            if mod == "control" then return IsControlKeyDown() end
            if mod == "alt" then return IsAltKeyDown() end
            return IsShiftKeyDown()
        ...
        function EUICoreStandaloneMinimap.SyncAuraSpellIDCVar()
            local db = EUICoreStandaloneMinimapDB
        ...
        do
            ...
            cvarBoot:SetScript("OnEvent", function()
                EUICoreStandaloneMinimap.SyncAuraSpellIDCVar()
            end)
        end

        local function SpellIDTooltipHook(tooltip, data)
            if not (EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.showSpellID) then return end
            ...
            if Enum.TooltipDataType
                ...
                and (EUICoreStandaloneMinimapDB.spellIDModifier or "none") == "none" then
                return
            end
            ...
            if EUICoreStandaloneMinimapDB.showIconID ~= false then
        ...
        local function ItemIDTooltipHook(tooltip, data)
            ...
            local showItem = EUICoreStandaloneMinimapDB.showItemID ~= false
            local showIcon = EUICoreStandaloneMinimapDB.showIconID ~= false
        ...
        local function ItemIdMaxStackHook(tooltip, data)
            if not (EUICoreStandaloneMinimapDB and EUICoreStandaloneMinimapDB.showItemMaxStacks) then return end
    ...
    if Settings and Settings.RegisterCanvasLayoutCategory then
        ...
        panel.name = "EUICoreStandaloneMinimap"
        local btn = CreateFrame("Button", nil, panel, "UIPanelButtonTemplate")
        btn:SetSize(200, 30)
        btn:SetPoint("CENTER", panel, "CENTER", 0, 0)
        btn:SetText("Open EUICoreStandaloneMinimap")
        btn:SetScript("OnClick", function()
            if InCombatLockdown() then
                EUICoreStandaloneMinimap.Print("|cffff6060[EUICoreStandaloneMinimap]|r Cannot open options during combat.")
                return
            ...
            C_Timer.After(0, function()
                if EUICoreStandaloneMinimap then EUICoreStandaloneMinimap:Show() end
            end)
        end)
        local category = Settings.RegisterCanvasLayoutCategory(panel, "EUICoreStandaloneMinimap")
    ...
    for _, cfg in ipairs(demoConfigs) do
        if IsAddonLoaded(cfg.folder) and not modules[cfg.folder] then
            ...
            EUICoreStandaloneMinimap:RegisterModule(cfg.folder, {
                title       = cfg.title,
                description = cfg.desc,
                pages       = cfg.pages,
                buildPage   = function(pageName, parent, yOffset)
                    local W = EUICoreStandaloneMinimap.Widgets
                    local y = yOffset
                    local _, h
                ...
                onReset = function()
                    ...
                    dS[k] = { size = 36, font = 14, opacity = 80, spacing = 4, scale = 100, thickness = 2 }
                    dD[k] = { effect = "pulse", position = "center", style = "modern" }
                    EUICoreStandaloneMinimap:SelectPage(activePage)
                end,
            })
        end
    end
...
EUICoreStandaloneMinimap.VIS_VALUES = {
    never      = "Never",
    always     = "Always",
    mouseover  = "Mouseover",
    in_combat      = "In Combat",
...
EUICoreStandaloneMinimap.VIS_ORDER = { "never", "always", "mouseover", "in_combat", "out_of_combat", "---", "in_raid", "in_party", "solo" }
...
-- transition in real time. Lua-side modules catch the same transition via the gliding edge events registered in EUICoreStandaloneMinimap_Visibility.lua (gated on EUICoreStandaloneMinimap._hasGlidingEvent).
EUICoreStandaloneMinimap.VIS_VALUES_AB = {
    never      = "Never",
    always     = "Always",
    mouseover  = "Mouseover",
    in_combat      = "In Combat",
...
EUICoreStandaloneMinimap.VIS_ORDER_AB = { "never", "always", "mouseover", "in_combat", "out_of_combat", "show_dragonriding", "show_not_dragonriding", "---", "in_raid", "in_party", "solo" }

-- CDM variant (no mouseover -- CDM bars don't support mouseover visibility)
EUICoreStandaloneMinimap.VIS_VALUES_CDM = {
    never          = "Never",
    always         = "Always",
    in_combat      = "In Combat",
    out_of_combat  = "Out of Combat",
...
EUICoreStandaloneMinimap.VIS_ORDER_CDM = { "never", "always", "in_combat", "out_of_combat", "---", "in_raid", "in_party", "solo" }
...
EUICoreStandaloneMinimap.VIS_OPT_ITEMS = {
...
EUICoreStandaloneMinimap.VIS_OPT_ITEMS_RESOURCE_BARS = {}
for _, item in ipairs(EUICoreStandaloneMinimap.VIS_OPT_ITEMS) do
    EUICoreStandaloneMinimap.VIS_OPT_ITEMS_RESOURCE_BARS[#EUICoreStandaloneMinimap.VIS_OPT_ITEMS_RESOURCE_BARS + 1] = item
    if item.key == "visHideMounted" then
        EUICoreStandaloneMinimap.VIS_OPT_ITEMS_RESOURCE_BARS[#EUICoreStandaloneMinimap.VIS_OPT_ITEMS_RESOURCE_BARS + 1] = {
...
function EUICoreStandaloneMinimap.IsPlayerMountedLike()
...
function EUICoreStandaloneMinimap.IsPlayerSkyriding()
...
function EUICoreStandaloneMinimap.CheckVisibilityOptionsNonMacro(opts)
    ...
    if opts.visHideMounted then
        if EUICoreStandaloneMinimap.IsPlayerMountedLike and EUICoreStandaloneMinimap.IsPlayerMountedLike() then return true end
    end
    ...
    if opts.visOnlyMounted then
        if not (EUICoreStandaloneMinimap.IsPlayerMountedLike and EUICoreStandaloneMinimap.IsPlayerMountedLike()) then return true end
    end

    if opts.visHideDragonriding then
        if EUICoreStandaloneMinimap.IsPlayerSkyriding and EUICoreStandaloneMinimap.IsPlayerSkyriding() then return true end
    end

    return false
end

function EUICoreStandaloneMinimap.CheckVisibilityOptions(opts)
    if not opts then return false end

    -- Instances / housing / mounted (shared with secure-frame fast path).
    if EUICoreStandaloneMinimap.CheckVisibilityOptionsNonMacro(opts) then return true end
...
function EUICoreStandaloneMinimap.CheckVisibilityMode(mode, state)
    ...
    if mode == "show_dragonriding" then
        ...
        -- EUICoreStandaloneMinimap_Visibility.lua and is also used by the multi-select visibility engine.
        return (EUICoreStandaloneMinimap.IsAirborneSkyriding and EUICoreStandaloneMinimap.IsAirborneSkyriding()) or false
    end
    if mode == "show_not_dragonriding" then
        ...
        return not (EUICoreStandaloneMinimap.IsAirborneSkyriding and EUICoreStandaloneMinimap.IsAirborneSkyriding())
    end
...
--  frames). Stored on EUICoreStandaloneMinimap to avoid the 200-local cap in this file.
-------------------------------------------------------------------------------
EUICoreStandaloneMinimap._FFD = EUICoreStandaloneMinimap._FFD or setmetatable({}, { __mode = "k" })
function EUICoreStandaloneMinimap._GetFFD(frame)
    local d = EUICoreStandaloneMinimap._FFD[frame]
    if not d then d = {}; EUICoreStandaloneMinimap._FFD[frame] = d end
    return d
end

-------------------------------------------------------------------------------
--  Third-Party Skin Registration (public API) -- other addons call
--  EUICoreStandaloneMinimap.RegisterSkin("TheirAddon", function(S) ... end) to have their frames painted in
...
--  disabled. Developer guide: SKINNING_API.md. Stored on EUICoreStandaloneMinimap to avoid the 200-local cap.
-------------------------------------------------------------------------------
EUICoreStandaloneMinimap._skinRegistry = EUICoreStandaloneMinimap._skinRegistry or {}
function EUICoreStandaloneMinimap.RegisterSkin(name, applyFn)
    if type(name) ~= "string" or name == "" or type(applyFn) ~= "function" then return end
    local reg = EUICoreStandaloneMinimap._skinRegistry
    for i = 1, #reg do
        if reg[i].name == name then return end
    end
    local entry = { name = name, apply = applyFn }
    reg[#reg + 1] = entry
    if EUICoreStandaloneMinimap._DispatchSkinRegistration then
        EUICoreStandaloneMinimap._DispatchSkinRegistration(entry)
    end
    return true
end
...
-------------------------------------------------------------------------------
function EUICoreStandaloneMinimap.SetElementVisibility(frame, visible)
    if not frame then return end
    if visible then
        frame:SetAlpha(EUICoreStandaloneMinimap._GetFFD(frame).restoreAlpha or 1)
        frame:EnableMouse(EUICoreStandaloneMinimap._GetFFD(frame).restoreMouse or false)
    else
        if frame:GetAlpha() > 0 then
            EUICoreStandaloneMinimap._GetFFD(frame).restoreAlpha = frame:GetAlpha()
        end
        EUICoreStandaloneMinimap._GetFFD(frame).restoreMouse = frame:IsMouseEnabled()
        frame:SetAlpha(0)
...
-------------------------------------------------------------------------------
function EUICoreStandaloneMinimap._BlizzCastBars()
    local bars = EUICoreStandaloneMinimap._blizzCastBarList
    ...
    EUICoreStandaloneMinimap._blizzCastBarList = bars
    ...
    for i = 1, #bars do
        ...
        hooksecurefunc(bar.frame, "UnregisterAllEvents", function()
            if not EUICoreStandaloneMinimap._blizzCastBarSnapshot then
                bar.owned = false
                bar.foreign = true
            end
        end)
...
function EUICoreStandaloneMinimap.CaptureBlizzCastBarEvents()
    local bars = EUICoreStandaloneMinimap._BlizzCastBars()
    local snapshot = {}
    for i = 1, #bars do
        snapshot[i] = bars[i].frame:IsEventRegistered("UNIT_SPELLCAST_START") and true or false
    end
    EUICoreStandaloneMinimap._blizzCastBarSnapshot = snapshot
end

function EUICoreStandaloneMinimap.RestoreBlizzCastBarEvents()
    local snapshot = EUICoreStandaloneMinimap._blizzCastBarSnapshot
    if not snapshot then return end
    EUICoreStandaloneMinimap._blizzCastBarSnapshot = nil
...
function EUICoreStandaloneMinimap.RearmBlizzCastBars()
    local bars = EUICoreStandaloneMinimap._blizzCastBarList
...
if PlayerCastingBarFrame and PetCastingBarFrame then
    EUICoreStandaloneMinimap._BlizzCastBars()
end
...
-------------------------------------------------------------------------------
function EUICoreStandaloneMinimap.SetPlayerCastBarSuppressed(owner, suppressed)
    if not owner or owner == "" then return end

    local owners = EUICoreStandaloneMinimap._playerCastBarSuppressors
    if not owners then
        owners = {}
        EUICoreStandaloneMinimap._playerCastBarSuppressors = owners
    end
    ...
    local hiddenParent = EUICoreStandaloneMinimap._playerCastBarHiddenParent

    if shouldSuppress then
        if not hiddenParent then
            hiddenParent = CreateFrame("Frame")
            hiddenParent:Hide()
            EUICoreStandaloneMinimap._playerCastBarHiddenParent = hiddenParent
        end

        if blizzBar:GetParent() ~= hiddenParent then
            EUICoreStandaloneMinimap._GetFFD(blizzBar).origParent = blizzBar:GetParent()
        end
        EUICoreStandaloneMinimap._GetFFD(blizzBar).castBarSuppressed = true
        ...
        if not EUICoreStandaloneMinimap._GetFFD(blizzBar).setParentHooked then
            EUICoreStandaloneMinimap._GetFFD(blizzBar).setParentHooked = true
            hooksecurefunc(blizzBar, "SetParent", function(self, newParent)
                if EUICoreStandaloneMinimap._GetFFD(self).castBarSuppressed and newParent ~= EUICoreStandaloneMinimap._playerCastBarHiddenParent then
                    C_Timer.After(0, function()
                        ...
                        if EUICoreStandaloneMinimap._GetFFD(self).castBarSuppressed
                           and not InCombatLockdown()
                           and not (EditModeManagerFrame and EditModeManagerFrame:IsShown())
                           and self:GetParent() ~= EUICoreStandaloneMinimap._playerCastBarHiddenParent
                        then
                            self:SetParent(EUICoreStandaloneMinimap._playerCastBarHiddenParent)
                        end
                    end)
                end
            end)
        ...
        if selection then
            if not EUICoreStandaloneMinimap._GetFFD(selection).suppressed then
                EUICoreStandaloneMinimap._GetFFD(selection).restoreAlpha = selection:GetAlpha()
                EUICoreStandaloneMinimap._GetFFD(selection).restoreMouse = selection:IsMouseEnabled()
            end
            EUICoreStandaloneMinimap._GetFFD(selection).suppressed = true
            selection:SetAlpha(0)
            selection:EnableMouse(false)

            if not EUICoreStandaloneMinimap._GetFFD(selection).showHooked then
                EUICoreStandaloneMinimap._GetFFD(selection).showHooked = true
                hooksecurefunc(selection, "Show", function(self)
                    ...
                    C_Timer.After(0, function()
                        if PlayerCastingBarFrame and EUICoreStandaloneMinimap._GetFFD(PlayerCastingBarFrame).castBarSuppressed then
                            self:SetAlpha(0)
    ...
    EUICoreStandaloneMinimap._GetFFD(blizzBar).castBarSuppressed = false
    ...
    local origParent = EUICoreStandaloneMinimap._GetFFD(blizzBar).origParent
    ...
    local selection = blizzBar.Selection
    if selection and EUICoreStandaloneMinimap._GetFFD(selection).suppressed then
        EUICoreStandaloneMinimap._GetFFD(selection).suppressed = false
        selection:SetAlpha(EUICoreStandaloneMinimap._GetFFD(selection).restoreAlpha or 1)
        selection:EnableMouse(EUICoreStandaloneMinimap._GetFFD(selection).restoreMouse or false)
    end
    ...
    EUICoreStandaloneMinimap.RearmBlizzCastBars()
end
...
do
    ...
    local function isEnabled()
        return not EUICoreStandaloneMinimapDB or EUICoreStandaloneMinimapDB.brightenSwiftmend ~= false
    end
    function EUICoreStandaloneMinimap._HookSwiftmendIcon(tex)
    ...
    EUICoreStandaloneMinimap._SWIFTMEND_SPELL = 18562
    EUICoreStandaloneMinimap._SWIFTMEND_ICON  = 134914
end
