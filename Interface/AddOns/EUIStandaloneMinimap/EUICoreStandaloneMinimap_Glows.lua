...
-------------------------------------------------------------------------------
--  EUICoreStandaloneMinimap_Glows.lua
--  Shared glow rendering engine for the EUICoreStandaloneMinimap addon suite.
...
--  Each addon attaches to EUICoreStandaloneMinimap.Glows.* instead of duplicating engines.
-------------------------------------------------------------------------------
if not EUICoreStandaloneMinimap then return end
if EUICoreStandaloneMinimap.Glows then return end  -- already loaded by another addon
...
-------------------------------------------------------------------------------
local DASH_H = [[Interface\AddOns\EUIStandaloneMinimap\media\glow-dash-h.tga]]
local DASH_V = [[Interface\AddOns\EUIStandaloneMinimap\media\glow-dash-v.tga]]
...
-------------------------------------------------------------------------------
--  Public API — attached to EUICoreStandaloneMinimap.Glows
-------------------------------------------------------------------------------
...
EUICoreStandaloneMinimap.Glows = {
    STYLES              = GLOW_STYLES,
