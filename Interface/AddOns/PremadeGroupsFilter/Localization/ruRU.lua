...
L["settings.compactListEntries.tooltip"] = "Скрывает стиль игры, чтобы записи в списке групп занимали меньше места по высоте (как до предэкспансионного обновления контента Midnight)."
