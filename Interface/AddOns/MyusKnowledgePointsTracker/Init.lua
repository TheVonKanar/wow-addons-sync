  ...
  db = {
    ...
    [Enum.ExpansionLevel.WarWithin] = {
      ...
      [2871] = MKPT_Profession:New(2871, 423321, 3057, { map = 2339, x = 0.4707, y = 0.7054 })
          ...
          -- Catch up mechanic
          :AddEntry(MKPT_PatronCatchUp:New({ questId = {}, itemId = 228724, atlasIcon = "Professions-Crafting-Orders-Icon", kp = 1, text = PROFESSIONS_CRAFTING_ORDERS_PAGE_NAME:format(PROFESSIONS_CRAFTER_ORDER_TAB_NPC) })
      ...
      [2872] = MKPT_Profession:New(2872, 423332, 3058, { map = 2339, x = 0.4917, y = 0.6363 })
          ...
          -- Catch up mechanic
          :AddEntry(MKPT_PatronCatchUp:New({ questId = {}, itemId = 228726, atlasIcon = "Professions-Crafting-Orders-Icon", kp = 1, text = PROFESSIONS_CRAFTING_ORDERS_PAGE_NAME:format(PROFESSIONS_CRAFTER_ORDER_TAB_NPC) })
      ...
      [2875] = MKPT_Profession:New(2875, 423335, 3060, { map = 2339, x = 0.4923, y = 0.5594 })
          ...
          -- Catch up mechanic
          :AddEntry(MKPT_PatronCatchUp:New({ questId = {}, itemId = 228730, atlasIcon = "Professions-Crafting-Orders-Icon", kp = 1, text = PROFESSIONS_CRAFTING_ORDERS_PAGE_NAME:format(PROFESSIONS_CRAFTER_ORDER_TAB_NPC) })
      ...
      [2878] = MKPT_Profession:New(2878, 423338, 3062, { map = 2339, x = 0.4881, y = 0.7092 })
          ...
          -- Catch up mechanic
          :AddEntry(MKPT_PatronCatchUp:New({ questId = {}, itemId = 228732, atlasIcon = "Professions-Crafting-Orders-Icon", kp = 1, text = PROFESSIONS_CRAFTING_ORDERS_PAGE_NAME:format(PROFESSIONS_CRAFTER_ORDER_TAB_NPC) })
      ...
      [2879] = MKPT_Profession:New(2879, 423339, 3063, { map = 2339, x = 0.4947, y = 0.7081 })
          ...
          -- Catch up mechanic
          :AddEntry(MKPT_PatronCatchUp:New({ questId = {}, itemId = 228734, atlasIcon = "Professions-Crafting-Orders-Icon", kp = 1, text = PROFESSIONS_CRAFTING_ORDERS_PAGE_NAME:format(PROFESSIONS_CRAFTER_ORDER_TAB_NPC) })
      ...
      [2880] = MKPT_Profession:New(2880, 423340, 3064, { map = 2339, x = 0.5431, y = 0.5844 })
          ...
          -- Catch up mechanic
          :AddEntry(MKPT_PatronCatchUp:New({ questId = {}, itemId = 228736, atlasIcon = "Professions-Crafting-Orders-Icon", kp = 1, text = PROFESSIONS_CRAFTING_ORDERS_PAGE_NAME:format(PROFESSIONS_CRAFTER_ORDER_TAB_NPC) })
      ...
      [2881] = MKPT_Profession:New(2881, 423341, 3065, { map = 2339, x = 0.5303, y = 0.5280 })
          ...
          -- Catch up mechanic
          :AddEntry(MKPT_CatchUp:New({ questId = {}, itemId = 224838, catchUpCurrencyId = 3065, atlasIcon = "Professions_Tracking_Ore", kp = 1, text = "Randomly looted while mining" })
      ...
      [2883] = MKPT_Profession:New(2883, 423343, 3067, { map = 2339, x = 0.5468, y = 0.6371 })
          ...
          -- Catch up mechanic
          :AddEntry(MKPT_PatronCatchUp:New({ questId = {}, itemId = 228738, atlasIcon = "Professions-Crafting-Orders-Icon", kp = 1, text = PROFESSIONS_CRAFTING_ORDERS_PAGE_NAME:format(PROFESSIONS_CRAFTER_ORDER_TAB_NPC) })
    ...
    [Enum.ExpansionLevel.Midnight] = {
      ...
      [2907] = MKPT_Profession:New(2907, 471004, 3199, { map = 2393, x = 0.4365, y = 0.5177 })
          ...
          :AddEntry(MKPT_DarkmoonQuest:New { questId = { 29508 }, waypoint = { map = 407, x = 0.5110, y = 0.8204 }, kp = 3 })
          -- Catch up mechanic
          :AddEntry(MKPT_PatronCatchUp:New({ questId = {}, itemId = 246322, atlasIcon = "Professions-Crafting-Orders-Icon", kp = 1, text = PROFESSIONS_CRAFTING_ORDERS_PAGE_NAME:format(PROFESSIONS_CRAFTER_ORDER_TAB_NPC) })
      ...
      [2909] = MKPT_Profession:New(2909, 471006, 3198, { map = 2393, x = 0.4800, y = 0.5385 })
          ...
          :AddEntry(MKPT_CatchUp:New({ questId = {}, itemId = 267653, catchUpCurrencyId = 3059, atlasIcon = "lootroll-toast-icon-disenchant-up", text = "Looted from disenchanting", kp = 1 })
      ...
      [2910] = MKPT_Profession:New(2910, 471007, 3197, { map = 2393, x = 0.4352, y = 0.5410 })
          ...
          :AddEntry(MKPT_Treatise:New({ questId = { 95138 }, itemId = 245809, waypoint = { map = 2393, x = 0.4502, y = 0.5560 }, kp = 1, spell = 1282302, atlasIcon = "Professions-Crafting-Orders-Icon", text = "Inscription work order" })
          ...
          :AddEntry(MKPT_PatronCatchUp:New({ questId = {}, itemId = 246326, atlasIcon = "Professions-Crafting-Orders-Icon", kp = 1, text = PROFESSIONS_CRAFTING_ORDERS_PAGE_NAME:format(PROFESSIONS_CRAFTER_ORDER_TAB_NPC) })
      ...
      [2912] = MKPT_Profession:New(2912, 471009, 3196, { map = 2393, x = 0.4830, y = 0.5142 })
          ...
          :AddEntry(MKPT_CatchUp:New({ questId = {}, itemId = 238467, catchUpCurrencyId = 3198, atlasIcon = "Professions_Tracking_Herb", kp = 1, text = "Randomly looted while gathering herbs" })
      ...
      [2913] = MKPT_Profession:New(2913, 471010, 3195, { map = 2393, x = 0.4691, y = 0.5161 })
          ...
          :AddEntry(MKPT_PatronCatchUp:New({ questId = {}, itemId = 246328, atlasIcon = "Professions-Crafting-Orders-Icon", kp = 1, text = PROFESSIONS_CRAFTING_ORDERS_PAGE_NAME:format(PROFESSIONS_CRAFTER_ORDER_TAB_NPC) })
      ...
      [2914] = MKPT_Profession:New(2914, 471011, 3194, { map = 2393, x = 0.4818, y = 0.5509 })
          ...
          :AddEntry(MKPT_PatronCatchUp:New({ questId = {}, itemId = 246330, atlasIcon = "Professions-Crafting-Orders-Icon", kp = 1, text = PROFESSIONS_CRAFTING_ORDERS_PAGE_NAME:format(PROFESSIONS_CRAFTER_ORDER_TAB_NPC) })
      ...
      [2915] = MKPT_Profession:New(2915, 471012, 3193, { map = 2393, x = 0.4314, y = 0.5576 })
          ...
          :AddEntry(MKPT_PatronCatchUp:New({ questId = {}, itemId = 246332, atlasIcon = "Professions-Crafting-Orders-Icon", kp = 1, text = PROFESSIONS_CRAFTING_ORDERS_PAGE_NAME:format(PROFESSIONS_CRAFTER_ORDER_TAB_NPC) })
      ...
      [2918] = MKPT_Profession:New(2918, 471015, 3190, { map = 2393, x = 0.4820, y = 0.5399 })
          ...
          :AddEntry(MKPT_PatronCatchUp:New({ questId = {}, itemId = 246334, atlasIcon = "Professions-Crafting-Orders-Icon", kp = 1, text = PROFESSIONS_CRAFTING_ORDERS_PAGE_NAME:format(PROFESSIONS_CRAFTER_ORDER_TAB_NPC) })
