...
LRPMIB.ClassColors = {
	WARRIOR 		= CreateColor(0.78, 0.61, 0.43, 1),
	PALADIN 		= CreateColor(0.96, 0.55, 0.73, 1),
	HUNTER 			= CreateColor(0.67, 0.83, 0.45, 1),
	ROGUE 			= CreateColor(1.00, 0.96, 0.41, 1),
	PRIEST 			= CreateColor(1.00, 1.00, 1.00, 1),
	DEATHKNIGHT 	= CreateColor(0.77, 0.12, 0.23, 1),
	SHAMAN 			= CreateColor(0.00, 0.44, 0.87, 1),
	MAGE 			= CreateColor(0.25, 0.78, 0.92, 1),
	WARLOCK 		= CreateColor(0.53, 0.53, 0.93, 1),
	MONK 			= CreateColor(0.00, 1.00, 0.60, 1),
	DRUID 			= CreateColor(1.00, 0.49, 0.04, 1),
	DEMONHUNTER 	= CreateColor(0.64, 0.19, 0.79, 1),
	EVOKER 			= CreateColor(0.20, 0.58, 0.50, 1),
};
...
LRPMIB.IconBrowserConstants = IconBrowserConstants;