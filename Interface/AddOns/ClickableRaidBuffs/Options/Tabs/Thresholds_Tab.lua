...
O.RegisterSection(function(AddSection)
  AddSection(L["Thresholds"], function(content, Row)
    local d = DB()
    ...
    AddNumSelectHalf(rowA, "LEFT", "spellThreshold", L["Castable Buffs (Minutes)"], 0, 120, 0.5, 15)

    AddNumSelectHalf(rowA, "RIGHT", "itemThreshold", L["Item Buffs (Minutes)"], 0, 120, 0.5, 15)


    local rowB = Row(KNOB.ROW_H_TOP)
    AddNumSelectHalf(rowB, "LEFT", "durabilityThreshold", L["Durability (%)"], 0, 100, 1, 25)

    AddNumSelectHalf(rowB, "RIGHT", "healthstoneThreshold", L["Healthstone (Charges)"], 0, 3, 1, 1)


    local rowC = Row(KNOB.ROW_H_TOP)
    AddNumSelectHalf(rowC, "LEFT", "soulstoneThreshold", L["Soulstone (Minutes)"], 0, 120, 0.5, 5)
