...
-- ================== NotoSans CJK (Locale Locked) ==================

local locale = GetLocale()

-- ================== Japanese ==================
if locale == "jaJP" then
  LSM:Register("font", "NotoSansJP-Regular", base .. "\\Noto_Sans_JP\\NotoSansJP-Regular.ttf")
  LSM:Register("font", "NotoSansJP-Bold",    base .. "\\Noto_Sans_JP\\NotoSansJP-Bold.ttf")
end

-- ================== Korean ==================
if locale == "koKR" then
  LSM:Register("font", "NotoSansKR-Regular", base .. "\\Noto_Sans_KR\\NotoSansKR-Regular.ttf")
  LSM:Register("font", "NotoSansKR-Bold",    base .. "\\Noto_Sans_KR\\NotoSansKR-Bold.ttf")
end

-- ================== Simplified Chinese ==================
if locale == "zhCN" then
  LSM:Register("font", "NotoSansSC-Regular", base .. "\\Noto_Sans_SC\\NotoSansSC-Regular.ttf")
  LSM:Register("font", "NotoSansSC-Bold",    base .. "\\Noto_Sans_SC\\NotoSansSC-Bold.ttf")
end

-- ================== Traditional Chinese ==================
if locale == "zhTW" then
  LSM:Register("font", "NotoSansTC-Regular", base .. "\\Noto_Sans_TC\\NotoSansTC-Regular.ttf")
  LSM:Register("font", "NotoSansTC-Bold",    base .. "\\Noto_Sans_TC\\NotoSansTC-Bold.ttf")
end
