...
--- @class TLMModule_Leveling: AceModule, AceHook-3.0, NumyAceEvent-3.0, AceConsole-3.0
local Module = TLM:NewModule("Leveling", "AceHook-3.0", "NumyAceEvent-3.0", "AceConsole-3.0");
