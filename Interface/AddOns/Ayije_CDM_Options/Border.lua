...
local function CreateBorderTab(page, tabId)
    ...
    local colorPicker = UI.CreateColorSwatch(page, L["Border Color"], "borderColor", "STYLE")
    colorPicker:SetPoint("TOPLEFT", ddBorder, "BOTTOMLEFT", 0, -15)
    page.colorPicker = colorPicker

    page.controls.b0 = UI.CreateModernSlider(page, L["Border Size"], 1, 50, CDM.db.borderSize, function(v) CDM.db.borderSize = v; API:Refresh("STYLE") end)
    page.controls.b0:SetPoint("TOPLEFT", colorPicker, "BOTTOMLEFT", 0, -10)

    page.controls.b1 = UI.CreateModernSlider(page, L["Border Offset X"], -50, 50, CDM.db.borderOffsetX, function(v) CDM.db.borderOffsetX = v; API:Refresh("STYLE") end)
    page.controls.b1:SetPoint("TOPLEFT", page.controls.b0, "BOTTOMLEFT", 0, -10)

    page.controls.b2 = UI.CreateModernSlider(page, L["Border Offset Y"], -50, 50, CDM.db.borderOffsetY, function(v) CDM.db.borderOffsetY = v; API:Refresh("STYLE") end)
