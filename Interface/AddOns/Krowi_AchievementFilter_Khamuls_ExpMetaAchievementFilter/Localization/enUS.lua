...
L["Show List for Achievements with toys as reward"] = "Show collection for achievements with toys as reward"
L["If enabled, a list with all achievements, which have a toy as reward, will be shown"] = "If enabled, a collection with all achievements, which have a toy as reward, will be shown"
...
L["Toy Collection Settings"] = "Toy Collection Settings"
