...
function CCS:inspect()
 ...
 --------------------------
    ...
    CCS_ic:SetBackdropBorderColor(0.3, 0.1, 0.4, 1) -- purple border
    ...
    closeBtn:SetScale(.5)
    closeBtn:SetPoint("TOPRIGHT", CCS_ic, "TOPRIGHT", -3, -3)
    closeBtn:Show()
    CCS_ic:Hide()
    CCS_ic:Show()
...
local function initmplusframe()
    ...
    local btnfont1 = _G["InspectMPlusfs1"] or InspectFrame:CreateFontString("InspectMPlusfs1")
...
local function initializeinspectframe()
    ...
    InspectFrameCloseButton:SetPoint("TOPRIGHT", InspectFrameBg, "TOPRIGHT", -5, 0)
