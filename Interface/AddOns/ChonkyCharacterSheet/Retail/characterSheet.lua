...
function CCS.HookSetup()
    ...
    hooksecurefunc(TokenFrame, "Show", function() hookfix(); end)
    ...
    if not PaperDollSidebarTab3._ccsHooked then
        ...
        PaperDollSidebarTab3:HookScript("OnClick", function(self, button)
            ...
            PaperDollFrame.EquipmentManagerPane:SetPoint("TOPLEFT", CharacterFrameInsetRight, "TOPLEFT", 9, -4)
...
function module:Initialize()
    ...
    charbg:SetBackdropBorderColor(0.4, .1, 0.6, .6)   -- purple border    
    ...
    CharacterFrameCloseButton:SetPoint("TOPRIGHT", CharacterFrameBg, "TOPRIGHT", -5, -5)
    CharacterFrameCloseButton:SetSize(32, 32)
    CharacterFrameCloseButton:SetScale(.5)
    ...
    if (option("hideiconborders")) then
        ...
        CharacterFrameTab1.Text:SetTextColor(1, .7, 1, 1)
        CharacterFrameTab2.Text:SetTextColor(1, .7, 1, 1)
        CharacterFrameTab3.Text:SetTextColor(1, .7, 1, 1)
    ...
    ReputationFrame.ScrollBox:SetPoint("BOTTOMRIGHT", CharacterFrameBg, "BOTTOMRIGHT", -30, 0)
