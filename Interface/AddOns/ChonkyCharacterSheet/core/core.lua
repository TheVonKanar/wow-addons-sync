...
function CCS:tree()
    ...
    gemButton:SetScript("OnEnter", function()
        --CCS.RenderSafeTooltip(CCStt, "item:213455") -- Gem
        --CCS.RenderSafeTooltip(CCStt, "item:213743")
        --CCS.RenderSafeTooltip(CCStt, "item:237620") -- Hands
