...
function TBCinitializeinspectframe()
    ...
    inspectbg:SetBackdropBorderColor(0.4, .1, 0.6, .6)   -- purple border    
...
-------------------------
    ...
    SkillListScrollFrame:SetBackdropBorderColor(0.4, .1, 0.6, .6)   -- purple border
    ...
    SkillDetailScrollFrame:SetBackdropBorderColor(0.4, .1, 0.6, .6)   -- purple border
