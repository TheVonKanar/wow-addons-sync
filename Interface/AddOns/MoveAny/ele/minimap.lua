...
function MoveAny:InitMinimap()
	...
	if MinimapToggleButton then MinimapToggleButton:SetParent(MoveAny:GetHidden()) end
	if MinimapBorderTop then MinimapBorderTop:SetParent(MoveAny:GetHidden()) end
