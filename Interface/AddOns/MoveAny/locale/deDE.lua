...
MoveAny:AddTrans("deDE", "LID_CATACTIONBARS", "Aktionsleisten")
MoveAny:AddTrans("deDE", "LID_CATCHAT", "Chat")
MoveAny:AddTrans("deDE", "LID_CATPARTYRAID", "Gruppe / Schlachtzug")
MoveAny:AddTrans("deDE", "LID_CATQUEST", "Quest")
MoveAny:AddTrans("deDE", "LID_CATWIDGETS", "Widgets")
...
MoveAny:AddTrans("deDE", "LID_ENCOUNTERBAR", "Begegnungsleiste (Zeigt meist Prozente an) (Bossleiste, Elanleiste, Dunkelmond-Jahrmarkt, ...)")
...
MoveAny:AddTrans("deDE", "LID_EssentialCooldownViewer", "Essenzielle Abklingzeit Betrachter (Abklingzeitmanager)")
MoveAny:AddTrans("deDE", "LID_EventToastManagerFrame", "EventToastManagerFrame (Stufenaufstieg, Neue Fähigkeit, Zonentext)")
...
MoveAny:AddTrans("deDE", "LID_FRAMESKEYDRAG", "Fenster mit %s + Linke-Maustaste-ziehen bewegen")
MoveAny:AddTrans("deDE", "LID_FRAMESKEYRESET", "Fenster mit %s + Mausradtaste-ziehen resetten")
MoveAny:AddTrans("deDE", "LID_FRAMESKEYSCALE", "Fenster mit %s + Rechte-Maustaste-ziehen zum skalieren")
...
MoveAny:AddTrans("deDE", "LID_LOCKPARENT", "Eltern sperren")
MoveAny:AddTrans("deDE", "LID_LOCKPARENTDESC", "Erzwingt, dass dieses Element wieder auf das MoveAny-Panel gesetzt wird, sobald etwas anderes (Blizzard oder ein anderes Addon) seinen Eltern-Frame ändert. Aktiviere dies, wenn das Element zufällig springt, seine Größe ändert oder von selbst seine gespeicherte Position verliert (z. B. nach dem Betreten eines Fahrzeugs).")
MoveAny:AddTrans("deDE", "LID_LOCKWINDOWS", "Fenster sperren")
...
MoveAny:AddTrans("deDE", "LID_PLAYERFRAMEGROUPINDICATOR", "Spielerfenster Gruppennummer")
...
MoveAny:AddTrans("deDE", "LID_POWERBARCOUNTERBAR", "Begegnungsleiste Gegenleiste (Boss Begegnungen, Dunkelmond-Jahrmarkt, ...)")
...
MoveAny:AddTrans("deDE", "LID_QUESTTRACKER", "Questverfolgung (Rechte Seite)")
...
MoveAny:AddTrans("deDE", "LID_SHIFT", "UMSCHALT")
MoveAny:AddTrans("deDE", "LID_SHOWMINIMAPBUTTON", "Minimapknopf anzeigen")
MoveAny:AddTrans("deDE", "LID_SHOWTIPS", "Tipps anzeigen")
MoveAny:AddTrans("deDE", "LID_SLASHMOVE", "move")
MoveAny:AddTrans("deDE", "LID_SLASHMOVEANY", "moveany")
MoveAny:AddTrans("deDE", "LID_SLASHRELOAD", "rl")
