...
MoveAny:AddTrans("zhCN", "LID_ALPHAISSKYRIDING", "可见性 (翱翔)")
...
MoveAny:AddTrans("zhCN", "LID_CATACTIONBARS", "动作条")
MoveAny:AddTrans("zhCN", "LID_CATCHAT", "聊天")
MoveAny:AddTrans("zhCN", "LID_CATPARTYRAID", "小队 / 团队")
MoveAny:AddTrans("zhCN", "LID_CATQUEST", "任务")
MoveAny:AddTrans("zhCN", "LID_CATWIDGETS", "部件")
MoveAny:AddTrans("zhCN", "LID_CENTERED", "居中")
...
MoveAny:AddTrans("zhCN", "LID_ENCOUNTERBAR", "遭遇战进度条 (通常显示百分比) (首领进度条、纪元进度条、暗月马戏团进度条等)")
...
MoveAny:AddTrans("zhCN", "LID_GAMETOOLTIP_ONCURSOR_NOTINCOMBAT", "跟随光标的提示框 (战斗中不跟随光标)")
...
MoveAny:AddTrans("zhCN", "LID_LEFTALIGNED", "左对齐")
MoveAny:AddTrans("zhCN", "LID_LFGMINIMAPFRAME", "地下城查找器小地图按钮")
MoveAny:AddTrans("zhCN", "LID_LOCKEDWINDOWS", "窗口已锁定")
MoveAny:AddTrans("zhCN", "LID_LOCKPARENT", "锁定父级")
MoveAny:AddTrans("zhCN", "LID_LOCKPARENTDESC", "每当其他内容(暴雪或其他插件)更改此元素的父框架时,强制将其移回 MoveAny 的面板。如果该元素会随机跳动、改变大小或自行丢失已保存的位置(例如进入载具后),请启用此选项。")
MoveAny:AddTrans("zhCN", "LID_LOCKWINDOWS", "锁定窗口")
...
MoveAny:AddTrans("zhCN", "LID_MINIMAPTRACKING", "小地图追踪按钮")
MoveAny:AddTrans("zhCN", "LID_MINIMAPTRACKINGBUTTON", "小地图追踪按钮")
...
MoveAny:AddTrans("zhCN", "LID_ORIENTATION", "方向")
...
MoveAny:AddTrans("zhCN", "LID_PLAYERFRAMEGROUPINDICATOR", "玩家框架队伍编号")
...
MoveAny:AddTrans("zhCN", "LID_POSITION", "位置")
...
MoveAny:AddTrans("zhCN", "LID_RIGHTALIGNED", "右对齐")
...
MoveAny:AddTrans("zhCN", "LID_SCALE", "缩放")
...
MoveAny:AddTrans("zhCN", "LID_SLASHMOVE", "移动")
MoveAny:AddTrans("zhCN", "LID_SLASHMOVEANY", "移动任意")
MoveAny:AddTrans("zhCN", "LID_SLASHRELOAD", "重载")
...
MoveAny:AddTrans("zhCN", "LID_STANCEBARANCHOR", "姿态栏锚点 (姿态按钮)")
...
MoveAny:AddTrans("zhCN", "LID_SUPERTRACKEDFRAME", "路径点图标")
...
MoveAny:AddTrans("zhCN", "LID_WINDOWSARENOWLOCKED", "窗口现已锁定")
MoveAny:AddTrans("zhCN", "LID_WINDOWSARENOWUNLOCKED", "窗口现已解锁")
