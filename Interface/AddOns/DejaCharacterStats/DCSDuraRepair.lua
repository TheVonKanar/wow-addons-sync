...
local DCS_ShowItemRepairCheck = CreateFrame("CheckButton", "DCS_ShowItemRepairCheck", DejaCharacterStatsPanel, "InterfaceOptionsCheckButtonTemplate")
	...
	-- DCS_ShowItemRepairCheck:RegisterEvent("UPDATE_INVENTORY_DURABILITY") -- Causes tooltip flickering every time it updates item durability which is periodic as item eventually decay.
