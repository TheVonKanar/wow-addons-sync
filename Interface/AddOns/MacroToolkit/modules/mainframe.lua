...
function MT:CreateMTFrame()
    ...
    local function frameMouseUp()
        ...
        MT.db.profile.width = mtframe:GetWidth()
    end
    do
        --mtframe:SetScale(MT.db.profile.scale)
        mtframe:SetToplevel(true)
        mtframe:SetSize(MT.db.profile.width or 638, MT.db.profile.height)
    ...
    do
        ...
        mtresizer:SetScript("OnMouseDown", function() mtframe:StartSizing() end)
        mtresizer:SetScript("OnMouseUp", frameMouseUp)
    ...
    do
        ...
        --mthbleft:SetPoint("TOPLEFT", 2, -210) -- to have editbox resized on drag
        mthbleft:SetPoint("BOTTOMLEFT", 2, 197) -- to have button container resized on drag
    ...
    do
        ...
        mtselbg:SetPoint("TOPLEFT", mthbleft, "BOTTOMLEFT", 0, 8)
    end
    ...
    do
        ...
        mtscroll:SetPoint("BOTTOMRIGHT", mthbright, "TOPRIGHT", -335, 0)
    ...
    do
        mttextbg:SetPoint("TOPLEFT", mtselbg, "BOTTOMLEFT", 6, -5)
    ...
    do
        ...
        mteditbutton:SetScript("OnClick", function()
            MT:SaveMacro()
    ...
    do
        ...
        mtcancelbutton:SetPoint("LEFT", mteditbutton, "RIGHT", 6, 0)
    ...
    do
        ...
        drake:SetPoint("BOTTOMRIGHT", 0, 29)
        drake:Hide()
    ...
    do
        ...
        mtaddslot:SetPoint("BOTTOMRIGHT", mthbright, "TOPRIGHT", -15, 5)
        mtaddslot:Disable()
    ...
    do
        ...
        mtaddscript:SetPoint("BOTTOMRIGHT", mtaddslot, "TOPRIGHT", 0, 80)
        mtaddscript:Disable()
    ...
    do
        ...
        mtshare:SetPoint("TOPRIGHT", mtclear, "BOTTOMRIGHT", 0, -3)
