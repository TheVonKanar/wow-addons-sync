...
local DATASET = {
    ...
    },
    {
        ...
        items = {
            ...
            { id = "unlock_delves_through_tier_8_11_if_available", text = "Desbloquea Excavaciones hasta nivel 8 (11 si está disponible)" },
            { id = "complete_weekly_events_if_available_tbd_will_add_as_we_get_them", text = "Completa los eventos semanales si están disponibles. (Por determinar; se añadirá conforme salgan)" },
    ...
    },
    {
        ...
        items = {
            ...
            { id = "do_high_level_bountiful_delves_with_coffer_keys_use_map_if_possible", text = "Haz Excavaciones abundantes de alto nivel con llaves de cofre; usa el mapa si es posible" },
            { id = "if_prey_gives_any_useful_rewards_do_prey_might_give_champ_pieces_on_nightmare", text = "Si la Presa da recompensas útiles, haz la Presa (puede dar piezas de campeón en pesadilla)" },
            { id = "complete_pvp_quest_for_guaranteed_hero_neck_ring", text = "Completa la misión JcJ para collar/anillo de héroe garantizado" },
            { id = "before_raid_craft_2x_246_ilvl_pieces_2x_embellishments_on_weak_slots_use_160_vet_crests", text = "Antes de la banda: fabrica 2 piezas de niv. de objeto 246, 2 adornos en huecos débiles, usa 160 crestas veteranas" },
            { id = "before_raid_spend_all_veteran_and_champion_crests_upgrading_everything", text = "Antes de la banda: gasta todas las crestas veteranas y de campeón mejorándolo todo" },
            { id = "complete_your_raids", text = "Completa tus bandas" },
            { id = "track_crests_0_100_heroic_0_100_mythic", text = "Control de crestas: 0/100 Heroicas, 0/100 Míticas" },
        },
    },
    {
        ...
        items = {
            ...
            { id = "kill_world_boss_for_champ_ilvl", text = "Mata al jefe del mundo para nivel de objeto campeón" },
            { id = "do_high_level_bountiful_delves_with_coffer_keys_use_map_if_possible", text = "Haz Excavaciones abundantes de alto nivel con llaves de cofre; usa el mapa si es posible" },
            { id = "even_if_you_skip_delves_do_at_least_one_t11_to_get_cracked_keystone_quest", text = "Aunque omitas las Excavaciones, haz al menos uno de nivel 11 para la misión de la piedra angular resquebrajada" },
            ...
            { id = "track_crests_220_220_heroic_0_220_mythic", text = "Control de crestas: 220/220 Heroicas, 0/220 Míticas" },
    ...
    },
    {
        ...
        items = {
            ...
            { id = "farm_12s_for_vault_crests", text = "Farmea +12s para Gran Cámara + crestas" },
            ...
            { id = "track_crests_320_320_heroic_160_320_mythic", text = "Control de crestas: 320/320 Heroicas, 160/320 Míticas" },
    ...
    },
    {
        ...
        items = {
            ...
            { id = "heroic_upgrade_2_of_your_4_6_269_items_to_6_6_276_for_80_heroic_crests", text = "Heroico: mejora 2 de tus objetos 269 4/6 a 276 6/6 por 80 crestas heroicas" },
            { id = "mythic_if_your_vault_item_was_1_6_upgrade_its_heroic_counterpart_first_to_6_6_heroic_for_20_heroic_crests_upgrade_your_1_6_272_myth_track_item_to_6_6_289_for_80_myth_crests", text = "Mítico: si tu objeto de la Gran Cámara era 1/6, mejora primero su equivalente heroico a 6/6 heroico por 20 crestas heroicas. Mejora tu objeto de pista mítica 272 1/6 a 6/6 289 por 80 crestas míticas." },
            { id = "mythic_upgrade_your_raid_drop_from_2_6_275_myth_track_to_6_6_289_for_80_myth_crests", text = "Mítico: mejora tu botín de banda 2/6 275 de pista mítica a 6/6 289 por 80 crestas míticas." },
            { id = "track_crests_420_400_heroic_320_420_mythic", text = "Control de crestas: 420/400 Heroicas, 320/420 Míticas" },
    ...
    },
    {
        ...
        items = {
            { id = "open_vault_272_myth_item", text = "Abre la Gran Cámara (objeto mítico 272+)" },
            { id = "farm_12s_for_vault_crests", text = "Farmea +12s para Gran Cámara + crestas" },
            { id = "craft_2nd_embellishment_at_285_ilvl_mythic_for_80_myth_crests", text = "Fabrica el 2.º adorno a nivel de objeto 285 Mítico por 80 crestas míticas" },
            { id = "heroic_upgrade_2_of_your_4_6_269_items_to_6_6_276_for_80_heroic_crests", text = "Heroico: mejora 2 de tus objetos 269 4/6 a 276 6/6 por 80 crestas heroicas" },
            { id = "mythic_if_your_vault_item_was_1_6_upgrade_its_heroic_counterpart_first_to_6_6_heroic_for_20_heroic_crests_upgrade_your_1_6_272_myth_track_item_to_6_6_289_for_80_myth_crests", text = "Mítico: si tu objeto de la Gran Cámara era 1/6, mejora primero su equivalente heroico a 6/6 heroico por 20 crestas heroicas. Mejora tu objeto de pista mítica 272 1/6 a 6/6 289 por 80 crestas míticas." },
            { id = "track_crests_520_520_heroic_480_520_mythic", text = "Control de crestas: 520/520 Heroicas, 480/520 Míticas" },
    ...
    },
    {
        ...
        title = "Semana 6 - 21 de abril - Listo con las crestas heroicas",
        items = {
            { id = "open_vault_272_myth_item", text = "Abre la Gran Cámara (objeto mítico 272+)" },
            { id = "farm_12s_for_vault_crests", text = "Farmea +12s para Gran Cámara + crestas" },
            ...
            { id = "mythic_if_your_vault_item_was_1_6_upgrade_its_heroic_counterpart_first_to_6_6_heroic_for_20_heroic_crests_upgrade_your_1_6_272_myth_track_item_to_6_6_289_for_80_myth_crests", text = "Mítico: si tu objeto de la Gran Cámara era 1/6, mejora primero su equivalente heroico a 6/6 heroico por 20 crestas heroicas. Mejora tu objeto de pista mítica 272 1/6 a 6/6 289 por 80 crestas míticas." },
            { id = "mythic_upgrade_your_raid_drop_from_2_6_275_myth_track_to_6_6_289_for_80_myth_crests", text = "Mítico: mejora tu botín de banda 2/6 275 de pista mítica a 6/6 289 por 80 crestas míticas." },
            { id = "track_crests_560_620_heroic_620_620_mythic", text = "Control de crestas: 560/620 Heroicas, 620/620 Míticas" },
