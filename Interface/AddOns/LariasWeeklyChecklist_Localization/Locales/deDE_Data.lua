...
local DATASET = {
    ...
    },
    {
        ...
        items = {
            ...
            { id = "unlock_delves_through_tier_8_11_if_available", text = "Ausflüchte bis Stufe 8 freischalten (11 falls verfügbar)" },
            { id = "complete_weekly_events_if_available_tbd_will_add_as_we_get_them", text = "Wöchentliche Events abschließen, wenn verfügbar. (Wird ergänzt wenn bekannt)" },
    ...
    },
    {
        ...
        items = {
            ...
            { id = "do_high_level_bountiful_delves_with_coffer_keys_use_map_if_possible", text = "Hochstufige ergiebige Ausflüchte mit Schatztruhen-Schlüsseln, Karte nutzen" },
            { id = "if_prey_gives_any_useful_rewards_do_prey_might_give_champ_pieces_on_nightmare", text = "Beute machen wenn sie nützliche Belohnungen gibt (Albtraum kann Champion-Teile geben)" },
    ...
    },
    {
        ...
        items = {
            ...
            { id = "kill_world_boss_for_champ_ilvl", text = "Weltboss für Champion-Gs töten" },
            { id = "do_high_level_bountiful_delves_with_coffer_keys_use_map_if_possible", text = "Hochstufige ergiebige Ausflüchte mit Schatztruhen-Schlüsseln, Karte nutzen" },
            { id = "even_if_you_skip_delves_do_at_least_one_t11_to_get_cracked_keystone_quest", text = "Auch ohne Ausflüchte: mindestens einen T11 für den zerbrochenen Schlussstein-Quest" },
