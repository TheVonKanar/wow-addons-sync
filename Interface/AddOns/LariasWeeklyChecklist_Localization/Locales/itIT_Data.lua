...
local DATASET = {

    {
        ...
        items = {
            { id = "do_not_spend_any_crests_until_told_to_do_so", text = "Non spendere nessuna Cresta finché non ti viene detto" },
    ...
    },
    {
        ...
        items = {
            ...
            { id = "unlock_delves_through_tier_8_11_if_available", text = "Sblocca le Spedizioni fino al livello 8 (11 se disponibile)" },
            { id = "complete_weekly_events_if_available_tbd_will_add_as_we_get_them", text = "Completa gli eventi settimanali se disponibili. (Da definire, verrà aggiunto)" },
    ...
    },
    {
        ...
        items = {
            { id = "do_not_spend_heroic_or_mythic_crests", text = "NON spendere creste eroiche o mitiche" },
            ...
            { id = "do_high_level_bountiful_delves_with_coffer_keys_use_map_if_possible", text = "Fai Spedizioni generose di alto livello con chiavi del forziere, usa la mappa se possibile" },
            { id = "if_prey_gives_any_useful_rewards_do_prey_might_give_champ_pieces_on_nightmare", text = "Se la Preda dà ricompense utili, falla (può dare pezzi da campione da Incubo)" },
            { id = "complete_pvp_quest_for_guaranteed_hero_neck_ring", text = "Completa la missione JcJ per collana/anello eroe garantito" },
            { id = "before_raid_craft_2x_246_ilvl_pieces_2x_embellishments_on_weak_slots_use_160_vet_crests", text = "Prima del raid: crafta 2 pezzi liv. 246, 2 ornamenti negli slot deboli, usa 160 creste veterano" },
            { id = "before_raid_spend_all_veteran_and_champion_crests_upgrading_everything", text = "Prima del raid: spendi tutte le creste veterano e campione potenziando tutto" },
            { id = "complete_your_raids", text = "Completa i tuoi raid" },
            { id = "track_crests_0_100_heroic_0_100_mythic", text = "Tieni traccia delle creste: 0/100 Eroico, 0/100 Mitico" },
        },
    },
    {
        ...
        items = {
            ...
            { id = "kill_world_boss_for_champ_ilvl", text = "Uccidi il boss mondiale per il livello oggetto campione" },
            { id = "do_high_level_bountiful_delves_with_coffer_keys_use_map_if_possible", text = "Fai Spedizioni generose di alto livello con chiavi del forziere, usa la mappa se possibile" },
            { id = "even_if_you_skip_delves_do_at_least_one_t11_to_get_cracked_keystone_quest", text = "Anche se salti le Spedizioni, fai almeno un livello 11 per la missione della Chiave Incrinata" },
            ...
            { id = "track_crests_220_220_heroic_0_220_mythic", text = "Tieni traccia delle creste: 220/220 Eroico, 0/220 Mitico" },
    ...
    },
    {
        ...
        items = {
            { id = "open_vault_272_myth_item_upgrade_after_crafting", text = "Apri la Grande Volta (oggetto mitico 272+) - potenzia dopo il crafting" },
            ...
            { id = "farm_12s_for_vault_crests", text = "Farma i +12 per la Grande Volta + creste" },
            { id = "heroic_upgrade_2_of_your_4_6_269_items_to_6_6_276_for_80_heroic_crests", text = "Eroico: potenzia 2 dei tuoi oggetti 269 4/6 a 276 6/6 per 80 creste eroiche" },
            { id = "mythic_if_your_vault_item_was_1_6_upgrade_its_heroic_counterpart_first_to_6_6_heroic_for_20_heroic_crests_upgrade_your_1_6_272_myth_track_item_to_6_6_289_for_80_myth_crests", text = "Mitico: se il tuo oggetto della Grande Volta era 1/6, potenzia prima la controparte eroica a 6/6 per 20 creste eroiche. Poi potenzia il tuo oggetto del percorso mitico 272 1/6 a 6/6 289 per 80 creste mitiche." },
            ...
            { id = "track_crests_320_320_heroic_160_320_mythic", text = "Tieni traccia delle creste: 320/320 Eroico, 160/320 Mitico" },
    ...
    },
    {
        ...
        items = {
            { id = "open_vault_272_myth_item", text = "Apri la Grande Volta (oggetto mitico 272+)" },
            { id = "farm_12s_for_vault_crests", text = "Farma i +12 per la Grande Volta + creste" },
            { id = "heroic_upgrade_2_of_your_4_6_269_items_to_6_6_276_for_80_heroic_crests", text = "Eroico: potenzia 2 dei tuoi oggetti 269 4/6 a 276 6/6 per 80 creste eroiche" },
            { id = "mythic_if_your_vault_item_was_1_6_upgrade_its_heroic_counterpart_first_to_6_6_heroic_for_20_heroic_crests_upgrade_your_1_6_272_myth_track_item_to_6_6_289_for_80_myth_crests", text = "Mitico: se il tuo oggetto della Grande Volta era 1/6, potenzia prima la controparte eroica a 6/6 per 20 creste eroiche. Poi potenzia il tuo oggetto del percorso mitico 272 1/6 a 6/6 289 per 80 creste mitiche." },
            { id = "mythic_upgrade_your_raid_drop_from_2_6_275_myth_track_to_6_6_289_for_80_myth_crests", text = "Mitico: potenzia il tuo bottino del raid 2/6 275 del percorso mitico a 6/6 289 per 80 creste mitiche." },
            { id = "track_crests_420_400_heroic_320_420_mythic", text = "Tieni traccia delle creste: 420/400 Eroico, 320/420 Mitico" },
    ...
    },
    {
        ...
        items = {
            { id = "open_vault_272_myth_item", text = "Apri la Grande Volta (oggetto mitico 272+)" },
            { id = "farm_12s_for_vault_crests", text = "Farma i +12 per la Grande Volta + creste" },
            { id = "craft_2nd_embellishment_at_285_ilvl_mythic_for_80_myth_crests", text = "Crafta il 2° ornamento a livello oggetto 285 Mitico per 80 creste mitiche" },
            { id = "heroic_upgrade_2_of_your_4_6_269_items_to_6_6_276_for_80_heroic_crests", text = "Eroico: potenzia 2 dei tuoi oggetti 269 4/6 a 276 6/6 per 80 creste eroiche" },
            { id = "mythic_if_your_vault_item_was_1_6_upgrade_its_heroic_counterpart_first_to_6_6_heroic_for_20_heroic_crests_upgrade_your_1_6_272_myth_track_item_to_6_6_289_for_80_myth_crests", text = "Mitico: se il tuo oggetto della Grande Volta era 1/6, potenzia prima la controparte eroica a 6/6 per 20 creste eroiche. Poi potenzia il tuo oggetto del percorso mitico 272 1/6 a 6/6 289 per 80 creste mitiche." },
            { id = "track_crests_520_520_heroic_480_520_mythic", text = "Tieni traccia delle creste: 520/520 Eroico, 480/520 Mitico" },
    ...
    },
    {
        ...
        title = "Settimana 6 - 21 apr. - Finite le creste eroiche",
        items = {
            { id = "open_vault_272_myth_item", text = "Apri la Grande Volta (oggetto mitico 272+)" },
            { id = "farm_12s_for_vault_crests", text = "Farma i +12 per la Grande Volta + creste" },
            { id = "heroic_upgrade_your_last_4_6_269_item_to_6_6_276_for_40_heroic_crests", text = "Eroico: potenzia il tuo ultimo oggetto 269 4/6 a 276 6/6 per 40 creste eroiche" },
            { id = "mythic_if_your_vault_item_was_1_6_upgrade_its_heroic_counterpart_first_to_6_6_heroic_for_20_heroic_crests_upgrade_your_1_6_272_myth_track_item_to_6_6_289_for_80_myth_crests", text = "Mitico: se il tuo oggetto della Grande Volta era 1/6, potenzia prima la controparte eroica a 6/6 per 20 creste eroiche. Poi potenzia il tuo oggetto del percorso mitico 272 1/6 a 6/6 289 per 80 creste mitiche." },
            { id = "mythic_upgrade_your_raid_drop_from_2_6_275_myth_track_to_6_6_289_for_80_myth_crests", text = "Mitico: potenzia il tuo bottino del raid 2/6 275 del percorso mitico a 6/6 289 per 80 creste mitiche." },
            { id = "track_crests_560_620_heroic_620_620_mythic", text = "Tieni traccia delle creste: 560/620 Eroico, 620/620 Mitico" },
    ...
    },
    {
        ...
        items = {
            { id = "do_not_craft_if_you_can_get_vault_items_higher_than_1_6", text = "Non craftare se puoi ottenere oggetti dalla Grande Volta superiori a 1/6" },
